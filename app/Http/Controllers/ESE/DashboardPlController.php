...
{   
    ...
    {        
        ...
        //$initdatadashboad = $this->DataDashboard();

        $objDashboard = new DashboardPL();
        ...
        return view("ESE.dashboard.Dashboard",$data, $initdatadashboad
        );
    ...
    private function DatasDashboard()
