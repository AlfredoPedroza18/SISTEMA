...
{
    /* ESTO ES PARA LO DE LOS ESTADOS DEL COMBO DE SELECCION */
    private $estadosQuery = "SELECT e.IdEstado, e.FK_nombre_estado FROM estados e 
    WHERE e.FK_nombre_estado IS NOT NULL ORDER BY e.FK_nombre_estado ASC";
    /**
...

    {
        ...
        return view("ESE.catalogos.empleadosxinvestigadores",[
            "empleados"=>$Empleados]);
    ...
    public function GCreate(Request $request){
        ...
        try {
            ...
            if($active_tab=='Finalizar'){
                ...
                ->with('propietario_c',$propietario_c)
