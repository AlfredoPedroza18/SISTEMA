  ...
  `df_cp`, `df_estado`, `df_municipio`, `df_ciudad`, `df_colonia`, `df_calle`, `df_num_exterior`, `df_num_interior`, `dc_cp`, `dc_estado`, `dc_municipio`, `dc_ciudad`, `dc_colonia`, `dc_calle`,
   `dc_num_exterior`, `dc_num_interior`, `medio_contacto`, `tipo_cliente`, `comentario`, `db_forma_pago`, `db_banco`, `db_dias_credito`, `db_limite_credito`, `db_cta_clientes`, `db_clabe`, `db_iva`,
...

    {
        ...
        $tipoCliente = [1 => 'Cliente',2 => 'Prospecto'];
    ...
    public function edit($id)
    {
        ...
        $seguimientoVenta = DB::select('SELECT c.id_ejecutivo, c.id_cn, cn.nombre AS clienteAsignado, c.medio_contacto, c.tipo, tc.nombre AS tipoCliente, c.id,c.contrato_a,c.nombre_comercial,c.comentario,CONCAT(u.`name`," ",u.apellido_paterno," ",u.apellido_materno) AS nombreEjecutivo FROM clientes c 
        INNER JOIN users u
