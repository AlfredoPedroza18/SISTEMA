...
use App\ESE\Formatos\Femsa\CursoFemsa;
use App\ESE\Formatos\Femsa\IdiomaFemsa;
use App\ESE\Formatos\Femsa\ConocimientosFemsa;
use App\ESE\Formatos\Femsa\ReferenciaPersonalFemsa;
use App\ESE\Formatos\Femsa\InformacionLaboralFemsa;
use App\ESE\Formatos\Femsa\DatoFamiliarFemsa;
use App\ESE\Formatos\Femsa\PadecimientoFamiliarFemsa;

class FormatoFemsaController extends Controller
{
    /**
    ...
    {   ;
        ...
        if( $estudio && $formato )
        {
            return view('ESE.formatos-estaticos.femsa.formato-femsa', compact( 'estudio', 'backToEstudio' ) );
        }      
    ...
    {
        $estudio = EstudioEse::with('formatoFemsa')->get()->find( $id );
        ...
        {    
            ...
            {              
                ...
                $formato_sm             = new FormatoFemsa;
                $formato_sm->fecha_alta = Carbon::now();
                $formato_estudio          = $estudio->formatoFemsa()->save( $formato_sm );  
            }else{
                $formato_estudio = $estudio->formatoFemsa;                
            }
    ...
    public function deleteCursoRealizado(Request $request)
    {
        ...
        {
            CursoFemsa::destroy($request->id_remove_curso_realizado);
        }
    ...
    public function deleteIdioma(Request $request)
    {
        ...
        {
            IdiomaFemsa::destroy($request->id_remove_idioma);
        }
    ...
    public function deleteConocimiento(Request $request)
    {
        ...
        {
            ConocimientosFemsa::destroy($request->id_remove_conocimiento);
        }
    ...
    public function deleteReferenciaPersonal(Request $request)
    {
        ...
        {
            ReferenciaPersonalFemsa::destroy($request->id_remove_ref_personal);
        }
    ...
    public function deleteReferenciaLaboral(Request $request)
    {
        ...
        {
            InformacionLaboralFemsa::destroy($request->id_remove_ref_laboral);
        }
    ...
    public function deleteDatoFamiliar(Request $request)
    {
        ...
        {
            DatoFamiliarFemsa::destroy($request->id_remove_dato_familiar);
        }
    ...
    public function deleteFamiliarPadece(Request $request)
    {
        ...
        {
            PadecimientoFamiliarFemsa::destroy($request->id_remove_familiar_padece);
        }
