...
/*
	...
	@if ($ProgramacionEjecucionGuardada != 'ProgramacionEjecucionGuardada')
			...
			setInterval(() => {
				...
				if(!$('.overlay_popup').hasClass('popup-open')){
					...
					swal({
						...
						title: "<h3>¡ Aún no se ha realizado la notificación!</h3> ",
    ...
    <div style="background-color: white; margin-left: 0px; margin-right: 0px;" class="row">
        ...
        <div class="form-row">
            ...
            <div style="background-color: white; margin-left: 0px; margin-right: 0px;" class="form-group col-md-3">
                ...
                <label id="label_status">Estatus: Creación</label>
    ...
    <div style="background-color: white; margin-left: 0px; margin-right: 0px;" class="row">
        ...
        <div class="form-row">
            ...
            <div style="background-color: white; margin-left: 0px; margin-right: 0px;" class="form-group col-md-3">
                ...
                <label id="label_cliente">Cliente: {{$clientes}}</label>

            </div>

            <div style="background-color: white; margin-left: 0px; margin-right: 0px;" class="form-group col-md-3">

                <label id="label_analista">Analista: {{$asignacion[4]}}</label>
    ...
    <div style="background-color: white; margin-left: 0px; margin-right: 0px;" class="row">
        ...
        <div class="form-row">
            ...
            <div style="background-color: white; margin-left: 0px; margin-right: 0px;" class="form-group col-md-3">
                ...
                <label>Candidato: {{$candidato}} </label>

            </div>

            <div style="background-color: white; margin-left: 0px; margin-right: 24%;" class="form-group col-md-3">

                <label id="label_Investigador">Investigador: {{$asignacion[5]}}</label>

            </div>

            <div style="background-color: white; margin-left: 0px; margin-right: 0px;" class="form-group col-md-3">

                <button class="btn btn-success" type="button" name="button" id="btnPreviewPDF" data-toggle="modal" data-target="#Previsualizar_ESE">Estudio</button>

            </div>

            <!-- @if (Auth::user()->IdRol==98)

            <div style="background-color: white; margin-left: 0px; margin-right: 0px;" class="form-group col-md-3">

                <a class="btn btn-success " id="btnConfirmacionAnalista" name="btnConfirmacionAnalista" onclick="ConfirmacionAnalista(this.id);" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Enviando confirmación...">Confirmación Analista</a>
            ...
            <div style="background-color: white; margin-left: 0px; margin-right: 0px;" class="form-group col-md-3">
                ...
                <a class="btn btn-success " id="btnConfirmacionInvestigador" name="btnConfirmacionInvestigador" onclick="ConfirmacionInvestigador(this.id);" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Enviando confirmación...">Confirmación Investigador</a>
    ...
    <div style="background-color: white; margin-left: 0px; margin-right: 0px;" class="row">
        ...
        <div class="form-row">
            ...
            <div style="background-color: white; margin-left: 0px; margin-right: 0px;" class="form-group col-md-3">
                    ...
                    <label id="Servicio">Servicio: {{$servicio}}</label>
...
<li class="{{ ($EstatusEval == 'Cerrado')?'disabled disabledTab':'' }}"><a href="#Asignacion" aria-controls="Asignacion"  >Asignación</a></li>

<li class="{{ ($Notificada == '' && $showDialogProgamacionEjecucion)?'':($EstatusEval == 'Cerrado')?'disabled disabledTab':'' }}"><a href="#ProgramacionEjecucion" aria-controls="ProgramacionEjecucion" role="tab" data-toggle="tab" >Agenda</a></li>

<li class="{{ ($EstatusEval == 'Cerrado')?'disabled disabledTab':'' }}"><a href="#Estudio" aria-controls="Estudio" >Estudio</a></li>

<li ><a href="#Investigador" aria-controls="Investigador" role="tab" data-toggle="tab">Resumen</a></li>

<li><a href="#Analista" aria-controls="Analista" role="tab" data-toggle="tab" width='100%'>Servicio</a></li>

<!--<li><a href="#Kardex" aria-controls="Kardex" role="tab" data-toggle="tab" disabled>Kardex</a></li>
-->
</ul>
...
<div  class="tab-pane active" id="Asignacion">
                    ...
                    <div class="row">
                        ...
                        <div class="input-group">
                          ...
                          <select class="form-control" id="IdAnalistaSec" name="IdAnalistaSec">
                            ...
                            <option value="1279" @if ($asignacion[3] == 1279) selected  @endif> No aplica Analista </option>
                    ...
                    <div class="row">
                        ...
                        <div class="input-group">
                          ...
                          <select class="form-control" id="IdInvestigador" name="IdInvestigador" onchange="selectInvestigador();">
                            ...
                            <option value="226" @if ($asignacion[2] == 226) selected @endif> No aplica Investigador </option>
                    ...
                    <div class="row">
                        ...
                        <div class="input-group">
                          ...
                          <select class="form-control" id="IdLider" name="IdLider" onchange="selectLider();">
                            ...
                            <!-- <option value="N/A"> Seleccione un Lider</option> -->
      ...
      <!-- <input type="submit" name="Guardar" value="Guardar" class="btn btn-success btn-block" onclick="hacer_click_Asignacion({{ isset($IdServicioEse)?$IdServicioEse:'0' }})">

      <input type="hidden" id="num_id" value="{{ isset($IdServicioEse)?$IdServicioEse:'' }}"> -->
          ...
          <div class="row">
              ...
              @if (Auth::user()->tipo=='c')
                  ...
                  <div class=" col-md-12 text-right">
                      ...
                      <!-- <input type="button" class="btn btn-success" onclick="Asignacion();" value="Guardar"> -->

                      <a class="btn btn-success" type="button" id="btnAsignacion"  data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Guardando..." disabled="true">Guardar</a>
              ...
              @else
                ...
                <div class=" col-md-3 text-right">
                  ...
                  @if (Auth::user()->IdRol==98)
                    ...
                    <a class="btn btn-success btn-block" id="btnConfirmacionAnalista" name="btnConfirmacionAnalista" onclick="ConfirmacionAnalista(this.id);" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Enviando confirmación...">Confirmación Analista</a>
                ...
                <div class="col-md-2">
                    ...
                    <a class="btn btn-success btn-block" type="button" id="btnAsignacion" onclick="Asignacion(this.id);" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Guardando...">Guardar</a>
                ...
                <div class="row">
                  ...
                  <label >Municipio</label>
                    ...
                    <select name="municipios" id="municipios" class="form-control" >
                        ...
                        <option value ="1">Seleccione una region</option>
  ...
  <form id="FProgramacionEjecucion">
      ...
      <div class="row"><!-- begin row -->
        ...
        <!-- begin col-1 -->
          ...
          <div class="col-md-3">
            ...
            </div> <!-- <input type="time" class="form-control" id="hora_inicio" name="hora_inicio" max="22:30:00" value="" step="1">-->
    ...
    <div class="row justify-content-end">
      ...
      <div class="col-md-2 text-right">
        ...
        <!-- <input type="button" class="btn btn-success" id="btn-notificar" onclick="Notificacion();" value="Notificar"> -->

        @if ($Notificada != 'Notificada')

              @if (Auth::user()->tipo=='c')

                  <a class="btn btn-success btn-block" id="Notificacion" name="Notificacion" disabled="true" >Notificar</a>

              @else

                  <a class="btn btn-success btn-block" id="Notificacion" name="Notificacion" onclick="NotificarAlCorreo(this.id);" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Notificando...">Notificar</a>

              @endif

        @else

        <!--<a class="btn btn-success " id="Notificacion" name="Notificacion" disabled>Notificar</a>-->
        ...
        @if (Auth::user()->tipo=='c')
            ...
            <div class="col-md-2">
                ...
                <!-- <input type="button" class="btn btn-success" onclick="ProgramacionEjecucion();" value="Guardar"> -->

                <a class="btn btn-success btn-block" type="button" id="btnProgramacionEjecucion" disabled="true" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Guardando...">Guardar</a>
  ...
  <form id="Analista-form" action="#" >
    ...
    <div class="row">
      ...
      <!-- <div class="form-group col-md-4">
          ...
          <select class="form-control" name="AptoEval" id="AptoEval">
      ...
      <div class="form-group col-md-6">
        ...
        <!-- <div class="form-group col-md-4">
            ...
            {!! Form::text('Estatus', null, ['class'=>'form-control', 'id'=>'EstatusEval','data-live-search'=>'true','data-parsley-group'=>'wizard-step-1','data-style'=>'btn-white','data-size'=>'']) !!}
    ...
    <div class="row">
      ...
      <div class="col-xl-12 col-sm-4"></div>

      <div class="col-xl-12 col-sm-2 text-right">

          <!-- <input type="button" class="btn btn-success" onclick="saveAnalista();" value="Guardar"> -->

          @if (Auth::user()->tipo=='c')

              <a class="btn btn-success btn-block float-left" id="btnAnalista" type="button" disabled="true" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Guardando...">Guardar</a>

          @else

              <a class="btn btn-success btn-block float-left" id="btnAnalista" type="button" onclick="saveAnalista(this.id);" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Guardando...">Guardar</a>
  ...
  <form id="Investigador-form" action="#" >
    ...
    <div class="row">
      ...
      <div class="form-group col-md-12" >
          ...
          <select class="form-control" name="DictamenVal" id="DictamenVal" onblur="saveDictamenA(this.name, this.value);">
      ...
      @if ($Incidencias==0)
        ...
        <!--<div class="form-group col-md-4">
            ...
            <select class="form-control" id="Estatus" name="Estatus">
              ...
              <option @if ($Estatus == "No Apto") selected @endif value="No Apto">No Apto</option>

              <option @if ($Estatus == "Apto a Reserva") selected @endif value="Apto a Reserva">Apto a Reserva</option>

              <option @if ($Estatus == "Apto") selected @endif value="Apto">Apto</option>
    ...
    <div class="row">
      ...
      <div class="col-xl-12 col-sm-2 ">
          ...
          @if (Auth::user()->tipo=='c')
              ...
              <a class="btn btn-success btn-block continue" type="button" id="btnTabInvestigador" disabled="true" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Guardando...">Siguienter</a>
...
<div class='modal-footer'>
  ...
  <button type='button' class='btn btn-warning' data-dismiss='modal'>Cerrar</button>
    ...
    @permission('ese.lista.estudios.editar')
    ...
    @endpermission
              ...
              $.ajax({
...

                  {
                    ...
                    isContentStudio = true;
                      ...
                      $("#grpos").empty();
                      console.log("respuestaimprime: %o",response)
                      ...
                      let newArrNameLinkTab = [...dataArr];
                          ...
                          $.each(newArrNameLinkTab,function(index,value){
                              ...
                              // aHREF = replaceCharactersSpecial(aHREF);

                              // value = replaceCharactersSpecial(value);
      ...
      //         //almacenamos los name de los inputs tipo date en array inputsDate

      //         if(lstNumero[i].getAttribute('type') == 'date'){

      //           inputsDate.push(arrayGName[i]);
      ...
      function EtiquetaD(){ 
        ...
        idInp=$('label[name="Tipo de demanda"]').attr("idInp");

        valInp=$('input[name="'+idInp+'"]').attr("value");

        idHD=$('label[name="¿Ha tenido alguna demanda laboral, civil, mercantil o penal, o ha sido detenido alguna vez?"]').attr("idInp");
                ...
                if(!allowedExtensionsJPEG.exec("."+file_ext)){
                  ...
                  new Compressor(input.files[0], {
                    ...
                    success(result) {
                      ...
                      // fd.append(`${id}`,result,result.name);

                      const mCanvas = document.getElementById('preview'+id);

                      // console.log('url: '+mCanvas.toDataURL());
                      ...
                      $.ajax({
                        ...
                        success: function (data) {
                          ...
                          // console.log(data[0]);
                            ...
                            // $("#btnAjustar"+id).attr('style', 'display: inline-block;');
    ...
    function Recortar(idFile,idStudio,title) {
      ...
      // $("#preview"+idFile).attr('style', 'display: inline-block;');
      ...
      function abrirEditor(e) {
          ...
          document.querySelector(`#croppr${idFile}`).setAttribute('src', urlImage);
            ...
            //     Math.max(0, (img.width - mCanvas.width) / 2),

            //     Math.max(0, (img.height - mCanvas.height) / 2), 

            //     mCanvas.width, mCanvas.height, 0, 0, mCanvas.width, mCanvas.height); 

            //     // console.log('mCanvas img: '+JSON.stringify(mCanvas.toDataURL()));
      ...
      function recortarImagen(data) {
        ...
        // console.log('DATA: '+JSON.stringify(data.target.height));

        // const inicioX = data.target.x;

        // const inicioY = data.target.y;

        // const nAncho = data.width;

        // const nAltura = data.height;

        // const inicioX = data.target.x;

        // const inicioY = data.target.y;

        // const nAncho = data.target.width;

        // const nAltura = data.target.height;

        // console.log('inicioX: '+inicioX+' inicioY: '+inicioY+' nAncho: '+nAncho+' nAltura: '+nAltura);
        ...
        mCanvas.toBlob(function(blob) {
          ...
          // mCanvas.width = nAncho;

          // mCanvas.height = nAltura;
        ...
        NImagenTemp.onload = function() {
          ...
          contexto.drawImage(mCanvas, 0, 0, width * zoom, height * zoom, 0, 0, width, height);
    ...
    var GuardadoInput = function(id,value){
      ...
      if(etiqueta=='¿Ha tenido alguna demanda laboral, civil, mercantil o penal, o ha sido detenido alguna vez?'){
      ...
      // console.log('value input: '+value+' id: '+id+' ids: '+ids+' tipo: '+tipo);
        ...
        $.ajax({
...

            {
              ...
              if(response.status == "success"){
                ...
                $("#"+response[0]).removeClass("normal");

                $("#"+response[0]).addClass(response[1]);
                ...
                success: function(response){
                  ...
                  if(IdLider=="N/A" || IdAnalista=="N/A" || IdInvestigador=="N/A" ){
                      ...
                      swal({
                          ...
                          title: "<h3>¡ El registro se guardo con éxito, "+response.message+" !</h3> ",
      ...
      loaderButton(idBtn,true);
        ...
        $.ajax({
            ...
            success: function(response){
              ...
              // console.log(response.status_alta);
                  ...
                  if(response.status_alta == 'error'){
                    ...
                    if(Estatus=="Cerrado"){
                      ...
                      console.log("cerrado"+response.resultadoConteoColor);
                        ...
                        // if(response.color=='verde' && response.status_alta == 'success'){
                        ...
                        // if(response.color=='amarillo' && response.resultadoConteoColor>1){
                        ...
                        swal({
                            ...
                            title: "<h3>¡ El estatus se ha guardado en pendiente!</h3> ",
        ...
        $.ajax({
          ...
          success: function(response){
            ...
            loaderButton(id,false);
              ...
              //             title: "<h3>¡ Estudio Completado !</h3> ",
      ...
      $.ajax({
          ...
          success: function(response){
...

            {
              ...
              // console.log(JSON.stringify(dataDownloadFile.base64));
            ...
            if(response.status == "500"){
              ...
              document.getElementById("PDFContent").innerHTML ='<div class="container-fluid" style="height:300px;">'+
                      ...
                      '<div class="col-sm-12">'+
                          ...
                          '<center><h3 class="">:( ocurrió un error al cargar PDF 500</h3></center>'+
              ...
              document.getElementById("PDFContent").innerHTML ='<div class="container-fluid" style="height:300px;">'+
                      ...
                      '<div class="col-sm-12">'+
                          ...
                          '<center><h3 class="">:( ocurrió un error al cargar PDF'+response.status+'</h3></center>'+
      ...
      $.ajax({
        ...
        success: function(response){
          ...
          $("#region").html("");
            ...
            $("#region").append(`<option value='1'>Seleccionar region`);

          response.forEach(element => { 

            $("#region").append(`<option value='${element.Region}'>${element.Region}`);
    ...
    function desableInvestigator(){
      ...
      if(typeModal == 'Telefónica'){

        $("#IdInvestigador").attr("disabled", "disabled");

        $("#btnShowModalInvestigator").addClass("not-active");
   ...
   // funcion para que en el boton aparezca un loading.
      ...
      $.ajax({
        ...
        success: function(response){  
          ...
          if(response.data != null){
            ...
            // Grado=arrayGrado;Institucion=arrayInstitucion;Comprobante=arrayComprobante;
            ...
            // console.log(JSON.stringify(data["IdiomasValor"]));

            // console.log(JSON.stringify(data.SITUACIÓN_SOCIAL_Y_ECONÓMICA["ViviendaTipoCalidadGeneralValor"]));
            ...
            // summarys.trayectoriaLaboral= summarys.trayectoriaLaboral.replace(":ComentariosRPValor", response.comentRP);
            ...
            // console.log('Resumen: '+$('#Resumen').val()+' Escolar: '+$('#Escolar').val()+' Trayectoria: '+$('#Trayectoria').val());
              ...
              if(nTel != -1){
                ...
                if(nCel != -1){
                  ...
                  if (element.id === 'Celular') {
                    ...
                    // resetAutoComplete(allInputsCel,"",document.getElementsByName(`${name}`)[0].id);

                    // saveResetValueInputs(allInputsCel,name,$("#IdServicioEse").val());
          ...
          $.ajax({
            ...
            success: function(response){
              ...
              if(response.status == "success"){
                ...
                // $("#filePJ"+idFile).addClass("required");    
     ...
     * Funcion para obtener el mes en letra
