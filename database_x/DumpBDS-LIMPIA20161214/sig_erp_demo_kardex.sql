...
CREATE TABLE `kardex` (
  ...
  `hr_inicio` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `hr_fin` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `tiempo_accion` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  ...
  `id_cliente` int(9) unsigned NOT NULL,
  PRIMARY KEY (`id`)
