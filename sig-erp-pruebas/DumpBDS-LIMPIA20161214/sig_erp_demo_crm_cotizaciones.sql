...
--
-- Table structure for table `crm_cotizaciones`
--
...
--
-- Dumping data for table `crm_cotizaciones`
--

LOCK TABLES `crm_cotizaciones` WRITE;
/*!40000 ALTER TABLE `crm_cotizaciones` DISABLE KEYS */;
/*!40000 ALTER TABLE `crm_cotizaciones` ENABLE KEYS */;
UNLOCK TABLES;
