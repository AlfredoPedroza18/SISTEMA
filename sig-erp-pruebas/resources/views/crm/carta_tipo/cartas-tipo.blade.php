...
<div id="content" class="content">
	...
	<h1 class="page-header text-center">CARTAS TIPO <small>ABM</small></h1>
	...
	<div class="panel panel-inverse" data-sortable-id="ui-widget-14" data-init="true">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title text-center table-responsive">Listado Cartas Tipo</h4>
                        </div>
		...
		var botonesABM_Clientes = {
			init: function(){
					...
					$('.btn-eliminar-registro').click(function(event){
							...
							var ruta		= "{{ url('cartas_tipo') }}/"+id_cliente+"";
								...
								confirmButtonColor: 'ef9d1e'
									...
									$.ajax({
										...
										success: function(response){ 
													...
													listarCartasTipo(); // Cargara todos los registros
													swal({   
