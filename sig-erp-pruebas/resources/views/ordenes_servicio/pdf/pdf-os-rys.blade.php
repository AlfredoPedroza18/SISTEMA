        ...
        <td colspan="2" style="font-family: Helvetica; text-align: justify; color: #585858">
          <p>          
            <ul class="alcance">
                ...
                <li>Tiempo de reclutamiento de acuerdo al perfil.</li>
                <li>Verificación de referencias laborales.</li>
                <li>Garantía Gen-T: 1 reposición de la vacante que se generen por abandono de empleo durante los primeros {{$datos_rys[0]->garantia_rys }} meses.</li>
