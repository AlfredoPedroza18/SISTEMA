...
<ol class="breadcrumb ">
    <li><a href="javascript:;">Administrador</a></li> 
		...
		<li><a href="{{route('sig-erp-crm::EmpresasFacturadoras.index')}}">Empresas Facturadoras</a></li>
		<li>Alta Empresa Facturadora</li>
   </ol>
<h1 class="page-header text-center">Empresas Facturadoras <small>Alta</small></h1>
	...
	<div class="panel panel-inverse" data-sortable-id="ui-widget-14">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Empresas Facturadoras <small>Alta</small></h4>
                        </div>
                        <div class="panel-body">
                        {!! Form::model($facturadora,
                        ['route'=>['sig-erp-crm::EmpresasFacturadoras.update',$facturadora],
                        'id'=>'form-alta-empresa']) 
                        !!}
                         @include('administrador.empresas.form-alta-empresa')
                        {!! Form::close()!!}
...
<!-- ================== BEGIN PAGE LEVEL JS ================== --> 
    ...
    //DESPLIEGA LOS VALORES DEL SELECTOR DE FORMA JURIDICA ---------
        ...
        @if($facturadora->forma_juridica==2)
         $('.pm').show();
         $('.pf').hide();
         ...
         @elseif($facturadora->forma_juridica==1)
...
//---------------------------------------------- funcion para  llena olonias,estado,municipio al darle entetr CP 
    ...
    var guardarCliente = function(){
        ...
        $.ajax({
            ...
            url:'{{ url('EmpresasFacturadoras') }}/'+num_id,
            type:'PUT',
            dataType: 'json',
            data: datos,
