										        ...
										        @foreach($cn as $clave)
										         <tr>
										           ...
										           <td class="text-center">
											           	  <a href="{{route('sig-erp-crm::departamentos.edit',$clave->id)}}" class="btn btn-primary btn-icon btn-circle btn-sm btn-editar-registro" data-toggle="tooltip" data-placement="top" title="Editar Registro"><i class="fa fa-pencil"></i></a>&nbsp&nbsp
