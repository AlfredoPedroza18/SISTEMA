...
<div id="content" class="content">
	...
	<ol class="breadcrumb ">
		...
		<li><a href="javascript:;">Editando plantilla</a></li>
	...
	<div class="row">
		<div class="col-md-12 ui-sortable">
			<div class="panel panel-inverse" data-sortable-id="ui-widget-1">
		        ...
		        <form class="form-horizontal" action="{{ url('utilerias/plantillas', $plantilla) }}" method="POST" enctype="multipart/form-data">
		        	{{ method_field('PUT') }}
		        	{{ csrf_field() }}
				                        ...
				                        <div class="panel-body">
				                            <div class="row"> 
											  	...
											  	<div class="form-group {{ $errors->has('descripcion') ? 'has-error' : '' }}">
											    	...
											    	<div class="col-md-9">
											      		<textarea name="descripcion" class="form-control" rows="3">{{ $plantilla->descripcion }}</textarea>
				                            		...
				                            		<div class="form-group">
													    ...
													    <div class="col-md-3">
													      <div 	class="input-group colorpicker-component color-plantilla" 
													      		data-color="{{ $plantilla->encabezado_fondo }}" 
													      		data-color-format="rgb" 
													      		id="colorpicker-prepend" 
													      		data-colorpicker-guid="2">
																<input 	type="text" 
																		value="{{ $plantilla->encabezado_fondo }}" 
																		readonly="" 
																		class="form-control" 
																		id="color-encabezado"
													    ...
													    <div class="col-md-3">
													      <div 	class="input-group colorpicker-component color-plantilla" 
													      		data-color="{{ $plantilla->encabezado_letra }}" 
													      		data-color-format="rgb" 
													      		id="colorpicker-prepend" 
													      		data-colorpicker-guid="2">
																<input 	type="text" 
																		value="{{ $plantilla->encabezado_letra }}" 
																		readonly="" 
																		class="form-control" 
													  ...
													  <div class="form-group">
													    ...
													    <div class="col-md-3">
													      <div 	class="input-group colorpicker-component color-plantilla" 
													      		data-color="{{ $plantilla->encabezado_detalle_fondo }}" 
													      		data-color-format="rgb" 
													      		id="colorpicker-prepend" 
													      		data-colorpicker-guid="2">
																<input 	type="text" 
																		value="{{ $plantilla->encabezado_detalle_fondo }}" 
																		readonly="" 
																		class="form-control" 
													    ...
													    <div class="col-md-3">
													      <div 	class="input-group colorpicker-component color-plantilla" 
													      		data-color="{{ $plantilla->encabezado_detalle_letra }}" 
													      		data-color-format="rgb" 
													      		id="colorpicker-prepend" 
													      		data-colorpicker-guid="2">
																<input 	type="text" 
																		value="{{ $plantilla->encabezado_detalle_letra }}" 
																		readonly="" 
																		class="form-control" 
													  ...
													  <div class="form-group">
													    ...
													    <div class="col-md-3">
													      <div 	class="input-group colorpicker-component color-plantilla" 
													      		data-color="{{ $plantilla->fecha_total_fondo }}" 
													      		data-color-format="rgb" 
													      		id="colorpicker-prepend" 
													      		data-colorpicker-guid="2">
																<input 	type="text" 
																		value="{{ $plantilla->fecha_total_fondo }}" 
																		readonly="" 
																		class="form-control" 
													    ...
													    <div class="col-md-3">
													      <div 	class="input-group colorpicker-component color-plantilla" 
													      		data-color="{{ $plantilla->fecha_total_letra }}" 
													      		data-color-format="rgb" 
													      		id="colorpicker-prepend" 
													      		data-colorpicker-guid="2">
																<input 	type="text" 
																		value="{{ $plantilla->fecha_total_letra }}" 
																		readonly="" 
																		class="form-control" 
													  ...
													  <div class="form-group">
													    ...
													    <div class="col-md-3">
													      <div 	class="input-group colorpicker-component color-plantilla" 
													      		data-color="{{ $plantilla->letra_general }}" 
													      		data-color-format="rgb" 
													      		id="colorpicker-prepend" 
													      		data-colorpicker-guid="2">
																<input 	type="text" 
																		value="{{ $plantilla->letra_general }}" 
																		readonly="" 
																		class="form-control" 
...
<script>
	...
	{
		cambiarColorHeader( '{{ $plantilla->encabezado_fondo }}' );
		cambiarColorHeaderLetra( '{{ $plantilla->encabezado_letra }}' );
		cambiarColorHeaderDetalle( '{{ $plantilla->encabezado_detalle_fondo }}' );
		cambiarColorHeaderLetraDetalle( '{{ $plantilla->encabezado_detalle_letra }}' );
		cambiarColorLetraFechaTotal( '{{ $plantilla->fecha_total_letra }}' );
		cambiarColorFechaTotal( '{{ $plantilla->fecha_total_fondo }}' );
		cambiarColorLetraGeneral( '{{ $plantilla->letra_general }}' );
	}
