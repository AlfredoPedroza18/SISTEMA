...
<!-- Mirrored from seantheme.com/color-admin-v2.0/admin/html/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 19 Sep 2016 14:45:22 GMT -->
<head>
	<meta charset="utf-8" />
	<title>SIG-ERP | Expediente</title>
	...
	<div id="page-container" class="fade">
        ...
        <div class="login bg-black animated fadeInDown">
            ...
            <div class="login-header">
                <div class="brand">
                    <span class="logo"></span> SIG - ERP
                    <small>Expediente de Clientes</small>
                </div>
                <div class="icon">
            ...
            <div class="login-content">
                <form action="{{ url('/login/clientes') }}" method="POST" class="margin-bottom-0">
                	{{ csrf_field() }}
                    <div class="form-group m-b-20">
                        <input type="text" class="form-control input-lg" name="email" value="{{ old('email') }}" placeholder="Usuario">
                        @if ($errors->has('email'))
