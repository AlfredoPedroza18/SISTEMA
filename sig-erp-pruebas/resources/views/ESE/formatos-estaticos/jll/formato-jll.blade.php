...
<div id="content" class="content">
	...
	<div class="panel panel-warning" data-sortable-id="ui-widget-12">
		<div class="panel-heading">
			...
			<h4 class="panel-title">Formato JLL</h4>
		</div>
		<div class="panel-body">							
				{{ Form::open(['route' => ['sig-erp-ese::formato-jll.update', $estudio], 'method' => 'put' ]) }}				
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
					...
					@include('ESE.formatos-estaticos.jll.jll-componente-resultados')
					@include('ESE.formatos-estaticos.jll.jll-componente-datos-personales')
					@include('ESE.formatos-estaticos.jll.jll-componente-documentacion')
					@include('ESE.formatos-estaticos.jll.jll-componente-antecedentes-legales')
					@include('ESE.formatos-estaticos.jll.jll-componente-referencias-laborales')
					@include('ESE.formatos-estaticos.jll.jll-componente-gaps')
					@include('ESE.formatos-estaticos.jll.jll-componente-ref-lab-cinco-anios')
					@include('ESE.formatos-estaticos.jll.jll-componente-escolaridad')
					@include('ESE.formatos-estaticos.jll.jll-componente-personas-viven-domicilio')
					@include('ESE.formatos-estaticos.jll.jll-componente-descripcion-vivienda')
					@include('ESE.formatos-estaticos.jll.jll-componente-tipo-vivienda')
					<div class="form-horizontal">
			            <div class="form-group">
...
{{ Form::open(['url' => 'delete-referencia-lab-simple-jll','method' => 'POST','id' => 'frm-delete-ref-simple']) }}
	<input type="text" name="id_remove_ref_lab_simple" value="0" id="id_remove_ref_lab_simple">	
{{ Form::close() }}

{{ Form::open(['url' => 'delete-referencia-lab-cinco-jll','method' => 'POST','id' => 'frm-delete-ref-cinco']) }}
	<input type="text" name="id_remove_ref_lab_cinco" value="0" id="id_remove_ref_lab_cinco">	
{{ Form::close() }}

{{ Form::open(['url' => 'delete-viven-domicilio-jll','method' => 'POST','id' => 'frm-delete-vive-persona']) }}
...
/***************************************************************************************************************************************************************************************/
	...
	let i = {{ isset( $estudio->formatoJll->vivenEnDomicilio ) ? count( $estudio->formatoJll->vivenEnDomicilio ) : '1' }};
...
/***************************************************************************************************************************************************************************************/
	...
	let index_ref_lab_cinco = {{ isset( $estudio->formatoJll->referenciasLaboralesCinco ) ? count( $estudio->formatoJll->referenciasLaboralesCinco ) : 1 }};
...
let index_vivien_dom = {{ isset( $estudio->formatoJll->vivenEnDomicilio ) ? count( $estudio->formatoJll->vivenEnDomicilio ) : '1' }};
