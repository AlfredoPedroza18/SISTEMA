    ...
    <div class="panel-body">
        <div class="form-horizontal">
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <input type="hidden" name="resultados[id]" value="{{ isset( $estudio->formatoJll ) ? $estudio->formatoJll->id : 0 }}">
                    <input  type="text" 
                            class="form-control" 
                            readonly="readonly" 
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    ...
                    <select class="form-control" name="resultados[resultado_candidato]">
                            ...
                            <option value="2" 
                                    @if( $estudio->formatoJll ) 
                                            @if( $estudio->formatoJll->resultado->resultado_candidato == '2' ) 
                                                selected="selected"
                                            @endif
                                    @endif
                            ...
                            <option value="3" 
                                    @if( $estudio->formatoJll ) 
                                            @if( $estudio->formatoJll->resultado->resultado_candidato == '3' ) 
                                                selected="selected"
                                            @endif
                                    @endif
                                     >No Apto</option>
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">                    
                    <textarea class="form-control" rows="5" name="resultados[resultado_laboral]">{{ isset( $estudio->formatoJll->resultado ) ? $estudio->formatoJll->resultado->resultado_laboral : '' }}</textarea>
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-2 control-label">Verificación escolar: </label>
                <div class="col-md-10">                    
                    <textarea class="form-control" rows="5" name="resultados[resultado_escolar]">{{ isset( $estudio->formatoJll->resultado ) ? $estudio->formatoJll->resultado->resultado_escolar : '' }}</textarea>
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-2 control-label">Gap employments: </label>
                <div class="col-md-10">                    
                    <textarea class="form-control" rows="5" name="resultados[resultado_gap]">{{ isset( $estudio->formatoJll->resultado ) ? $estudio->formatoJll->resultado->resultado_gap : '' }}</textarea>
                </div>
            </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-10">                    
                    <textarea class="form-control" rows="2" name="resultados[observaciones]">{{ isset( $estudio->formatoJll->resultado ) ? trim($estudio->formatoJll->resultado->observaciones) : '' }}</textarea>
                </div>
            </div>
        </div>
    </div>
