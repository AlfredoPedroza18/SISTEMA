...
<div id="content" class="content">
	...
	<div class="panel panel-warning" data-sortable-id="ui-widget-12">
		<div class="panel-heading">
			...
			<h4 class="panel-title">Formato HSBC</h4>
		</div>
		<div class="panel-body">
				<h4 class="text-danger"><strong>Nota:</strong> La vista del domicilio se carga en la sección de carga de imagenes, concepto Vivienda Exterior</h4>							
				{{ Form::open(['route' => ['sig-erp-ese::formato-hsbc.update', $estudio], 'method' => 'put' ]) }}				
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
					...
					@include('ESE.formatos-estaticos.hsbc.hsbc-componente-resultados')
					@include('ESE.formatos-estaticos.hsbc.hsbc-componente-datos-personales')
					@include('ESE.formatos-estaticos.hsbc.hsbc-componente-documentacion')
					@include('ESE.formatos-estaticos.hsbc.hsbc-componente-antecedentes-legales')
					@include('ESE.formatos-estaticos.hsbc.hsbc-componente-referencias-laborales')
					@include('ESE.formatos-estaticos.hsbc.hsbc-componente-gaps')
					@include('ESE.formatos-estaticos.hsbc.hsbc-componente-ref-lab-cinco-anios')
					@include('ESE.formatos-estaticos.hsbc.hsbc-componente-escolaridad')
					@include('ESE.formatos-estaticos.hsbc.hsbc-componente-personas-viven-domicilio')
					@include('ESE.formatos-estaticos.hsbc.hsbc-componente-descripcion-vivienda')
					@include('ESE.formatos-estaticos.hsbc.hsbc-componente-tipo-vivienda')
					<div class="form-horizontal">
			            <div class="form-group">
...
{{ Form::open(['url' => 'delete-referencia-lab-simple','method' => 'POST','id' => 'frm-delete-ref-simple']) }}
	<input type="text" name="id_remove_ref_lab_simple" value="0" id="id_remove_ref_lab_simple">	
{{ Form::close() }}

{{ Form::open(['url' => 'delete-referencia-lab-cinco','method' => 'POST','id' => 'frm-delete-ref-cinco']) }}
	<input type="text" name="id_remove_ref_lab_cinco" value="0" id="id_remove_ref_lab_cinco">	
{{ Form::close() }}

{{ Form::open(['url' => 'delete-viven-domicilio','method' => 'POST','id' => 'frm-delete-vive-persona']) }}
...
<script>
/***************************************************************************************************************************************************************************************/
	let i = {{ isset( $estudio->formatoHsbc->referenciasLaborales ) ? count( $estudio->formatoHsbc->referenciasLaborales ) : '1' }};
...
/***************************************************************************************************************************************************************************************/
	...
	let index_ref_lab_cinco = {{ isset( $estudio->formatoHsbc->referenciasLaboralesCinco ) ? count( $estudio->formatoHsbc->referenciasLaboralesCinco ) : 1 }};
	    ...
	    let template_ref_lab = `
	        	<div id="fila_laboral_cinco_${index_ref_lab_cinco}" class="form-horizontal">
	                ...
	                <div class="form-group">
	                    ...
	                    <div class="col-md-3">
	                        <input type="text" class="form-control" name="referencias_lab_cinco[${index_ref_lab_cinco}][telefono]">
	                    </div>
	                </div>
...
let index_vivien_dom = {{ isset( $estudio->formatoHsbc->vivenEnDomicilio ) ? count( $estudio->formatoHsbc->vivenEnDomicilio ) : '1' }};
