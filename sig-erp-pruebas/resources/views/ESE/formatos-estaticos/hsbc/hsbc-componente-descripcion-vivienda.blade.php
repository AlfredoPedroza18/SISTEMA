    ...
    <div class="panel-body">
        <div class="form-horizontal">
            <div class="form-group">
                <input type="hidden" name="descripcion_vivienda[id]" value="{{ isset( $estudio->formatoHsbc->descripcionVivienda ) ? $estudio->formatoHsbc->descripcionVivienda->id : 0 }}">
                <label class="col-md-2 text-center control-label"><strong>Ubicación</strong></label>
                <div class="col-md-10">
                    <textarea class="form-control" rows="3" name="descripcion_vivienda[ubicacion]">
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <textarea class="form-control" rows="3" name="descripcion_vivienda[exterior]">
