    ...
    <div class="panel-body">
        <div class="form-horizontal">
            ...
            @if( $estudio->formatoHddisc )
                @forelse( $estudio->formatoHddisc->informacion_laboral as $index => $referencia )
                    ...
                    <div class="form-group">                
                        ...
                        <div class="col-md-3">
                            <input type="number" class="form-control" name="referencia_laboral[{{ $index }}][sueldo_inicial]" value="{{ $referencia->sueldo_inicial }}"  oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" min="1" max="99999999999999999" maxlength="15">
                        </div>
                    ...
                    <div class="form-group">                
                        ...
                        <div class="col-md-3">
                            <input type="number" class="form-control" name="referencia_laboral[{{ $index }}][sueldo_final]" value="{{ $referencia->sueldo_final }}"  oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" min="1" max="99999999999999999" maxlength="15">
                        </div>
