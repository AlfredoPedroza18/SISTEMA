        ...
        <div class="form-horizontal">
                    ...
                    <table class="table table-striped">
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td>
                                    <input type="hidden" name="bienes_total[id]" value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->bienes_totales->id : '0' }}">
                                    <input  type="number" class="form-control" name="bienes_total[valor]"  readonly="readonly" id="monto_bienes_total"                                        
                                            value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->bienes_totales->valor : '' }}">
                                </td>
                                <td>
                                    <input  type="number" class="form-control" name="bienes_total[pagado]" readonly="readonly" id="monto_pagado_total" 
                                            value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->bienes_totales->pagado : '' }}">
                                </td>
                                <td class="text-right">
                                    <input  type="number" class="form-control" name="bienes_total[adeudo]" readonly="readonly" id="monto_adeudo_total" 
                                            value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->bienes_totales->adeudo : '' }}">
                                </td>
                            </tr>
                        </tfoot>
                        <tbody>
                            <tr>
                                <td>
                                    <input type="hidden" name="bienes_detalle[0][id]" value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->bienes[0]->id : '0' }}">
                                    ...
                                    <div class="col-md-12">                    
                                        <select class="form-control" name="bienes_detalle[0][tiene]">
                                            ...
                                            @if( $estudio->formatoHddisc )
                                                @if( $estudio->formatoHddisc->bienes[0]->tiene == '1' )
                                                    selected="selected"    
                                                @endif
                                            @endif
                                            >Si</option>
                                            <option value="2"
                                            @if( $estudio->formatoHddisc )
                                                @if( $estudio->formatoHddisc->bienes[0]->tiene == '2' )
                                                    selected="selected"
                                                @endif
                                            @endif
                                            >No</option>
                                ...
                                <td>
                                    <input  type="text" class="form-control" name="bienes_detalle[0][tipo]"                                             
                                            value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->bienes[0]->tipo : '' }}">
                                </td>
                                <td>
                                    <input  type="number" class="form-control monto_bienes" name="bienes_detalle[0][valor]"                                             
                                            value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->bienes[0]->valor : '' }}">
                                </td>
                                <td>
                                    <input  type="number" class="form-control monto_pagado" name="bienes_detalle[0][pagado]"                                             
                                            value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->bienes[0]->pagado : '' }}">
                                </td>
                                <td>
                                    <input  type="number" class="form-control monto_adeudo" name="bienes_detalle[0][adeudo]"                                             
                                            value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->bienes[0]->adeudo : '' }}">
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <input type="hidden" name="bienes_detalle[1][id]" value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->bienes[1]->id : '0' }}">
                                ...
                                <td>
                                    <div class="col-md-12">                    
                                        <select class="form-control" name="bienes_detalle[1][tiene]">
                                            <option value="1"
                                            @if( $estudio->formatoHddisc )
                                                @if( $estudio->formatoHddisc->bienes[1]->tiene == '1' )
                                                    selected="selected"    
                                                @endif
                                            @endif
                                            >Si</option>
                                            <option value="2"
                                            @if( $estudio->formatoHddisc )
                                                @if( $estudio->formatoHddisc->bienes[1]->tiene == '2' )
                                                    selected="selected"
                                                @endif
                                            @endif
                                            >No</option>
                                ...
                                <td>
                                    <input  type="text" class="form-control" name="bienes_detalle[1][tipo]"                                             
                                            value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->bienes[1]->tipo : '' }}">
                                </td>
                                <td>
                                    <input  type="number" class="form-control monto_bienes" name="bienes_detalle[1][valor]"                                             
                                            value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->bienes[1]->valor : '' }}">
                                </td>
                                <td>
                                    <input  type="number" class="form-control monto_pagado" name="bienes_detalle[1][pagado]"                                             
                                            value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->bienes[1]->pagado : '' }}">
                                </td>
                                <td>
                                    <input  type="number" class="form-control monto_adeudo" name="bienes_detalle[1][adeudo]"                                             
                                            value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->bienes[1]->adeudo : '' }}">
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <input type="hidden" name="bienes_detalle[2][id]" value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->bienes[2]->id : '0' }}">
                                ...
                                <td>
                                    <div class="col-md-12">                    
                                        <select class="form-control" name="bienes_detalle[2][tiene]">
                                            <option value="1"
                                            @if( $estudio->formatoHddisc )
                                                @if( $estudio->formatoHddisc->bienes[2]->tiene == '1' )
                                                    selected="selected"    
                                                @endif
                                            @endif
                                            >Si</option>
                                            <option value="2"
                                            @if( $estudio->formatoHddisc )
                                                @if( $estudio->formatoHddisc->bienes[2]->tiene == '2' )
                                                    selected="selected"
                                                @endif
                                            @endif
                                            >No</option>
                                ...
                                <td>
                                    <input  type="text" class="form-control" name="bienes_detalle[2][tipo]"                                             
                                            value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->bienes[2]->tipo : '' }}">
                                </td>
                                <td>
                                    <input  type="number" class="form-control monto_bienes" name="bienes_detalle[2][valor]"                                             
                                            value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->bienes[2]->valor : '' }}">
                                </td>
                                <td>
                                    <input  type="number" class="form-control monto_pagado" name="bienes_detalle[2][pagado]"                                             
                                            value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->bienes[2]->pagado : '' }}">
                                </td>
                                <td>
                                    <input  type="number" class="form-control monto_adeudo" name="bienes_detalle[2][adeudo]"                                             
                                            value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->bienes[2]->adeudo : '' }}">
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <input type="hidden" name="bienes_detalle[3][id]" value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->bienes[3]->id : '0' }}">
                                ...
                                <td>
                                    <div class="col-md-12">                    
                                        <select class="form-control" name="bienes_detalle[3][tiene]">
                                            <option value="1"
                                            @if( $estudio->formatoHddisc )
                                                @if( $estudio->formatoHddisc->bienes[3]->tiene == '1' )
                                                    selected="selected"    
                                                @endif
                                            @endif
                                            >Si</option>
                                            <option value="2"
                                            @if( $estudio->formatoHddisc )
                                                @if( $estudio->formatoHddisc->bienes[3]->tiene == '2' )
                                                    selected="selected"
                                                @endif
                                            @endif
                                            >No</option>
                                ...
                                <td>
                                    <input  type="text" class="form-control" name="bienes_detalle[3][tipo]"                                             
                                            value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->bienes[3]->tipo : '' }}">
                                </td>
                                <td>
                                    <input  type="number" class="form-control monto_bienes" name="bienes_detalle[3][valor]"                                             
                                            value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->bienes[3]->valor : '' }}">
                                </td>
                                <td>
                                    <input  type="number" class="form-control monto_pagado" name="bienes_detalle[3][pagado]"                                             
                                            value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->bienes[3]->pagado : '' }}">
                                </td>
                                <td>
                                    <input  type="number" class="form-control monto_adeudo" name="bienes_detalle[3][adeudo]"                                             
                                            value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->bienes[3]->adeudo : '' }}">
                                </td>
                            </tr>
                        </tbody>
                    </table>
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <input  type="text" 
                            class="form-control"                              
                            value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->bienes_totales->ubicacion : '' }}"
