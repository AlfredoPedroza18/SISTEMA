    ...
    <div class="panel-body">
        <div class="form-horizontal">
            ...
            @if( $estudio->formatoHddisc )
                @forelse( $estudio->formatoHddisc->referencias_personales as $index => $referencia )
                    <div class="form-group">
                        <label class="col-md-2 text-center control-label">
                            <a  href="javascript:;" 
                    ...
                    <div class="form-group">                
                        ...
                        <div class="col-md-3">
                            <input type="text" class="form-control" name="referencias_personales[{{ $index }}][empresa]" value="{{ $referencia->tiempo_conocerlo }}">
                        </div>
                        <label class="col-md-1 control-label">Parentesco</label>
                        <div class="col-md-2">
                            <input type="text" class="form-control" name="referencias_personales[{{ $index }}][parentesco]" value="{{ $referencia->tiempo_conocerlo }}">
                        </div>
