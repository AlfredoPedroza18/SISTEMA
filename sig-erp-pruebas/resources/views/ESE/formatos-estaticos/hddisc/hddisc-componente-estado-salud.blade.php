    ...
    <div class="panel-body">
        <div class="form-horizontal">
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <input type="hidden" name="enfermedades_candidato[id]" value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->enfermedad->id : '' }}">
            ...
            <div class="form-group">
                ...
                <div class="col-md-2">
                    <select class="form-control" name="enfermedades_candidato[anemia]">
                            ...
                            <option value="2" 
                                    @if( $estudio->formatoHddisc ) 
                                            @if( $estudio->formatoHddisc->enfermedad->anemia == '2' ) 
                                                selected="selected"
                                            @endif
                                    @endif
                                     >No</option>
                ...
                <div class="col-md-2">
                    <select class="form-control" name="enfermedades_candidato[gastritis]">
                            ...
                            <option value="2" 
                                    @if( $estudio->formatoHddisc ) 
                                            @if( $estudio->formatoHddisc->enfermedad->gastritis == '2' ) 
                                                selected="selected"
                                            @endif
                                    @endif
                                     >No</option>
                ...
                <div class="col-md-2">
                    <select class="form-control" name="enfermedades_candidato[ulcera]">
                            ...
                            <option value="2" 
                                    @if( $estudio->formatoHddisc ) 
                                            @if( $estudio->formatoHddisc->enfermedad->ulcera == '2' ) 
                                                selected="selected"
                                            @endif
                                    @endif
                                     >No</option>
            ...
            <div class="form-group">
                ...
                <div class="col-md-2">
                    <select class="form-control" name="enfermedades_candidato[asma]">
                            ...
                            <option value="2" 
                                    @if( $estudio->formatoHddisc ) 
                                            @if( $estudio->formatoHddisc->enfermedad->asma == '2' ) 
                                                selected="selected"
                                            @endif
                                    @endif
                                     >No</option>
                ...
                <div class="col-md-2">
                    <select class="form-control" name="enfermedades_candidato[espalda]">
                            ...
                            <option value="2" 
                                    @if( $estudio->formatoHddisc ) 
                                            @if( $estudio->formatoHddisc->enfermedad->espalda == '2' ) 
                                                selected="selected"
                                            @endif
                                    @endif
                                     >No</option>
                ...
                <div class="col-md-2">
                    <select class="form-control" name="enfermedades_candidato[artritis]">
                            ...
                            <option value="2" 
                                    @if( $estudio->formatoHddisc ) 
                                            @if( $estudio->formatoHddisc->enfermedad->artritis == '2' ) 
                                                selected="selected"
                                            @endif
                                    @endif
                                     >No</option>
            ...
            <div class="form-group">
                ...
                <div class="col-md-2">
                    <select class="form-control" name="enfermedades_candidato[gripe]">
                            ...
                            <option value="2" 
                                    @if( $estudio->formatoHddisc ) 
                                            @if( $estudio->formatoHddisc->enfermedad->gripe == '2' ) 
                                                selected="selected"
                                            @endif
                                    @endif
                                     >No</option>
                ...
                <div class="col-md-2">
                    <select class="form-control" name="enfermedades_candidato[migrania]">
                            ...
                            <option value="2" 
                                    @if( $estudio->formatoHddisc ) 
                                            @if( $estudio->formatoHddisc->enfermedad->migrania == '2' ) 
                                                selected="selected"
                                            @endif
                                    @endif
                                     >No</option>
                ...
                <div class="col-md-2">
                    <select class="form-control" name="enfermedades_candidato[bronquitis]">
                            ...
                            <option value="2" 
                                    @if( $estudio->formatoHddisc ) 
                                            @if( $estudio->formatoHddisc->enfermedad->bronquitis == '2' ) 
                                                selected="selected"
                                            @endif
                                    @endif
                                     >No</option>
            ...
            <div class="form-group">
                ...
                <div class="col-md-2">
                    <select class="form-control" name="enfermedades_candidato[presion_alta]">
                            ...
                            <option value="2" 
                                    @if( $estudio->formatoHddisc ) 
                                            @if( $estudio->formatoHddisc->enfermedad->presion_alta == '2' ) 
                                                selected="selected"
                                            @endif
                                    @endif
                                     >No</option>
                ...
                <div class="col-md-2">
                    <select class="form-control" name="enfermedades_candidato[presion_baja]">
                            ...
                            <option value="2" 
                                    @if( $estudio->formatoHddisc ) 
                                            @if( $estudio->formatoHddisc->enfermedad->presion_baja == '2' ) 
                                                selected="selected"
                                            @endif
                                    @endif
                                     >No</option>
                ...
                <div class="col-md-2">
                    <select class="form-control" name="enfermedades_candidato[rinon]">
                            ...
                            <option value="2" 
                                    @if( $estudio->formatoHddisc ) 
                                            @if( $estudio->formatoHddisc->enfermedad->rinon == '2' ) 
                                                selected="selected"
                                            @endif
                                    @endif
                                     >No</option>
            ...
            <div class="form-group">
                ...
                <div class="col-md-2">
                    <select class="form-control" name="enfermedades_candidato[epilepsia]">
                            ...
                            <option value="2" 
                                    @if( $estudio->formatoHddisc ) 
                                            @if( $estudio->formatoHddisc->enfermedad->epilepsia == '2' ) 
                                                selected="selected"
                                            @endif
                                    @endif
                                     >No</option>
                ...
                <div class="col-md-2">
                    <select class="form-control" name="enfermedades_candidato[problemas_cardiacos]">
                            ...
                            <option value="2" 
                                    @if( $estudio->formatoHddisc ) 
                                            @if( $estudio->formatoHddisc->enfermedad->problemas_cardiacos == '2' ) 
                                                selected="selected"
                                            @endif
                                    @endif
                                     >No</option>
            ...
            <div class="form-group">
                ...
                <input  type="hidden" 
                        ...
                        value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->padecimiento->id : 0 }}">
                <div class="col-md-2">
                    <select class="form-control" name="padecimientos[acidez]">
                            ...
                            <option value="2" 
                                    @if( $estudio->formatoHddisc ) 
                                            @if( $estudio->formatoHddisc->padecimiento->acidez == '2' ) 
                                                selected="selected"
                                            @endif
                                    @endif
                                     >No</option>
                ...
                <div class="col-md-2">
                    <select class="form-control" name="padecimientos[insomnio]">
                            ...
                            <option value="2" 
                                    @if( $estudio->formatoHddisc ) 
                                            @if( $estudio->formatoHddisc->padecimiento->insomnio == '2' ) 
                                                selected="selected"
                                            @endif
                                    @endif
                                     >No</option>
                ...
                <div class="col-md-2">
                    <select class="form-control" name="padecimientos[debilidad]">
                            ...
                            <option value="2" 
                                    @if( $estudio->formatoHddisc ) 
                                            @if( $estudio->formatoHddisc->padecimiento->debilidad == '2' ) 
                                                selected="selected"
                                            @endif
                                    @endif
                                     >No</option>
            ...
            <div class="form-group">
                ...
                <div class="col-md-2">
                    <select class="form-control" name="padecimientos[ansiedad]">
                            ...
                            <option value="2" 
                                    @if( $estudio->formatoHddisc ) 
                                            @if( $estudio->formatoHddisc->padecimiento->ansiedad == '2' ) 
                                                selected="selected"
                                            @endif
                                    @endif
                                     >No</option>
                ...
                <div class="col-md-2">
                    <select class="form-control" name="padecimientos[escalofrios]">
                            ...
                            <option value="2" 
                                    @if( $estudio->formatoHddisc ) 
                                            @if( $estudio->formatoHddisc->padecimiento->escalofrios == '2' ) 
                                                selected="selected"
                                            @endif
                                    @endif
                                     >No</option>
                ...
                <div class="col-md-2">
                    <select class="form-control" name="padecimientos[mareos]">
                            ...
                            <option value="2" 
                                    @if( $estudio->formatoHddisc ) 
                                            @if( $estudio->formatoHddisc->padecimiento->mareos == '2' ) 
                                                selected="selected"
                                            @endif
                                    @endif
                                     >No</option>
            ...
            <div class="form-group">
                ...
                <div class="col-md-2">
                    <select class="form-control" name="padecimientos[dolor_cabeza]">
                            ...
                            <option value="2" 
                                    @if( $estudio->formatoHddisc ) 
                                            @if( $estudio->formatoHddisc->padecimiento->dolor_cabeza == '2' ) 
                                                selected="selected"
                                            @endif
                                    @endif
                                     >No</option>
                ...
                <div class="col-md-2">
                    <select class="form-control" name="padecimientos[manos_temblorosas]">
                            ...
                            <option value="2" 
                                    @if( $estudio->formatoHddisc ) 
                                            @if( $estudio->formatoHddisc->padecimiento->manos_temblorosas == '2' ) 
                                                selected="selected"
                                            @endif
                                    @endif
                                     >No</option>
                ...
                <div class="col-md-2">
                    <select class="form-control" name="padecimientos[taquicardia]">
                            ...
                            <option value="2" 
                                    @if( $estudio->formatoHddisc ) 
                                            @if( $estudio->formatoHddisc->padecimiento->taquicardia == '2' ) 
                                                selected="selected"
                                            @endif
                                    @endif
                                     >No</option>
            ...
            <div class="form-group">
                ...
                <div class="col-md-2">
                    <select class="form-control" name="padecimientos[estrenimiento]">
                            ...
                            <option value="2" 
                                    @if( $estudio->formatoHddisc ) 
                                            @if( $estudio->formatoHddisc->padecimiento->estrenimiento == '2' ) 
                                                selected="selected"
                                            @endif
                                    @endif
                                     >No</option>
                ...
                <div class="col-md-2">
                    <select class="form-control" name="padecimientos[alergia]">
                            ...
                            <option value="2" 
                                    @if( $estudio->formatoHddisc ) 
                                            @if( $estudio->formatoHddisc->padecimiento->alergia == '2' ) 
                                                selected="selected"
                                            @endif
                                    @endif
                                     >No</option>
                ...
                <div class="col-md-2">
                    <input  type="text" 
                            ...
                            value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->padecimiento->tipo : '' }}">
            ...
            <div class="form-group">
                ...
                <div class="col-md-2">
                    <select class="form-control" name="padecimientos[tratamiento_medico]">
                            ...
                            <option value="2" 
                                    @if( $estudio->formatoHddisc ) 
                                            @if( $estudio->formatoHddisc->padecimiento->tratamiento_medico == '2' ) 
                                                selected="selected"
                                            @endif
                                    @endif
                                     >No</option>
                ...
                <div class="col-md-4">
                    <input  type="text" 
                            ...
                            value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->padecimiento->tratamiento_medico_desc : '' }}">   
                </div>
            </div> 
            <div class="form-group">
                ...
                <div class="col-md-2">
                    <select class="form-control" name="padecimientos[medicamento_controlado]">
                            ...
                            <option value="2" 
                                    @if( $estudio->formatoHddisc ) 
                                            @if( $estudio->formatoHddisc->padecimiento->medicamento_controlado == '2' ) 
                                                selected="selected"
                                            @endif
                                    @endif
                                     >No</option>
                ...
                <div class="col-md-4">
                    <input  type="text" 
                            ...
                            value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->padecimiento->medicamento_controlado_desc : '' }}">   
                </div>
            </div> 
            ...
            @if( $estudio->formatoHddisc )
                @forelse( $estudio->formatoHddisc->padecimiento_familiar as $index => $familiar )
                     <div class="form-group">
                        <label class="col-md-2 text-center control-label">
                            <a  href="javascript:;" 
            ...
            <div class="form-group">
                ...
                <div class="col-md-2">                    
                    <input  type="hidden" 
                            ...
                            value="{{ isset( $estudio->formatoHddisc ) ?  $estudio->formatoHddisc->atencion_medica->id : '0' }}">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <input  type="text" 
                            ...
                            value="{{ isset( $estudio->formatoHddisc ) ?  $estudio->formatoHddisc->atencion_medica->padecimiento : '' }}">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">   
                	<input     type="text" 
                            ...
                            value="{{ isset( $estudio->formatoHddisc ) ?  $estudio->formatoHddisc->atencion_medica->accidente_llamar : '' }}">
                </div>                
                ...
                <div class="col-md-2">   
                    <input  type="text" 
                            ...
                            value="{{ isset( $estudio->formatoHddisc ) ?  $estudio->formatoHddisc->atencion_medica->telefono : '' }}">
                </div>                
            </div>            
        </div>
    </div>
