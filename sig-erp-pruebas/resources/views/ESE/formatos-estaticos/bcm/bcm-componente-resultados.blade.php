    ...
    <div class="panel-body">
        <div class="form-horizontal">
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <input type="hidden" name="resultados[id]" value="{{ isset( $estudio->formatoBcm ) ? $estudio->formatoBcm->id : 0 }}">
                    <input  type="text" 
                            class="form-control" 
                            readonly="readonly" 
                ...
                <div class="col-md-4">
                    {{--<input  type="text" 
                        ...
                        <select class="form-control" name="resultados[resultado_candidato]">
                            ...
                            <option value="2" 
                                    @if( $estudio->formatoBcm ) 
                                            @if( $estudio->formatoBcm->resultado->resultado_candidato == '2' ) 
                                                selected="selected"
                                            @endif
                                    @endif
                            ...
                            <option value="3" 
                                    @if( $estudio->formatoBcm ) 
                                            @if( $estudio->formatoBcm->resultado->resultado_candidato == '3' ) 
                                                selected="selected"
                                            @endif
                                    @endif
                                     >No Apto</option>
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">                    
                    <textarea class="form-control" rows="5" name="resultados[resultados_verificacion_laboral]">{{ isset( $estudio->formatoBcm->resultado ) ? $estudio->formatoBcm->resultado->resultados_verificacion_laboral : '' }}</textarea>
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-2 control-label">Verificación escolar: </label>
                <div class="col-md-10">                    
                    <textarea class="form-control" rows="5" name="resultados[resultados_verificacion_escolar]">{{ isset( $estudio->formatoBcm->resultado ) ? $estudio->formatoBcm->resultado->resultados_verificacion_escolar : '' }}</textarea>
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-2 control-label">Gap employments: </label>
                <div class="col-md-10">                    
                    <textarea class="form-control" rows="5" name="resultados[resultados_gaps]">{{ isset( $estudio->formatoBcm->resultado ) ? $estudio->formatoBcm->resultado->resultados_gaps : '' }}</textarea>
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-2 control-label">Observaciones: </label>
                <div class="col-md-10">                    
                    <textarea class="form-control" rows="2" name="resultados[observaciones]">{{ isset( $estudio->formatoBcm->resultado ) ? trim($estudio->formatoBcm->resultado->observaciones) : '' }}</textarea>
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-2 control-label">Observaciones: </label>
