...
<div id="content" class="content">
	...
	<div class="panel panel-warning" data-sortable-id="ui-widget-12">
		<div class="panel-heading">
			...
			<h4 class="panel-title">Formato FEMSA</h4>
			
		</div>
		<div class="panel-body">

				{{ Form::open(['route' => ['sig-erp-ese::formato-femsa.update', $estudio], 'method' => 'put','enctype'=>'multipart/form-data' ]) }}								
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
					...
					@include('ESE.formatos-estaticos.femsa.femsa-componente-resumen')
					@include('ESE.formatos-estaticos.femsa.femsa-componente-datos-generales')
					@include('ESE.formatos-estaticos.femsa.femsa-componente-documentacion')
					@include('ESE.formatos-estaticos.femsa.femsa-componente-escolaridad')
					@include('ESE.formatos-estaticos.femsa.femsa-componente-datos-familiares')
					@include('ESE.formatos-estaticos.femsa.femsa-componente-datos-situacion-economica')
					@include('ESE.formatos-estaticos.femsa.femsa-componente-bienes')
					@include('ESE.formatos-estaticos.femsa.femsa-componente-informacion-vivienda')
					@include('ESE.formatos-estaticos.femsa.femsa-componente-apreciacion-vivienda')
					@include('ESE.formatos-estaticos.femsa.femsa-domicilio-ubicacion')
					@include('ESE.formatos-estaticos.femsa.femsa-componente-situacion-social')
					
					@include('ESE.formatos-estaticos.femsa.femsa-componente-estado-salud')
					@include('ESE.formatos-estaticos.femsa.femsa-componente-habitos-costumbres')
					@include('ESE.formatos-estaticos.femsa.femsa-componente-disponibilidad')
					
					@include('ESE.formatos-estaticos.femsa.femsa-componente-referencias-personales') 
					@include('ESE.formatos-estaticos.femsa.femsa-informacion-laboral')
...
{{ Form::open(['url' => 'femsa-delete-cursos-realizados','method' => 'POST','id' => 'frm-delete-curso-realizado']) }}
	<input type="hidden" name="id_remove_curso_realizado" value="0" id="id_remove_curso_realizado">	
{{ Form::close() }}


{{ Form::open(['url' => 'femsa-delete-idioma','method' => 'POST','id' => 'frm-delete-idioma']) }}
	<input type="hidden" name="id_remove_idioma" value="0" id="id_remove_idioma">	
{{ Form::close() }}


{{ Form::open(['url' => 'femsa-delete-conocimiento','method' => 'POST','id' => 'frm-delete-conocimiento']) }}
	<input type="hidden" name="id_remove_conocimiento" value="0" id="id_remove_conocimiento">	
{{ Form::close() }}

{{ Form::open(['url' => 'femsa-delete-referencia-personal','method' => 'POST','id' => 'frm-delete-ref-personal']) }}
	<input type="hidden" name="id_remove_ref_personal" value="0" id="id_remove_ref_personal">	
{{ Form::close() }}


{{ Form::open(['url' => 'femsa-delete-referencia-laboral','method' => 'POST','id' => 'frm-delete-ref-laboral']) }}
	<input type="hidden" name="id_remove_ref_laboral" value="0" id="id_remove_ref_laboral">	
{{ Form::close() }}

{{ Form::open(['url' => 'femsa-delete-dato-familiar','method' => 'POST','id' => 'frm-delete-dato-familiar']) }}
	<input type="hidden" name="id_remove_dato_familiar" value="0" id="id_remove_dato_familiar">	
{{ Form::close() }}

{{ Form::open(['url' => 'femsa-delete-familiar-padece','method' => 'POST','id' => 'frm-delete-familiar-padece']) }}
...
let index_curso = {{ isset( $estudio->formatoFemsa ) ? count( $estudio->formatoFemsa->cursos ) : '1' }};
...
/***************************************************************************************************************************************************************************************
									INICIO ADD IDIOMAS
***************************************************************************************************************************************************************************************/
let index_idioma = {{ isset( $estudio->formatoFemsa ) ? count( $estudio->formatoFemsa->idiomas ) : '1' }};
...
***************************************************************************************************************************************************************************************/
let index_conocimiento = {{ isset( $estudio->formatoFemsa ) ? count( $estudio->formatoFemsa->conocmientos_habilidades ) : '1' }};
...
***************************************************************************************************************************************************************************************/
let index_referencia_laboral = {{ isset( $estudio->formatoFemsa ) ? count( $estudio->formatoFemsa->informacion_laboral ) : '1' }};
	    	...
	    	<div id="fila_referencia_laboral_${index_referencia_laboral}">
	    		...
	    		<div class="form-group">
                    ...
                    <div class="form-group">                
                        ...
                        <div class="col-md-3">
                            <input type="text" class="form-control" name="referencia_laboral[${index_referencia_laboral}][sueldo_inicial]" value="">
                        </div>
                    ...
                    <div class="form-group">                
                        ...
                        <div class="col-md-3">
                            <input type="text" class="form-control" name="referencia_laboral[${index_referencia_laboral}][sueldo_final]" value="">
                        </div>
                    ...
                    <div class="form-group"> 
                        ...
                        <div class="col-md-2">
                            <select class="form-control" name="referencia_laboral[${index_referencia_laboral}][robo]">
                    ...
                    <div class="form-group"> 
                        ...
                        <div class="col-md-11">
                          <input class="form-control" name="referencia_laboral[${index_referencia_laboral}][robo_detalle]">
                        </div>
                    </div>
...
***************************************************************************************************************************************************************************************/
let index_referencia_personal = {{ isset( $estudio->formatoFemsa ) ? count( $estudio->formatoFemsa->referencias_personales ) : '1' }};
...
let index_dato_familiar = {{ isset( $estudio->formatoFemsa ) ? count( $estudio->formatoFemsa->datos_familiares ) : '1' }};
...
let index_familiar_padece = {{ isset( $estudio->formatoFemsa ) ? count( $estudio->formatoFemsa->datos_familiares ) : '1' }};
