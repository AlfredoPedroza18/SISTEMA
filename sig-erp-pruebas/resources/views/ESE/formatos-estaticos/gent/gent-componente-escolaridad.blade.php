    ...
    <div class="panel-body">
        <div class="form-horizontal">
            <div class="form-group">
                ...
                <label class="col-md-1 control-label text-center"><strong>Años</strong></label>                
                <label class="col-md-2 control-label text-center"><strong>Comprobante</strong></label>                
                <label class="col-md-1 control-label text-center"><strong>Folio</strong></label>                
            </div>
            <div class="form-group">
                <label class="col-md-2 control-label text-center">Primaria </label>
                <div class="col-md-2 text-center">
                    <input type="hidden" name="escolaridad[0][id]" value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->escolaridad->first()->id : 0 }}">
                    <input type="hidden" name="escolaridad[0][grado]" value="Primaria">
                    <input  type="text" 
                            class="form-control"                              
                            value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->escolaridad->first()->institucion : '' }}" 
                            name="escolaridad[0][institucion]">
                </div>
                <div class="col-md-2 text-center">                    
                    <input  type="text" 
                            class="form-control"                            
                            value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->escolaridad->first()->domicilio : '' }}" 
                            name="escolaridad[0][domicilio]">
                </div>                                
                <div class="col-md-2 text-center">                    
                    <input  type="text" 
                            class="form-control"                            
                            value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->escolaridad->first()->periodo : '' }}" 
                            name="escolaridad[0][periodo]">
                </div>
                <div class="col-md-1 text-center">                    
                    <input  type="text" 
                            class="form-control"                            
                            value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->escolaridad->first()->anios : '' }}" 
                            name="escolaridad[0][anios]">
                </div>
                <div class="col-md-2 text-center">                    
                    <input  type="text" 
                            class="form-control"                            
                            value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->escolaridad->first()->comprobante : '' }}" 
                            name="escolaridad[0][comprobante]">
                </div>
                <div class="col-md-1 text-center">                    
                    <input  type="text" 
                            class="form-control"                            
                            value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->escolaridad->first()->folio : '' }}" 
                            name="escolaridad[0][folio]">
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-2 control-label text-center">Secundaria </label>
                <div class="col-md-2 text-center">
                    <input type="hidden" name="escolaridad[1][id]" value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->escolaridad[1]->id : 0 }}">
                    <input type="hidden" name="escolaridad[1][grado]" value="Secundaria">
                    <input  type="text" 
                            class="form-control"                              
                            value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->escolaridad[1]->institucion : '' }}" 
                            name="escolaridad[1][institucion]">
                </div>
                <div class="col-md-2 text-center">                    
                    <input  type="text" 
                            class="form-control"                            
                            value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->escolaridad[1]->domicilio : '' }}" 
                            name="escolaridad[1][domicilio]">
                </div>                                
                <div class="col-md-2 text-center">                    
                    <input  type="text" 
                            class="form-control"                            
                            value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->escolaridad[1]->periodo : '' }}" 
                            name="escolaridad[1][periodo]">
                </div>
                <div class="col-md-1 text-center">                    
                    <input  type="text" 
                            class="form-control"                            
                            value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->escolaridad[1]->anios : '' }}" 
                            name="escolaridad[1][anios]">
                </div>
                <div class="col-md-2 text-center">                    
                    <input  type="text" 
                            class="form-control"                            
                            value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->escolaridad[1]->comprobante : '' }}" 
                            name="escolaridad[1][comprobante]">
                </div>
                <div class="col-md-1 text-center">                    
                    <input  type="text" 
                            class="form-control"                            
                            value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->escolaridad[1]->folio : '' }}" 
                            name="escolaridad[1][folio]">
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-2 control-label text-center">Técnica </label>
                <div class="col-md-2 text-center">
                    <input type="hidden" name="escolaridad[2][id]" value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->escolaridad[2]->id : 0 }}">
                    <input type="hidden" name="escolaridad[2][grado]" value="Técnica">
                    <input  type="text" 
                            class="form-control"                              
                            value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->escolaridad[2]->institucion : '' }}" 
                            name="escolaridad[2][institucion]">
                </div>
                <div class="col-md-2 text-center">                    
                    <input  type="text" 
                            class="form-control"                            
                            value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->escolaridad[2]->domicilio : '' }}" 
                            name="escolaridad[2][domicilio]">
                </div>                                
                <div class="col-md-2 text-center">                    
                    <input  type="text" 
                            class="form-control"                            
                            value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->escolaridad[2]->periodo : '' }}" 
                            name="escolaridad[2][periodo]">
                </div>
                <div class="col-md-1 text-center">                    
                    <input  type="text" 
                            class="form-control"                            
                            value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->escolaridad[2]->anios : '' }}" 
                            name="escolaridad[2][anios]">
                </div>
                <div class="col-md-2 text-center">                    
                    <input  type="text" 
                            class="form-control"                            
                            value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->escolaridad[2]->comprobante : '' }}" 
                            name="escolaridad[2][comprobante]">
                </div>
                <div class="col-md-1 text-center">                    
                    <input  type="text" 
                            class="form-control"                            
                            value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->escolaridad[2]->folio : '' }}" 
                            name="escolaridad[2][folio]">
                </div>
            </div>
                 <div class="form-group">
                <label class="col-md-2 control-label text-center">Preparatoria </label>
                <div class="col-md-2 text-center">
                    <input type="hidden" name="escolaridad[4][id]" value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->escolaridad[4]->id : 0 }}">
                    <input type="hidden" name="escolaridad[4][grado]" value="Técnica">
                    <input  type="text" 
                            class="form-control"                              
                            value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->escolaridad[4]->institucion : '' }}" 
                            name="escolaridad[4][institucion]">
                </div>
                <div class="col-md-2 text-center">                    
                    <input  type="text" 
                            class="form-control"                            
                            value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->escolaridad[4]->domicilio : '' }}" 
                            name="escolaridad[4][domicilio]">
                </div>                                
                <div class="col-md-2 text-center">                    
                    <input  type="text" 
                            class="form-control"                            
                            value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->escolaridad[4]->periodo : '' }}" 
                            name="escolaridad[4][periodo]">
                </div>
                <div class="col-md-1 text-center">                    
                    <input  type="text" 
                            class="form-control"                            
                            value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->escolaridad[4]->anios : '' }}" 
                            name="escolaridad[4][anios]">
                </div>
                <div class="col-md-2 text-center">                    
                    <input  type="text" 
                            class="form-control"                            
                            value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->escolaridad[4]->comprobante : '' }}" 
                            name="escolaridad[4][comprobante]">
                </div>
                <div class="col-md-1 text-center">                    
                    <input  type="text" 
                            class="form-control"                            
                            value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->escolaridad[4]->folio : '' }}" 
                            name="escolaridad[4][folio]">
                </div>
            </div>
                <div class="form-group">
                <label class="col-md-2 control-label text-center">Otro </label>
                <div class="col-md-2 text-center">
                    <input type="hidden" name="escolaridad[5][id]" value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->escolaridad[5]->id : 0 }}">
                    <input type="hidden" name="escolaridad[5][grado]" value="Técnica">
                    <input  type="text" 
                            class="form-control"                              
                            value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->escolaridad[5]->institucion : '' }}" 
                            name="escolaridad[5][institucion]">
                </div>
                <div class="col-md-2 text-center">                    
                    <input  type="text" 
                            class="form-control"                            
                            value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->escolaridad[5]->domicilio : '' }}" 
                            name="escolaridad[5][domicilio]">
                </div>                                
                <div class="col-md-2 text-center">                    
                    <input  type="text" 
                            class="form-control"                            
                            value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->escolaridad[5]->periodo : '' }}" 
                            name="escolaridad[5][periodo]">
                </div>
                <div class="col-md-1 text-center">                    
                    <input  type="text" 
                            class="form-control"                            
                            value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->escolaridad[5]->anios : '' }}" 
                            name="escolaridad[5][anios]">
                </div>
                <div class="col-md-2 text-center">                    
                    <input  type="text" 
                            class="form-control"                            
                            value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->escolaridad[5]->comprobante : '' }}" 
                            name="escolaridad[5][comprobante]">
                </div>
                <div class="col-md-1 text-center">                    
                    <input  type="text" 
                            class="form-control"                            
                            value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->escolaridad[5]->folio : '' }}" 
                            name="escolaridad[5][folio]">
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-2 control-label text-center">Profesional </label>
                <div class="col-md-2 text-center">
                    <input type="hidden" name="escolaridad[3][id]" value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->escolaridad[3]->id : 0 }}">
                    <input type="hidden" name="escolaridad[3][grado]" value="Profesional">
                    <input  type="text" 
                            class="form-control"                              
                            value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->escolaridad[3]->institucion : '' }}" 
                            name="escolaridad[3][institucion]">
                </div>
                <div class="col-md-2 text-center">                    
                    <input  type="text" 
                            class="form-control"                            
                            value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->escolaridad[3]->domicilio : '' }}" 
                            name="escolaridad[3][domicilio]">
                </div>                                
                <div class="col-md-2 text-center">                    
                    <input  type="text" 
                            class="form-control"                            
                            value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->escolaridad[3]->periodo : '' }}" 
                            name="escolaridad[3][periodo]">
                </div>
                <div class="col-md-1 text-center">                    
                    <input  type="text" 
                            class="form-control"                            
                            value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->escolaridad[3]->anios : '' }}" 
                            name="escolaridad[3][anios]">
                </div>
                <div class="col-md-2 text-center">                    
                    <input  type="text" 
                            class="form-control"                            
                            value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->escolaridad[3]->comprobante : 'asasa' }}" 
                            name="escolaridad[3][comprobante]">
                </div>
                <div class="col-md-1 text-center">                    
                    <input  type="text" 
                            class="form-control"                            
                            value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->escolaridad[3]->folio : '' }}" 
                            name="escolaridad[3][folio]">
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-3 control-label">Si es trunco, ¿Por qué abandonó sus estudios? </label>
                <div class="col-md-9 text-center">                    
                    <input type="hidden" name="escolaridad_obs[id]" value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->escolaridad_obs->id : 0 }}">  
                    <input  type="text" 
                            class="form-control"                            
                            value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->escolaridad_obs->trunco_abandono : '' }}" 
                            name="escolaridad_obs[trunco_abandono]">
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-3 control-label">Si está estudiando, ¿Qué días y en qué horario?</label>
                <div class="col-md-9 text-center">                    
                    <input  type="text" 
                            class="form-control"                            
                            value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->escolaridad_obs->estudia_horario : '' }}" 
                            name="escolaridad_obs[estudia_horario]">
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-2 control-label">Observaciones: </label>
                <div class="col-md-10"> 
                    <textarea class="form-control" rows="3" name="escolaridad_obs[observaciones]">{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->escolaridad_obs->observaciones : '' }}</textarea>
                </div>                
            </div>  
            <div class="form-group">
                <hr>
            ...
            <div class="form-group">
                ...
                <label class="col-md-6 control-label text-center"><strong>Realizó</strong></label>
            </div>
            <div id="cursos-realizados-container">

                @if( $estudio->formatoGent )
                    @forelse( $estudio->formatoGent->cursos as $index => $curso )
                        <div class="form-group">
            ...
            @if( $estudio->formatoGent )
                @forelse( $estudio->formatoGent->idiomas as $index => $idioma )
                    <div class="form-group">
                ...
                @empty
                    <div class="form-group">
                        ...
                        <div class="col-md-1">
                            <input  type="number" class="form-control" name="idiomas[0][porcentaje]" value="0" readonly="readonly">
                        </div>
                    </div>
                @endforelse
            ...
            <div id="conocimientos-container">
                @if( $estudio->formatoGent )
                    @forelse( $estudio->formatoGent->conocmientos_habilidades as $index => $conocimiento )
                        <div class="form-group">
                            <label class="col-md-2 col-md-offset-1 text-center control-label">
                                <a  href="javascript:;" 
