...
<div id="content" class="content">
	...
	<div class="panel panel-warning" data-sortable-id="ui-widget-12">
		...
		<div class="panel-body">							
				{{ Form::open(['route' => ['sig-erp-ese::formato-metlife.update', $estudio], 'method' => 'put','enctype'=>'multipart/form-data' ]) }}				
					
					<div class="form-horizontal">
			            <div class="form-group">
			                <div class="col-md-2 col-md-offset-7 text-right">
			                    <button type="submit" class="btn btn-lg btn-circle btn-primary" title="Guardar"><i class="fa fa-1x fa-save"></i></button>
			                </div>
			                       <div class="col-md-3">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
					...
					@include('ESE.formatos-estaticos.metlife.metlife-componente-encabezado')
					@include('ESE.formatos-estaticos.metlife.metlife-componente-datos-generales')
					@include('ESE.formatos-estaticos.metlife.metlife-componente-documentacion')
					@include('ESE.formatos-estaticos.metlife.metlife-componente-escolaridad')
					@include('ESE.formatos-estaticos.metlife.metlife-componente-cursos')
					@include('ESE.formatos-estaticos.metlife.metlife-componente-idioma')
					@include('ESE.formatos-estaticos.metlife.metlife-componente-conocimientos')
					@include('ESE.formatos-estaticos.metlife.metlife-componente-familia')
					@include('ESE.formatos-estaticos.metlife.metlife-componente-seconomica')
					@include('ESE.formatos-estaticos.metlife.metlife-componente-bienes')
					@include('ESE.formatos-estaticos.metlife.metlife_componente-infovivienda')
					@include('ESE.formatos-estaticos.metlife.metlife_componente-apreciacion')
					@include('ESE.formatos-estaticos.metlife.metlife-componente-ubicacion')
					@include('ESE.formatos-estaticos.metlife.metlife-componente-situacionSocial')
					@include('ESE.formatos-estaticos.metlife.metlife-componente-actividad-fisica')
					@include('ESE.formatos-estaticos.metlife.metlife_componente-disponibilidad')
					@include('ESE.formatos-estaticos.metlife.metlife-componente-rastreo-infonavit')
					@include('ESE.formatos-estaticos.metlife.metlife-componente-referencias-personales')
					@include('ESE.formatos-estaticos.metlife.metlife-componente-referencias-laborales')
...
let index_cursos = {{ isset( $estudio->formatoMetlife->cursoMet ) ? count( $estudio->formatoMetlife->cursoMet ) : '1' }};
...
// --------------------------------------------END CURSOS---------------------------------------------------------------------//
//---------------------------------------------------------IDIOMAS--------------------------------------------//
let index_idioma = {{ isset( $estudio->formatoMetlife->idiomas ) ? count( $estudio->formatoMetlife->idiomas ) : '1' }};
...
// --------------------------------------------END CONOCIMIENTOS---------------------------------------------------------------------//
//---------------------------------------------------------FAMILIA--------------------------------------------//
/*let index_familia = {{ isset( $estudio->formatoMetlife->familia ) ? count( $estudio->formatoMetlife->familia ) : '1' }};
...
let index_personal = {{ isset( $estudio->formatoMetlife->referenciaPersonal) ? count( $estudio->formatoMetlife->referenciaPersonal) : '1' }};
	    ...
	    let template_personal = `
	        	<div id="fila_personal_${index_personal}" attr-row="${index_personal}">
                    ...
                    <div class="col-md-2 col-md-offset-2 text-right">
                        ...
                        <input type="number" maxlength="255" class="form-control" name="referencias_personales[${index_personal}][celular_referencia]" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" min="1" max="99999999999999999" maxlength="13">
                        </div>
                   </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-3 text-left">
                        <input type="number"  class="form-control " name="referencias_personales[${index_personal}][telefono_referencia]" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" min="1" max="99999999999999999" maxlength="13">
                        </div>
                    </div>
                     <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text"  class="form-control" name="referencias_personales[${index_personal}][comentarios_referencia]" maxlength="255">
                        </div>
...
let index_laboral = {{ isset( $estudio->formatoMetlife->referenciaLaborales) ? count( $estudio->formatoMetlife->referenciaLaborales) : '1' }};
	    ...
	    let template_laboral = `
			...
			<div class="form-group">
				...
				<div class="form-group">
                        ...
                        <div class="col-md-3 text-left">
                            <input type="number"  class="form-control" name="referencias_laborales[${index_laboral}][telefono_laboral]"  oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" min="1" max="99999999999999999" maxlength="13">
                        </div>
                    </div>
                 ...
                 <div class="form-group">
                       ...
                       <div class="col-md-2 col-md-offset-1 text-right">
                        ...
                        <div class="col-md-3 text-left">
                            <input type="number"  class="form-control" name="referencias_laborales[${index_laboral}][celular_laboral]"  oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" min="1" max="99999999999999999" maxlength="13">
                        </div>
