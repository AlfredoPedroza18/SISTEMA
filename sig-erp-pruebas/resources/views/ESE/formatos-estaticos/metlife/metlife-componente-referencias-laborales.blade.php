...
<div class="panel panel-primary" data-sortable-id="ui-widget-15">
    ...
    <div class="panel-body">
        ...
        <div id="laboral-container">
                ...
                @foreach ($estudio->formatoMetlife->referenciaLaborales as $indexlaboral => $laboral)
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-3 text-left">
                            <input type="number"  class="form-control" name="referencias_laborales[{{ $indexlaboral }}][telefono_laboral]" value="{{ $laboral->telefono_laboral }}" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" min="1" max="99999999999999999" maxlength="13">
                        </div>
                    </div><!-- end row-->
                </div> <!-- end form-group-->
                 <div class="form-group">
                    <div class="row">
                       <div class="col-md-2 col-md-offset-1 text-right">
                        ...
                        <div class="col-md-3 text-left">
                            <input type="number"  class="form-control" name="referencias_laborales[{{ $indexlaboral }}][celular_laboral]" value="{{ $laboral->celular_laboral }}" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" min="1" max="99999999999999999" maxlength="13">
                        </div>
                    </div><!-- end row-->
                </div> <!-- end form-group-->
                  <div class="form-group">
            ...
            <div id="fila_personal_0" attr-row="0"><!-- START FILA -->
                 <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-3 text-left">
                            <input type="number"  class="form-control" name="referencias_laborales[0][telefono_laborales]"  oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" min="1" max="99999999999999999" maxlength="13">
                        </div>
                    </div><!-- end row-->
                </div> <!-- end form-group-->
                 <div class="form-group">
                    <div class="row">
                       <div class="col-md-2 col-md-offset-1 text-right">
                        ...
                        <div class="col-md-3 text-left">
                            <input type="number"  class="form-control" name="referencias_laborales[0][celular_laboral]"  oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" min="1" max="99999999999999999" maxlength="13">
                        </div>
                    </div><!-- end row-->
                </div> <!-- end form-group-->
                  <div class="form-group">
