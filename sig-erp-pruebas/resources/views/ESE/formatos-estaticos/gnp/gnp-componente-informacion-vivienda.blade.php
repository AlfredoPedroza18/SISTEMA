...
<div class="panel panel-primary" data-sortable-id="ui-widget-15">
    ...
    <div class="form-horizontal">
            ...
            <div class="form-group">
                <div class="col-md-9">
                    <input type="hidden" name="infvivienda[id]" value="{{ isset( $estudio->formatoGnp ) ? $estudio->formatoGnp->id : 0 }}">
              ...
              <div class="form-group">
                <div class="row">
                      <div class="col-md-1  col-md-offset-1 text-center">
                           <input  type="text" 
                            class="form-control" 
                            value="{{ isset( $estudio->formatoGnp) ? $estudio->formatoGnp->vivienda->vivienda_propia: '' }}" 
                      ...
                      <div class="col-md-1 text-center">
                           <input  type="text" 
                            class="form-control" 
                            value="{{ isset( $estudio->formatoGnp) ? $estudio->formatoGnp->vivienda->inmueble_casa: '' }}" 
                      ...
                      <div class="col-md-1 text-center">
                        <input  type="text" 
                            class="form-control" 
                            value="{{ isset( $estudio->formatoGnp) ? $estudio->formatoGnp->vivienda->servicios_luz: '' }}" 
                      ...
                      <div class="col-md-1 text-center">
                        <input  type="text" 
                            class="form-control" 
                            value="{{ isset( $estudio->formatoGnp) ? $estudio->formatoGnp->vivienda->distribucion_sala: '' }}" 
                      ...
                      <div class="col-md-1 text-center">
                        <input  type="text" 
                            class="form-control" 
                            value="{{ isset( $estudio->formatoGnp) ? $estudio->formatoGnp->vivienda->distribucion_jardín: '' }}" 
              ...
              <div class="form-group">
                <div class="row">
                      <div class="col-md-1  col-md-offset-1 text-center">
                           <input  type="text" 
                            class="form-control" 
                            value="{{ isset( $estudio->formatoGnp) ? $estudio->formatoGnp->vivienda->vivienda_rentada: '' }}" 
                      ...
                      <div class="col-md-1 text-center">
                           <input  type="text" 
                            class="form-control" 
                            value="{{ isset( $estudio->formatoGnp) ? $estudio->formatoGnp->vivienda->inmueble_departamento: '' }}" 
                      ...
                      <div class="col-md-1 text-center">
                        <input  type="text" 
                            class="form-control" 
                            value="{{ isset( $estudio->formatoGnp) ? $estudio->formatoGnp->vivienda->servicios_agua: '' }}" 
                      ...
                      <div class="col-md-1 text-center">
                        <input  type="text" 
                            class="form-control" 
                            value="{{ isset( $estudio->formatoGnp) ? $estudio->formatoGnp->vivienda->distribucion_comedor: '' }}" 
                      ...
                      <div class="col-md-1 text-center">
                        <input  type="text" 
                            class="form-control" 
                            value="{{ isset( $estudio->formatoGnp) ? $estudio->formatoGnp->vivienda->distribucion_zotehuela: '' }}" 
             ...
             <div class="form-group">
                <div class="row">
                      <div class="col-md-1  col-md-offset-1 text-center">
                           <input  type="text" 
                            class="form-control" 
                            value="{{ isset( $estudio->formatoGnp) ? $estudio->formatoGnp->vivienda->vivienda_hipotecada: '' }}" 
                      ...
                      <div class="col-md-1 text-center">
                           <input  type="text" 
                            class="form-control" 
                            value="{{ isset( $estudio->formatoGnp) ? $estudio->formatoGnp->vivienda->inmueble_duplex: '' }}" 
                      ...
                      <div class="col-md-1 text-center">
                        <input  type="text" 
                            class="form-control" 
                            value="{{ isset( $estudio->formatoGnp) ? $estudio->formatoGnp->vivienda->servicios_pavimentacion: '' }}" 
                      ...
                      <div class="col-md-1 text-center">
                        <input  type="text" 
                            class="form-control" 
                            value="{{ isset( $estudio->formatoGnp) ? $estudio->formatoGnp->vivienda->distribucion_recamara: '' }}" 
                      ...
                      <div class="col-md-1 text-center">
                        <input  type="text" 
                            class="form-control" 
                            value="{{ isset( $estudio->formatoGnp) ? $estudio->formatoGnp->vivienda->distribucion_patio: '' }}" 
               ...
               <div class="form-group">
                <div class="row">
                      <div class="col-md-1  col-md-offset-1 text-center">
                           <input  type="text" 
                            class="form-control" 
                            value="{{ isset( $estudio->formatoGnp) ? $estudio->formatoGnp->vivienda->vivienda_congelada: '' }}" 
                      ...
                      <div class="col-md-1 text-center">
                           <input  type="text" 
                            class="form-control" 
                            value="{{ isset( $estudio->formatoGnp) ? $estudio->formatoGnp->vivienda->inmueble_condominio: '' }}" 
                      ...
                      <div class="col-md-1 text-center">
                        <input  type="text" 
                            class="form-control" 
                            value="{{ isset( $estudio->formatoGnp) ? $estudio->formatoGnp->vivienda->servicios_drenaje: '' }}" 
                      ...
                      <div class="col-md-1 text-center">
                        <input  type="text" 
                            class="form-control" 
                            value="{{ isset( $estudio->formatoGnp) ? $estudio->formatoGnp->vivienda->distribucion_cocina: '' }}" 
                      ...
                      <div class="col-md-1 text-center">
                        <input  type="text" 
                            class="form-control" 
                            value="{{ isset( $estudio->formatoGnp) ? $estudio->formatoGnp->vivienda->distribucion_estudio: '' }}" 
              ...
              <div class="form-group">
                <div class="row">
                      <div class="col-md-1  col-md-offset-1 text-center">
                           <input  type="text" 
                            class="form-control" 
                            value="{{ isset( $estudio->formatoGnp) ? $estudio->formatoGnp->vivienda->vivienda_prestada: '' }}" 
                      ...
                      <div class="col-md-1 text-center">
                           <input  type="text" 
                            class="form-control" 
                            value="{{ isset( $estudio->formatoGnp) ? $estudio->formatoGnp->vivienda->inmueble_vecindad: '' }}" 
                      ...
                      <div class="col-md-1 text-center">
                        <input  type="text" 
                            class="form-control" 
                            value="{{ isset( $estudio->formatoGnp) ? $estudio->formatoGnp->vivienda->servicios_telefono: '' }}" 
                      ...
                      <div class="col-md-1 text-center">
                        <input  type="text" 
                            class="form-control" 
                            value="{{ isset( $estudio->formatoGnp) ? $estudio->formatoGnp->vivienda->distribucion_bano: '' }}" 
                      ...
                      <div class="col-md-1 text-center">
                        <input  type="text" 
                            class="form-control" 
                            value="{{ isset( $estudio->formatoGnp) ? $estudio->formatoGnp->vivienda->distribucion_cuarto_de_servicio: '' }}" 
              ...
              <div class="form-group">
                <div class="row">
                      <div class="col-md-1  col-md-offset-1 text-center">
                           <input  type="text" 
                            class="form-control" 
                            value="{{ isset( $estudio->formatoGnp) ? $estudio->formatoGnp->vivienda->vivienda_padres: '' }}" 
                      ...
                      <div class="col-md-1 text-center">
                           <input  type="text" 
                            class="form-control" 
                            value="{{ isset( $estudio->formatoGnp) ? $estudio->formatoGnp->vivienda->inmueble_cuarto: '' }}" 
                      ...
                      <div class="col-md-1 text-center">
                        <input  type="text" 
                            class="form-control" 
                            value="{{ isset( $estudio->formatoGnp) ? $estudio->formatoGnp->vivienda->servicios_seg_publica: '' }}" 
                      ...
                      <div class="col-md-1 text-center">
                        <input  type="text" 
                            class="form-control" 
                            value="{{ isset( $estudio->formatoGnp) ? $estudio->formatoGnp->vivienda->distribucion_garaje: '' }}" 
               ...
               <div class="form-group">
                <div class="row">
                      <div class="col-md-1  col-md-offset-1 text-center">
                           <input  type="text" 
                            class="form-control" 
                            value="{{ isset( $estudio->formatoGnp) ? $estudio->formatoGnp->vivienda->vivienda_otro: '' }}" 
                      ...
                      <div class="col-md-1 text-center">
                           <input  type="text" 
                            class="form-control" 
                            value="{{ isset( $estudio->formatoGnp) ? $estudio->formatoGnp->vivienda->inmueble_otro: '' }}" 
                      ...
                      <div class="col-md-1 text-center">
                        <input  type="text" 
                            class="form-control" 
                            value="{{ isset( $estudio->formatoGnp) ? $estudio->formatoGnp->vivienda->servicios_alumbrado: '' }}" 
                      ...
                      <div class="col-md-1 text-center">
                        <input  type="text" 
                            class="form-control" 
                            value="{{ isset( $estudio->formatoGnp) ? $estudio->formatoGnp->vivienda->distribucion_biblioteca: '' }}" 
               ...
               <div class="form-group">
                <div class="row">
                   <div class="col-md-3">
                    ...
                    <input  type="text" 
                            class="form-control" 
                            value="{{ isset( $estudio->formatoGnp) ? $estudio->formatoGnp->vivienda->personas_viven: '' }}" 
