...
<div class="panel panel-primary" data-sortable-id="ui-widget-15">
    ...
    <div class="panel-body">
        ...
        <div id="laboral-container">
                ...
                @foreach ($estudio->formatoGnp->referenciaLaborales as $indexlaboral => $laboral)
...
<textarea class="form-control" placeholder="Describir Situación Socioeconómica " rows="5"   name="referencias_laborales[{{ $indexlaboral }}][principales_funciones_laboral]">{{ $laboral->principales_funciones_laboral }}</textarea>
                   ...
                   <div class="form-group">
                    ...
                    <div class="col-md-1 col-md-offset-1 text-right">
                        ...
                        <div class="col-md-2 text-right">
                         ...
                         <div class="col-md-4 text-left">
                <textarea class="form-control" placeholder="Describir motivo de separación " rows="5"   name="referencias_laborales[{{ $indexlaboral }}][motivo_separacion_laboral]">
                                {{ $laboral->motivo_separacion_laboral }}
                            </textarea>
                ...
                <textarea class="form-control" placeholder="Describir motivo de separación " rows="5"   name="referencias_laborales[{{ $indexlaboral }}][observaciones_laboral]">
                                {{ $laboral->observaciones_laboral }}
                            </textarea>
