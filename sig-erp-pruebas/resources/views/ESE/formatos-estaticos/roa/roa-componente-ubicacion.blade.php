...
<div class="panel panel-primary" data-sortable-id="ui-widget-15">
    ...
    <div class="form-horizontal">
            ...
            <div class="form-group">
                <div class="col-md-9">
                    <input type="hidden" name="ubicacion[id]" value="{{ isset( $estudio->formatoRoa ) ? $estudio->formatoRoa->id : 0 }}">
              ...
              <div class="form-group">
                ...
                <div class="col-md-4 text-right">
                      ...
                      <div class="col-md-5  col-md-offset-1 text-left ">
                           <input  type="text" 
                            class="form-control" 
                            value="{{ isset( $estudio->formatoRoa) ? $estudio->formatoRoa->ubicacionDomicilio->distancia_trabajo: '' }}" 
            ...
            <div class="form-group">
                ...
                <div class="col-md-4 text-right">
                      ...
                      <div class="col-md-5  col-md-offset-1 text-left ">
                           <input  type="text" 
                            class="form-control" 
                            value="{{ isset( $estudio->formatoRoa) ? $estudio->formatoRoa->ubicacionDomicilio->medio_transporte: '' }}" 
