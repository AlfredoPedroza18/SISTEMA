    ...
    <div class="panel-body">
        <div class="form-horizontal">
            ...
            @if($estudio->formatoRoa)
                ...
                @foreach ($estudio->formatoRoa->idiomas as $indexidiomas => $idi)
                    <div class="form-group">
            ...
            @else                
                ...
                <div class="form-group">
                    <input type="hidden" name="idiomas_realizados[0][id]" value="{{ isset( $estudio->formatoRoa) ? $estudio->formatoRoa->idiomas->id : 0 }}">
                    <div class="col-md-2 col-md-offset-2">
