...
<div class="panel panel-primary" data-sortable-id="ui-widget-15">
    ...
    <div class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <input type="hidden" name="datos_generales[id]" value="{{ isset( $estudio->formatoRoa ) ? $estudio->formatoRoa->id : 0 }}">
                    <input  type="text" 
                            class="form-control" 
                            readonly="readonly" 
                ...
                <div class="col-md-3">
                         <select class="form-control" name="datos_generales[sexo]">
                            <option value="1" @if( $estudio->formatoRoa ) @if( $estudio->formatoRoa->datosGenerales->sexo == '1' ) selected="selected" @endif @endif>FEMENINNO</option>
                            <option value="2" @if( $estudio->formatoRoa ) @if( $estudio->formatoRoa->datosGenerales->sexo == '2' ) selected="selected" @endif @endif>MASCULINO</option>
              ...
              <div class="form-group">
                ...
                <div class="col-md-2">
                          <input  type="text" 
                            class="form-control"
                            value="{{ isset( $estudio->formatoRoa) ? $estudio->formatoRoa->datosGenerales->edad: '' }}" 
                  ...
                  <div class="col-md-2">
                            <input  type="date" 
                            class="form-control" 
                             value="{{ isset( $estudio->formatoRoa) ? $estudio->formatoRoa->datosGenerales->fecha_nac : '' }}" 
                  ...
                  <div class="col-md-2">
                            <input  type="text" 
                            class="form-control" 
                             value="{{ isset( $estudio->formatoRoa) ? $estudio->formatoRoa->datosGenerales->lugar_nac : '' }}" 
            ...
            <div class="form-group">
                   ...
                   <div class="col-md-2">
                            <input  type="text" 
                            class="form-control" 
                             value="{{ isset( $estudio->formatoRoa) ? $estudio->formatoRoa->datosGenerales->nacionalidad : '' }}" 
                ...
                <div class="col-md-2">
                         <select class="form-control" name="datos_generales[edo_civil]">
                             <option value="1" @if( $estudio->formatoRoa ) @if( $estudio->formatoRoa->datosGenerales->edo_civil == '1' ) selected="selected" @endif @endif>SOLTERO</option>
                             <option value="2" @if( $estudio->formatoRoa ) @if( $estudio->formatoRoa->datosGenerales->edo_civil == '2' ) selected="selected" @endif @endif>CASADO</option>
                             <option value="3" @if( $estudio->formatoRoa ) @if( $estudio->formatoRoa->datosGenerales->edo_civil == '3' ) selected="selected" @endif @endif>VIUDO</option>
                             <option value="4" @if( $estudio->formatoRoa ) @if( $estudio->formatoRoa->datosGenerales->edo_civil == '4' ) selected="selected" @endif @endif>DIVORCIADO</option>
                  ...
                  <div class="col-md-2">
                            <input  type="date" 
                            class="form-control" 
                             value="{{ isset( $estudio->formatoRoa) ? $estudio->formatoRoa->datosGenerales->fecha_matrimonio : '' }}" 
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                      <input type="text" 
                            class="form-control"
                            value="{{ isset( $estudio->formatoRoa) ? $estudio->formatoRoa->datosGenerales->calle : ''}}" 
            ...
            <div class="form-group">
              <div class="row">
                  ...
                  <div class="col-md-2">
                            <input  type="text" 
                            class="form-control" 
                             value="{{ isset( $estudio->formatoRoa) ? $estudio->formatoRoa->datosGenerales->num_ext: '' }}" 
                  ...
                  <div class="col-md-2">
                            <input  type="text" 
                            class="form-control" 
                             value="{{ isset( $estudio->formatoRoa) ? $estudio->formatoRoa->datosGenerales->num_int: '' }}" 
                  ...
                  <div class="col-md-2">
                            <input  type="text" 
                             class="form-control" 
                             value="{{ isset( $estudio->formatoRoa) ? $estudio->formatoRoa->datosGenerales->municipio : '' }}" 
            ...
            <div class="form-group">
              <div class="row">
                  ...
                  <div class="col-md-2">
                            <input  type="text" 
                            class="form-control" 
                             value="{{ isset( $estudio->formatoRoa) ? $estudio->formatoRoa->datosGenerales->colonia : '' }}" 
                  ...
                  <div class="col-md-2">
                            <input  type="email" 
                            class="form-control" 
                             value="{{ isset( $estudio->formatoRoa) ? $estudio->formatoRoa->datosGenerales->email : '' }}" 
                  ...
                  <div class="col-md-2">
                            ...
                            class="form-control" 
                            value="{{ isset( $estudio->formatoRoa) ? $estudio->formatoRoa->datosGenerales->telefono : '' }}" 
            ...
            <div class="form-group">
                <div class="row">
                  ...
                  <div class="col-md-2">
                            ...
                            oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                            class="form-control" 
                             value="{{ isset( $estudio->formatoRoa) ? $estudio->formatoRoa->datosGenerales->cp : '' }}" 
                  ...
                  <div class="col-md-2">
                            <input  type="text" 
                            class="form-control" 
                             value="{{ isset( $estudio->formatoRoa) ? $estudio->formatoRoa->datosGenerales->tiempo_domicilio : '' }}" 
                  ...
                  <div class="col-md-2">
                            ...
                            oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" 
                            class="form-control" 
                            value="{{ isset( $estudio->formatoRoa) ? $estudio->formatoRoa->datosGenerales->celular : '' }}" 
           ...
           <div class="form-group">
                <div class="row">     
                  ...
                  <div class="col-md-6">
                            <input  type="text" 
                            class="form-control" 
                             value="{{ isset( $estudio->formatoRoa) ? $estudio->formatoRoa->datosGenerales->puesto : '' }}" 
                  ...
                  <div class="col-md-2">
                            ...
                            oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" 
                            class="form-control" 
                            value="{{ isset( $estudio->formatoRoa) ? $estudio->formatoRoa->datosGenerales->telefono_recados : '' }}" 
          ...
          <div class="form-group">
             <div class="row">
                  ...
                  <div class="col-md-8">
                            <input  type="text"
                            class="form-control" 
                             value="{{ isset( $estudio->formatoRoa) ? $estudio->formatoRoa->datosGenerales->entre_calles : '' }}" 
