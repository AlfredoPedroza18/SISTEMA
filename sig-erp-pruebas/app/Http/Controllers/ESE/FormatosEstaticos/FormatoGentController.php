...
use App\ESE\Formatos\Gent\CursoGent;
use App\ESE\Formatos\Gent\IdiomaGent;
use App\ESE\Formatos\Gent\ConocimientosGent;
use App\ESE\Formatos\Gent\ReferenciaPersonalGent;
use App\ESE\Formatos\Gent\InformacionLaboralGent;
use App\ESE\Formatos\Gent\DatoFamiliarGent;
use App\ESE\Formatos\Gent\PadecimientoFamiliarGent;
use App\Helpers\TraitDownloadXls;

class FormatoGentController extends Controller
{
    use TraitDownloadXls;
    /**
    ...
    public function edit( Request $request, $id)
    {
        ...
        if( $estudio && $formato )
        {
            return view('ESE.formatos-estaticos.gent.formato-gent', compact( 'estudio','backToEstudio' ) );
        }      
    ...
    {
        $estudio = EstudioEse::with('FormatoGent')->get()->find( $id );
        ...
        {    
            ...
            {              
                ...
                $formato_sm             = new FormatoGent;
                $formato_sm->fecha_alta = Carbon::now();
                $formato_estudio          = $estudio->formatoGent()->save( $formato_sm );  
            }else{
                $formato_estudio = $estudio->formatoGent;                
            }
    ...
    public function deleteCursoRealizado(Request $request)
    {
        ...
        {
            CursoGent::destroy($request->id_remove_curso_realizado);
        }
    ...
    public function deleteIdioma(Request $request)
    {
        ...
        {
            IdiomaGent::destroy($request->id_remove_idioma);
        }
    ...
    public function deleteConocimiento(Request $request)
    {
        ...
        {
            ConocimientosGent::destroy($request->id_remove_conocimiento);
        }
    ...
    public function deleteReferenciaPersonal(Request $request)
    {
        ...
        {
            ReferenciaPersonalGent::destroy($request->id_remove_ref_personal);
        }
    ...
    public function deleteReferenciaLaboral(Request $request)
    {
        ...
        {
            InformacionLaboralGent::destroy($request->id_remove_ref_laboral);
        }
    ...
    public function deleteDatoFamiliar(Request $request)
    {
        ...
        {
            DatoFamiliarGent::destroy($request->id_remove_dato_familiar);
        }
    ...
    public function deleteFamiliarPadece(Request $request)
    {
        ...
        {
            PadecimientoFamiliarGent::destroy($request->id_remove_familiar_padece);
        }
