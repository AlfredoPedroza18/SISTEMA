            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <div class="form-group">
                        ...
                        {{ Form::text('apellido_paterno_con[]','{apellido_paterno_con}',['class' => 'form-control contact-name','placeholder'=>'Edgar','id'=>'nombre_con','data-parsley-group'=>'wizard-step-3','maxlength'=>''])}}
                ...
                <div class="col-md-3">
                    ...
                    <div class="form-group">
                        ...
                        {{ Form::text('apellido_materno_con[]','{apellido_materno_con}',['class' => 'form-control contact-name','placeholder'=>'Edgar','id'=>'nombre_con','data-parsley-group'=>'wizard-step-3','maxlength'=>''])}}
            ...
            <!-- begin col-2 -->
                 ...
                 <div class="col-md-2">
                    ...
                    <div class="form-group">
                        ...
                        {{ Form::text('telefono1[]','{telefono1}',['class' => 'form-control phone_with_ddd telefonos-size','placeholder'=>'587-020-9993','id'=>'telefono1','data-parsley-group'=>'wizard-step-3','maxlength'=>'10','onblur'=>'sizeTelefonos(this)'])}}
             ...
             <!-- begin col-4 -->
                 ...
                 <div class="col-md-2">
                    ...
                    <div class="form-group">
                        ...
                        {{ Form::text('telefono2[]','{telefono2}',['class' => 'form-control phone_with_ddd telefonos-size','placeholder'=>'587-020-9993','id'=>'telefono2','data-parsley-group'=>'wizard-step-3','maxlength'=>'10','onblur'=>'sizeTelefonos(this)'])}}
