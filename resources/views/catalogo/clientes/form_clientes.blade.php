{{ csrf_field() }}
                          <div id="wizard">
									<ol>
										...
										<li>
										    Contacto ...<center><i class="fa fa-3x fa-male"></i>
										    </center>
										</li>
										<li>
...
<!---------------------------------------- BEGIN DATOS DE PROSPECTO ----------------------------------------------  -->
									...
									<div class="wizard-step-1">
                                        <fieldset>
                                            ...
                                            <font size="1">Nota: (Los campos marcados con * son obligatorios para prospecto )</font><p>
                                                ...
                                                <div class="col-md-4">
													<div class="form-group block1">
														...
														<label>{{ Form::label('Nombre Comercial', '* Nombre Comercial') }}</label>
															...
															{{ Form::text('nombre_comercial',null,['class' => 'form-control','placeholder'=>'Empresa S.A de C.V','id'=>'nombre_comercial','data-parsley-group'=>'wizard-step-1'])}}
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group block1">
                                                        <label>{{ Form::label('Status', 'Status') }}</label>
                                                            {{ Form::select('status',['1'=>'Activo','2'=>'Inactivo','3'=>'Suspensión'],null,['class'=>'form-control','data-live-search'=>'true','data-parsley-group'=>'wizard-step-1','data-style'=>'btn-white','data-size'=>'10','id'=>'status']) }}
...
{{ Form::select('registro_patronal',[''=>'Selecciona una opci&oacute;n','1'=>'Clase I','2'=>'Clase II','3'=>'Clase III','4'=>'Clase IV','5'=>'Clase V'],null,['class'=>'form-control','data-live-search'=>'true','data-parsley-group'=>'wizard-step-1','data-style'=>'btn-white','data-size'=>'10','id'=>'registro_patronal']) }}
                                                    </div>
                                             </div>
                                              <div class="col-md-4">
                                                    <div class="form-group block1">
                                                        ...
                                                        <label>{{ Form::label('Registro Patronal', 'Registro Patronal') }}</label>
                                                         {{ Form::text('registro_p',null,['class' => 'form-control','placeholder'=>'','id'=>'registro_p','data-parsley-group'=>'wizard-step-1','maxlength'=>'11'])}}
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
													<div class="form-group">
                                                        ...
                                                        {{ Form::text('df_cp',null,['class' => 'form-control','placeholder'=>'México','id'=>'demo_cp','data-parsley-group'=>'wizard-step-2','maxlength'=>''])}} 
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        {{ Form::text('dc_cp',null,['class' => 'form-control','placeholder'=>'México','id'=>'demo_dc_cp','data-parsley-group'=>'wizard-step-2','maxlength'=>''])}} 
                                                        <div id="result_search_dc_cp"></div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label>{{ Form::label('Colonia', 'Colonia') }}</label>
                                                            ...
                                                            {{ Form::text('dc_colonia',null,['class' => 'form-control','placeholder'=>'Hidalgo','id'=>'demo_dc_colonia','data-parsley-group'=>'wizard-step-2','maxlength'=>''])}}
                                                            <div id="result_search_dc_colonia"></div>
...
<!---------------------------------------- BEGIN  DATOS DE Contácto ----------------------------------------------  -->
									...
									<div class="wizard-step-3">
										<fieldset>
											<legend class="pull-left col-md-2 col-lg-2 ">Contacto</legend>
                                            <div class="text-left  ">
                                          ...
                                          <div id="container-contacto">
                                              <div id="principal-contacto">  
                                                    ...
                                                    <div class="col-md-3 col-md-offset-9">
                                                        <div class="form-group">
                                                            <label>
                                                                ...
                                                                {{ Form::radio('contacto_first[]', null,false,['class' => 'seleccion_contacto']) }}
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label>{{ Form::label('nickname', '* Nickname') }}</label>
                                                            {!! Form::text('nickname', 'Nombre.ApellidoP.ApellidoM', ['class'=>'form-control', 'id'=>'Nickname', 'required'=>'required', 'readonly']) !!}
                                                        </div>
                                                    </div>
                                                    <!-- end col-4 -->
                                                    <!-- begin col-4 -->
                                                  ...
                                                  <div class="col-md-3">
                                                          <div class="form-group">
                                                              <label>{{ Form::label('Usuario', 'Usuario*') }}</label>
                                                              {{ Form::text('username',null,['class' => 'form-control','placeholder'=>'Lider','id'=>'username','data-parsley-group'=>'wizard-step-4','maxlength'=>''])}}
                                                          </div>
                                                      </div>
                                                      <div class="col-md-3">
                                                          <div class="form-group">
                                                ...
                                                <!-- begin col-2 -->
                                                     <div class="col-md-2">
                                                        <div class="form-group">
                                                            ...
                                                            {{ Form::text('telefono1[]',null,['class' => 'form-control telefono1','placeholder'=>'58702093','id'=>'telefono1','data-parsley-group'=>'wizard-step-3','maxlength'=>'10','onblur'=>'sizeTelefonos(this)'])}}
                                                        </div>
                                                    </div>
                                                <!-- end col-2 -->
                                                <!-- begin col-3 -->
                                                 ...
                                                 <!-- begin col-4 -->
                                                     <div class="col-md-2">
                                                        <div class="form-group">
                                                            ...
                                                            {{ Form::text('telefono2[]',null,['class' => 'form-control telefono2','placeholder'=>'58702093','id'=>'telefono2','data-parsley-group'=>'wizard-step-3','maxlength'=>'10','onblur'=>'sizeTelefonos(this)'])}}
                                                        </div>
                                                    </div>
                                                <!-- end col-4 -->
                                                <!-- begin col-5 -->
...
{{ Form::select('tipo_cliente',$tipo_cliente_lista,null,['class'=>'form-control','data-live-search'=>'true','data-parsley-group'=>'wizard-step-1','data-style'=>'btn-white','data-size'=>'10','id'=>'tipo_cliente']) }}
                                                ...
                                                <div class="col-md-4">
                                                  <div class="form-group">
                                                        ...
                                                        {{ Form::textarea('comentario', null, ['class' => 'form-control','id' => 'comentario','size' => '30x5']) }}
...
{{ Form::select('contrato_a',[''=>'Selecciona una opci&oacute;n','1'=>'PSCC','2'=>'Admon TH','3'=>'Capacitando','4'=>'Human DEV','5'=>'ARCADIA'],null,['class'=>'form-control','data-live-search'=>'true','data-parsley-group'=>'wizard-step-1','data-style'=>'btn-white','data-size'=>'10','id'=>'contrato_a']) }}
                                            ...
                                            <div class="col-md-4">
                                                    <div class="form-group">
                                                         <label>{{ Form::label('Clientes Adignado a', '* Cliente asignado a') }}</label>
                                                 ...
                                                 <div class="col-md-3">
                                                    <div class="form-group">
                                                       <label>{{ Form::label('Clabe', 'Clabe') }}</label>
                                                        {{ Form::number('db_clabe',null,['class' => 'form-control input-sm','placeholder'=>'369852145632897103','id'=>'db_clabe','data-parsley-group'=>'wizard-step-2','maxlength'=>'18',' oninput'=>'javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);'])}}
                                                    </div>
                                                </div>
                                                <!-- end col4 -->
                                            </div>
                                                ...
                                                <!-- end col1 -->
                                                 ...
                                                 <div class="col-md-3">
                                                    <div class="form-group">
                                                       ...
                                                       {{ Form::number('db_limite_credito',null,['class' => 'form-control input-sm','placeholder'=>'99974','id'=>'db_limite_credito','step'=>'any','data-parsley-group'=>'wizard-step-2','maxlength'=>'12',' oninput'=>'javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);'])}}
                                                    </div>
                                                </div>
                                                <!-- end col-2 -->
                                                <!-- begin col-3-->
									...
									<div class="wizard-step-3 final">
									    <div class="jumbotron m-b-0 text-center">
                                         ...
                                         <!--  End ID_EJECUTIVO.-->
                                             ...
                                             {{ Form::button('Guardar', ['class' => 'btn btn-success btn-lg','id' => 'btn-alta-cliente','type'=>'submit']) }}</p>
                                        </div>
									</div>
									<!-- end wizard step-7 -->
								</div>
