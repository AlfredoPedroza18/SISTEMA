<div id="plantilla-contacto" name="container-contacto">
        ...
        <hr>
            ...
            <!-- begin col-2 -->
                 <div class="col-md-2">
                    <div class="form-group">
                        ...
                        {{ Form::text('telefono1[]',null,['class' => 'form-control @if($telefono1[] == null) ivalid @endif telefono1','placeholder'=>'58702093','id'=>'telefono1','onkeyup'=>'CamposLlenos(this);','data-parsley-group'=>'wizard-step-3','maxlength'=>'15','onblur'=>'sizeTelefonos(this)','required'=>'true'])}}
                    </div>
                </div>
            <!-- end col-2 -->
            <!-- begin col-3 -->
            ...
            <div class="col-md-3">
                    <div class="form-group">
                        ...
                        {{ Form::text('correo1[]',null,['class' => 'form-control @if($correo1[] == null) ivalid @endif','placeholder'=>'email@domain.com','id'=>'correo1','onkeyup'=>'CamposLlenos(this);','data-parsley-group'=>'wizard-step-3','onblur'=>'validarEmail(this)','required'=>'true'])}}
