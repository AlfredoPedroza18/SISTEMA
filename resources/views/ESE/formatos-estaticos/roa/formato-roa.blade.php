...
<div id="content" class="content">
	...
	<div class="panel panel-warning" data-sortable-id="ui-widget-12">
		<div class="panel-heading">
			...
			<h4 class="panel-title">Formato de Grupo Roa</h4>
		</div>
		<div class="panel-body">							
				{{ Form::open(['route' => ['sig-erp-ese::formato-roa.update', $estudio], 'method' => 'put' ]) }}				
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
					...
					@include('ESE.formatos-estaticos.roa.roa-componente-encabezado')
				    @include('ESE.formatos-estaticos.roa.roa-componente-datos-generales')
					@include('ESE.formatos-estaticos.roa.roa-componente-documentacion')
				    @include('ESE.formatos-estaticos.roa.roa-componente-escolaridad')
				    @include('ESE.formatos-estaticos.roa.roa-componente-cursos')
				    @include('ESE.formatos-estaticos.roa.roa-componente-idiomas')
				    @include('ESE.formatos-estaticos.roa.roa-componente-conocimientos')
				    @include('ESE.formatos-estaticos.roa.roa-componente-familia')
				    @include('ESE.formatos-estaticos.roa.roa-componente-info-familiar')
				    @include('ESE.formatos-estaticos.roa.roa-componente-seconomica')
				    @include('ESE.formatos-estaticos.roa.roa-componente-bienes')
					@include('ESE.formatos-estaticos.roa.roa-componente-vivienda')
				    @include('ESE.formatos-estaticos.roa.roa-componente-apreciacion')
				    @include('ESE.formatos-estaticos.roa.roa-componente-ubicacion')
				    @include('ESE.formatos-estaticos.roa.roa-componente-situacion-social')
				    @include('ESE.formatos-estaticos.roa.roa-componente-estado-salud')
				    @include('ESE.formatos-estaticos.roa.roa-componente-padecimientos')
				    @include('ESE.formatos-estaticos.roa.roa-componente-tratamiendo-salud')
				    @include('ESE.formatos-estaticos.roa.roa-componente-atencion-medica')
				    @include('ESE.formatos-estaticos.roa.roa-componente-habitos')
				    @include('ESE.formatos-estaticos.roa.roa-componente-disponibilidad')
				    @include('ESE.formatos-estaticos.roa.roa-componente-referencias_personales')
				    @include('ESE.formatos-estaticos.roa.roa-componente-referencias-laborales')
...
{{ Form::open(['url' => 'delete-escolaridad','method' => 'POST','id' => 'frm-delete-escolaridad']) }}
	<input type="hidden" name="id_remove_escolaridad" value="0" id="id_remove_escolaridad">	
{{ Form::close() }}
...
{{ Form::close() }}
{{ Form::open(['url' => 'delete-personal','method' => 'POST','id' => 'frm-delete-personal']) }}
	<input type="hidden" name="id_remove_personal" value="0" id="id_remove_personal">	
{{ Form::close() }}
...
let index_escolaridad = {{ isset( $estudio->formatoRoa->escolariRoa ) ? count( $estudio->formatoRoa->escolariRoa ) : '1' }};
	document.getElementById('add-escolaridad').onclick = function () {
	    let template_escolaridad = `
	        	<div id="fila_escolaridad_${index_escolaridad}" class="form-horizontal">
	                <div class="form-group">
					    <label class="col-md-1 text-center control-label">
					        <a href="javascript:;" class="btn btn-circle btn-danger btn-row-escolaridad" data-btn-delete-escolaridad="${index_escolaridad}">
					...
					<div class="form-group">
						<input type="hidden" name="escolaridad[${index_escolaridad}][id]" value="0">
					    <div class="col-md-2 col-md-offset-1">
					        <input type="text" maxlength="255" class="form-control" name="escolaridad[${index_escolaridad}][grado]">
					    </div>
					    <div class="col-md-2">
					        <input type="text" class="form-control" name="escolaridad[${index_escolaridad}][institucion]">
					    </div>
					     <div class="col-md-2 ">
					        <input type="text"  class="form-control" name="escolaridad[${index_escolaridad}][domicilio]">
					    </div>
					    <div class="col-md-1 ">
					        <input type="text" maxlength="255" class="form-control" name="escolaridad[${index_escolaridad}][periodos]">
					    </div>
					    <div class="col-md-1 ">
					        <input type="text" maxlength="255" class="form-control" name="escolaridad[${index_escolaridad}][años]">
					    </div>
					     <div class="col-md-2 ">
					        <input type="text" maxlength="255" class="form-control" name="escolaridad[${index_escolaridad}][comprobante]">
					    </div>
					    <div class="col-md-1 ">
					        <input type="text" maxlength="255" class="form-control" name="escolaridad[${index_escolaridad}][folio]">
					    </div>
	    ...
	    let container_escolaridad = document.getElementById('escolaridad-container');
	    let div_escolaridad 	  = document.createElement('div');
	    div_escolaridad.innerHTML = template_escolaridad;
	    container_escolaridad.appendChild(div_escolaridad);
	    

	    index_escolaridad++;

	    btn_delete_escolaridad();
	}


	var btn_delete_escolaridad = function()
	{
		$('.btn-row-escolaridad').click(function(){
			 var id_esco = $(this).attr('data-btn-delete-escolaridad');
			 $('#fila_escolaridad_'+id_esco).remove();
		});
	}
// --------------------------------------------END escolaridad---------------------------------------------------------------------//
//---------------------------------------------------------cursos--------------------------------------------//

let index_cursos = {{ isset( $estudio->formatoRoa->cursoMet ) ? count( $estudio->formatoRoa->cursoMet ) : '1' }};
...
// --------------------------------------------END CURSOS---------------------------------------------------------------------//
//---------------------------------------------------------IDIOMAS--------------------------------------------//
let index_idioma = {{ isset( $estudio->formatoRoa->idiomas ) ? count( $estudio->formatoRoa->idiomas ) : '1' }};
...
let index_conocimientos = {{ isset( $estudio->formatoMetlife->conocimientos_ ) ? count( $estudio->formatoMetlife->conocimientos_ ) : '1' }};
...
let index_familia = {{ isset( $estudio->formatoRoa->familia ) ? count( $estudio->formatoRoa->familia) : '1' }};
...
// --------------------------------------------END FAMILIA---------------------------------------------------------------------//
//---------------------------------------------------------ITRATAMIENTO--------------------------------------------//
let index_tratamiento = {{ isset( $estudio->formatoRoa->edoSalud ) ? count( $estudio->formatoRoa->edoSalud ) : '1' }};
...
let index_personal = {{ isset( $estudio->formatoRoa->referenciaPersonal) ? count( $estudio->formatoRoa->referenciaPersonal) : '1' }};
	document.getElementById('add-personal').onclick = function () {
	    let template_personal = `
	        	<div id="fila_personal_${index_personal}" attr-row="${index_personal}">
	                <div class="form-group">
					    <label class="col-md-2 text-center control-label">
					        <a href="javascript:;" class="btn btn-circle btn-danger btn-row-personal" data-btn-delete-personal="${index_personal}">
					            <i class="fa fa-minus"></i>
					        </a>
					    </label>				
					...
					<div>
						...
						<input type="hidden" name="referencias_personales[${index_personal}][id]" value="0">
					    <div class="form-group">
                    <div class="col-md-2 col-md-offset-2 text-right">
                            <label class="control-label">NOMBRE DE LA REFERENCIA:</label>
                        </div>
                        <div class="col-md-3">
                        <input type="text" maxlength="255" class="form-control" name="referencias_personales[${index_personal}][nombre_referencia]">
                        </div>
                        <div class="col-md-2 text-right">
                            <label class="control-label">CELULAR:</label>
                        </div>
                        <div class="col-md-3 text-left">                                        
                        <input type="number" maxlength="255" class="form-control" name="referencias_personales[${index_personal}][celular_referencia]" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" min="1" max="99999999999999999" maxlength="15">
                        </div>
                   </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-3">
                        <input type="text" maxlength="255" class="form-control" name="referencias_personales[${index_personal}][domicilio_referencia]" >
                        </div>
                        <div class="col-md-2 text-right">
                            <label class="control-label">TELÉFONO:</label>
                        </div>
                        <div class="col-md-3 text-left">
                        <input type="number"  class="form-control" name="referencias_personales[${index_personal}][telefono_referencia]" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" min="1" max="99999999999999999" maxlength="15">
                        </div>
                    </div>
                     <div class="form-group">
                        ...
                        <div class="col-md-3">
                        <input type="text" maxlength="255" class="form-control" name="referencias_personales[${index_personal}][ocupacion_referencia]" >
                        </div>
                        <div class="col-md-2 text-right">
                            <label class="control-label">TIEMPO DE CONOCERLO:</label>
                        </div>
                        <div class="col-md-3 text-left">
                        <input type="text"  class="form-control" name="referencias_personales[${index_personal}][tiempo_conocerlo_referencia]" maxlength="15">
                        </div>
                    </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-3">
                        <input type="text" maxlength="255" class="form-control" name="referencias_personales[${index_personal}][empresa_referencia]" >
                        </div>
                        <div class="col-md-2 text-right">
                            <label class="control-label">PARENTESCO:</label>
                        </div>
                        <div class="col-md-3 text-left">
                        <input type="text"  class="form-control" name="referencias_personales[${index_personal}][parentesco_referencia]" maxlength="15">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-md-2 col-md-offset-2 text-right">
                        ...
                        <input type="text"  class="form-control" name="referencias_personales[${index_personal}][comentarios_referencias]" maxlength="255">
                        </div>
	    ...
	    let container_per = document.getElementById('personal-container');
	    let div_per 	  = document.createElement('div');
	    div_per.innerHTML = template_personal;
	    container_per.appendChild(div_per);
	...
	var btn_delete_personal = function()
	{
		$('.btn-row-personal').click(function(){
			 var id_per = $(this).attr('data-btn-delete-personal');
			 $('#fila_personal_'+id_per).remove();
		});
	}
...
//---------------------------------------------------------escolaridads--------------------------------------------//	
		...
		$('.frm-submit-delete-escolaridad').click(function(){
			id_remove_escolaridad = $(this).attr('data-id-delete-escolaridad');
			$('#id_remove_escolaridad').val( id_remove_escolaridad );
			$('#frm-delete-escolaridad').submit()
...
//---------------------------------------------------------PERSONAL--------------------------------------------//	
		...
		$('.frm-submit-delete-personal').click(function(){
			id_remove_personal = $(this).attr('data-id-delete-personal');
			$('#id_remove_personal').val( id_remove_personal );
			$('#frm-delete-personal').submit()
