                    ...
                    <table class="table table-striped">
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td>
                                    <input type="hidden" name="bienes_total[id]" value="{{ isset( $estudio->formatoSM ) ? $estudio->formatoSM->bienes_totales->id : '0' }}">
                                    <input  type="number" class="form-control" name="bienes_total[valor]"  readonly="readonly" id="monto_bienes_total"                                        
                                            value="{{ isset( $estudio->formatoSM ) ? $estudio->formatoSM->bienes_totales->valor : '0.00' }}">
                                </td>
                                <td>
                                    <input  type="number" class="form-control" name="bienes_total[pagado]" readonly="readonly" id="monto_pagado_total" 
                                            value="{{ isset( $estudio->formatoSM ) ? $estudio->formatoSM->bienes_totales->pagado : '0.00' }}">
                                </td>
                                <td class="text-right">
                                    <input  type="number" class="form-control" name="bienes_total[adeudo]" readonly="readonly" id="monto_adeudo_total" 
                                            value="{{ isset( $estudio->formatoSM ) ? $estudio->formatoSM->bienes_totales->adeudo : '0.00' }}">
                                </td>
                            </tr>
                        </tfoot>
                        <tbody>
                            <tr>
                                <td>
                                    <input type="hidden" name="bienes_detalle[0][id]" value="{{ isset( $estudio->formatoSM ) ? $estudio->formatoSM->bienes[0]->id : '0' }}">
                                    ...
                                    <div class="col-md-12">                    
                                        <select class="form-control" name="bienes_detalle[0][tiene]">
                                            ...
                                            @if( $estudio->formatoSM )
                                                @if( $estudio->formatoSM->bienes[0]->tiene == '1' )
                                                    selected="selected"    
                                                @endif
                                            @endif
                                            >Si</option>
                                            <option value="2"
                                            @if( $estudio->formatoSM )
                                                @if( $estudio->formatoSM->bienes[0]->tiene == '2' )
                                                    selected="selected"
                                                @endif
                                            @endif
                                            >No</option>
                                ...
                                <td>
                                    <input  type="text" class="form-control" name="bienes_detalle[0][tipo]"                                             
                                            value="{{ isset( $estudio->formatoSM ) ? $estudio->formatoSM->bienes[0]->tipo : '' }}">
                                </td>
                                <td>
                                    <input  type="number" class="form-control monto_bienes" name="bienes_detalle[0][valor]"                                             
                                            value="{{ isset( $estudio->formatoSM ) ? $estudio->formatoSM->bienes[0]->valor : '0.00' }}">
                                </td>
                                <td>
                                    <input  type="number" class="form-control monto_pagado" name="bienes_detalle[0][pagado]"                                             
                                            value="{{ isset( $estudio->formatoSM ) ? $estudio->formatoSM->bienes[0]->pagado : '0.00' }}">
                                </td>
                                <td>
                                    <input  type="number" class="form-control monto_adeudo" name="bienes_detalle[0][adeudo]"                                             
                                            value="{{ isset( $estudio->formatoSM ) ? $estudio->formatoSM->bienes[0]->adeudo : '0.00' }}">
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <input type="hidden" name="bienes_detalle[1][id]" value="{{ isset( $estudio->formatoSM ) ? $estudio->formatoSM->bienes[1]->id : '0' }}">
                                    <input  type="text" class="form-control" name="bienes_detalle[1][activo]" readonly="readonly"                                             
                                            value="CRÉDITO O HIPOTECA">
                                </td>
                                <td>
                                    <div class="col-md-12">                    
                                        <select class="form-control" name="bienes_detalle[1][tiene]">
                                            <option value="1"
                                            @if( $estudio->formatoSM )
                                                @if( $estudio->formatoSM->bienes[1]->tiene == '1' )
                                                    selected="selected"    
                                                @endif
                                            @endif
                                            >Si</option>
                                            <option value="2"
                                            @if( $estudio->formatoSM )
                                                @if( $estudio->formatoSM->bienes[1]->tiene == '2' )
                                                    selected="selected"
                                                @endif
                                            @endif
                                            >No</option>
                                ...
                                <td>
                                    <input  type="text" class="form-control" name="bienes_detalle[1][tipo]"                                             
                                            value="{{ isset( $estudio->formatoSM ) ? $estudio->formatoSM->bienes[1]->tipo : '' }}">
                                </td>
                                <td>
                                    <input  type="number" class="form-control monto_bienes" name="bienes_detalle[1][valor]"                                             
                                            value="{{ isset( $estudio->formatoSM ) ? $estudio->formatoSM->bienes[1]->valor : '0.00' }}">
                                </td>
                                <td>
                                    <input  type="number" class="form-control monto_pagado" name="bienes_detalle[1][pagado]"                                             
                                            value="{{ isset( $estudio->formatoSM ) ? $estudio->formatoSM->bienes[1]->pagado : '0.00' }}">
                                </td>
                                <td>
                                    <input  type="number" class="form-control monto_adeudo" name="bienes_detalle[1][adeudo]"                                             
                                            value="{{ isset( $estudio->formatoSM ) ? $estudio->formatoSM->bienes[1]->adeudo : '0.00' }}">
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <input type="hidden" name="bienes_detalle[2][id]" value="{{ isset( $estudio->formatoSM ) ? $estudio->formatoSM->bienes[2]->id : '0' }}">
                                ...
                                <td>
                                    <div class="col-md-12">                    
                                        <select class="form-control" name="bienes_detalle[2][tiene]">
                                            <option value="1"
                                            @if( $estudio->formatoSM )
                                                @if( $estudio->formatoSM->bienes[2]->tiene == '1' )
                                                    selected="selected"    
                                                @endif
                                            @endif
                                            >Si</option>
                                            <option value="2"
                                            @if( $estudio->formatoSM )
                                                @if( $estudio->formatoSM->bienes[2]->tiene == '2' )
                                                    selected="selected"
                                                @endif
                                            @endif
                                            >No</option>
                                ...
                                <td>
                                    <input  type="text" class="form-control" name="bienes_detalle[2][tipo]"                                             
                                            value="{{ isset( $estudio->formatoSM ) ? $estudio->formatoSM->bienes[2]->tipo : '' }}">
                                </td>
                                <td>
                                    <input  type="number" class="form-control monto_bienes" name="bienes_detalle[2][valor]"                                             
                                            value="{{ isset( $estudio->formatoSM ) ? $estudio->formatoSM->bienes[2]->valor : '0.00' }}">
                                </td>
                                <td>
                                    <input  type="number" class="form-control monto_pagado" name="bienes_detalle[2][pagado]"                                             
                                            value="{{ isset( $estudio->formatoSM ) ? $estudio->formatoSM->bienes[2]->pagado : '0.00' }}">
                                </td>
                                <td>
                                    <input  type="number" class="form-control monto_adeudo" name="bienes_detalle[2][adeudo]"                                             
                                            value="{{ isset( $estudio->formatoSM ) ? $estudio->formatoSM->bienes[2]->adeudo : '0.00' }}">
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <input type="hidden" name="bienes_detalle[3][id]" value="{{ isset( $estudio->formatoSM ) ? $estudio->formatoSM->bienes[3]->id : '0' }}">
                                ...
                                <td>
                                    <div class="col-md-12">                    
                                        <select class="form-control" name="bienes_detalle[3][tiene]">
                                            <option value="1"
                                            @if( $estudio->formatoSM )
                                                @if( $estudio->formatoSM->bienes[3]->tiene == '1' )
                                                    selected="selected"    
                                                @endif
                                            @endif
                                            >Si</option>
                                            <option value="2"
                                            @if( $estudio->formatoSM )
                                                @if( $estudio->formatoSM->bienes[3]->tiene == '2' )
                                                    selected="selected"
                                                @endif
                                            @endif
                                            >No</option>
                                ...
                                <td>
                                    <input  type="text" class="form-control" name="bienes_detalle[3][tipo]"                                             
                                            value="{{ isset( $estudio->formatoSM ) ? $estudio->formatoSM->bienes[3]->tipo : '' }}">
                                </td>
                                <td>
                                    <input  type="number" class="form-control monto_bienes" name="bienes_detalle[3][valor]"                                             
                                            value="{{ isset( $estudio->formatoSM ) ? $estudio->formatoSM->bienes[3]->valor : '0.00' }}">
                                </td>
                                <td>
                                    <input  type="number" class="form-control monto_pagado" name="bienes_detalle[3][pagado]"                                             
                                            value="{{ isset( $estudio->formatoSM ) ? $estudio->formatoSM->bienes[3]->pagado : '0.00' }}">
                                </td>
                                <td>
                                    <input  type="number" class="form-control monto_adeudo" name="bienes_detalle[3][adeudo]"                                             
                                            value="{{ isset( $estudio->formatoSM ) ? $estudio->formatoSM->bienes[3]->adeudo : '0.00' }}">
                                </td>
                            </tr>
                        </tbody>
                    </table>
