        ...
        <div class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-md-2 text-center">
                    <input type="hidden" name="escolaridad[0][id]" value="{{ isset( $estudio->formatoFemsa ) ? $estudio->formatoFemsa->escolaridad->first()->id : 0 }}">
                    <input type="hidden" name="escolaridad[0][grado]" value="Primaria">
                    <input  type="text" 
                            class="form-control"                              
                            value="{{ isset( $estudio->formatoFemsa ) ? $estudio->formatoFemsa->escolaridad->first()->institucion : '' }}" 
                            name="escolaridad[0][institucion]">
                </div>
                <div class="col-md-2 text-center">                    
                    <input  type="text" 
                            class="form-control"                            
                            value="{{ isset( $estudio->formatoFemsa ) ? $estudio->formatoFemsa->escolaridad->first()->domicilio : '' }}" 
                            name="escolaridad[0][domicilio]">
                </div>                                
                <div class="col-md-2 text-center">                    
                    <input  type="text" 
                            class="form-control"                            
                            value="{{ isset( $estudio->formatoFemsa ) ? $estudio->formatoFemsa->escolaridad->first()->periodo : '' }}" 
                            name="escolaridad[0][periodo]">
                </div>
                <div class="col-md-1 text-center">                    
                    <input  type="text" 
                            class="form-control"                            
                            value="{{ isset( $estudio->formatoFemsa ) ? $estudio->formatoFemsa->escolaridad->first()->anios : '' }}" 
                            name="escolaridad[0][anios]">
                </div>
                <div class="col-md-2 text-center">                    
                    <input  type="text" 
                            class="form-control"                            
                            value="{{ isset( $estudio->formatoFemsa ) ? $estudio->formatoFemsa->escolaridad->first()->comprobante : '' }}" 
                            name="escolaridad[0][comprobante]">
                </div>
                <div class="col-md-1 text-center">                    
                    <input  type="text" 
                            class="form-control"                            
                            value="{{ isset( $estudio->formatoFemsa ) ? $estudio->formatoFemsa->escolaridad->first()->folio : '' }}" 
            ...
            <div class="form-group">
                ...
                <div class="col-md-2 text-center">
                    <input type="hidden" name="escolaridad[1][id]" value="{{ isset( $estudio->formatoFemsa ) ? $estudio->formatoFemsa->escolaridad[1]->id : 0 }}">
                    <input type="hidden" name="escolaridad[1][grado]" value="Secundaria">
                    <input  type="text" 
                            class="form-control"                              
                            value="{{ isset( $estudio->formatoFemsa ) ? $estudio->formatoFemsa->escolaridad[1]->institucion : '' }}" 
                            name="escolaridad[1][institucion]">
                </div>
                <div class="col-md-2 text-center">                    
                    <input  type="text" 
                            class="form-control"                            
                            value="{{ isset( $estudio->formatoFemsa ) ? $estudio->formatoFemsa->escolaridad[1]->domicilio : '' }}" 
                            name="escolaridad[1][domicilio]">
                </div>                                
                <div class="col-md-2 text-center">                    
                    <input  type="text" 
                            class="form-control"                            
                            value="{{ isset( $estudio->formatoFemsa ) ? $estudio->formatoFemsa->escolaridad[1]->periodo : '' }}" 
                            name="escolaridad[1][periodo]">
                </div>
                <div class="col-md-1 text-center">                    
                    <input  type="text" 
                            class="form-control"                            
                            value="{{ isset( $estudio->formatoFemsa ) ? $estudio->formatoFemsa->escolaridad[1]->anios : '' }}" 
                            name="escolaridad[1][anios]">
                </div>
                <div class="col-md-2 text-center">                    
                    <input  type="text" 
                            class="form-control"                            
                            value="{{ isset( $estudio->formatoFemsa ) ? $estudio->formatoFemsa->escolaridad[1]->comprobante : '' }}" 
                            name="escolaridad[1][comprobante]">
                </div>
                <div class="col-md-1 text-center">                    
                    <input  type="text" 
                            class="form-control"                            
                            value="{{ isset( $estudio->formatoFemsa ) ? $estudio->formatoFemsa->escolaridad[1]->folio : '' }}" 
            ...
            <div class="form-group">
                ...
                <div class="col-md-2 text-center">
                    <input type="hidden" name="escolaridad[2][id]" value="{{ isset( $estudio->formatoFemsa ) ? $estudio->formatoFemsa->escolaridad[2]->id : 0 }}">
                    <input type="hidden" name="escolaridad[2][grado]" value="Técnica">
                    <input  type="text" 
                            class="form-control"                              
                            value="{{ isset( $estudio->formatoFemsa ) ? $estudio->formatoFemsa->escolaridad[2]->institucion : '' }}" 
                            name="escolaridad[2][institucion]">
                </div>
                <div class="col-md-2 text-center">                    
                    <input  type="text" 
                            class="form-control"                            
                            value="{{ isset( $estudio->formatoFemsa ) ? $estudio->formatoFemsa->escolaridad[2]->domicilio : '' }}" 
                            name="escolaridad[2][domicilio]">
                </div>                                
                <div class="col-md-2 text-center">                    
                    <input  type="text" 
                            class="form-control"                            
                            value="{{ isset( $estudio->formatoFemsa ) ? $estudio->formatoFemsa->escolaridad[2]->periodo : '' }}" 
                            name="escolaridad[2][periodo]">
                </div>
                <div class="col-md-1 text-center">                    
                    <input  type="text" 
                            class="form-control"                            
                            value="{{ isset( $estudio->formatoFemsa ) ? $estudio->formatoFemsa->escolaridad[2]->anios : '' }}" 
                            name="escolaridad[2][anios]">
                </div>
                <div class="col-md-2 text-center">                    
                    <input  type="text" 
                            class="form-control"                            
                            value="{{ isset( $estudio->formatoFemsa ) ? $estudio->formatoFemsa->escolaridad[2]->comprobante : '' }}" 
                            name="escolaridad[2][comprobante]">
                </div>
                <div class="col-md-1 text-center">                    
                    <input  type="text" 
                            class="form-control"                            
                            value="{{ isset( $estudio->formatoFemsa ) ? $estudio->formatoFemsa->escolaridad[2]->folio : '' }}" 
            ...
            <div class="form-group">
                ...
                <div class="col-md-2 text-center">
                    <input type="hidden" name="escolaridad[3][id]" value="{{ isset( $estudio->formatoFemsa ) ? $estudio->formatoFemsa->escolaridad[3]->id : 0 }}">
                    <input type="hidden" name="escolaridad[3][grado]" value="Profesional">
                    <input  type="text" 
                            class="form-control"                              
                            value="{{ isset( $estudio->formatoFemsa ) ? $estudio->formatoFemsa->escolaridad[3]->institucion : '' }}" 
                            name="escolaridad[3][institucion]">
                </div>
                <div class="col-md-2 text-center">                    
                    <input  type="text" 
                            class="form-control"                            
                            value="{{ isset( $estudio->formatoFemsa ) ? $estudio->formatoFemsa->escolaridad[3]->domicilio : '' }}" 
                            name="escolaridad[3][domicilio]">
                </div>                                
                <div class="col-md-2 text-center">                    
                    <input  type="text" 
                            class="form-control"                            
                            value="{{ isset( $estudio->formatoFemsa ) ? $estudio->formatoFemsa->escolaridad[3]->periodo : '' }}" 
                            name="escolaridad[3][periodo]">
                </div>
                <div class="col-md-1 text-center">                    
                    <input  type="text" 
                            class="form-control"                            
                            value="{{ isset( $estudio->formatoFemsa ) ? $estudio->formatoFemsa->escolaridad[3]->anios : '' }}" 
                            name="escolaridad[3][anios]">
                </div>
                <div class="col-md-2 text-center">                    
                    <input  type="text" 
                            class="form-control"                            
                            value="{{ isset( $estudio->formatoFemsa ) ? $estudio->formatoFemsa->escolaridad[3]->comprobante : 'asasa' }}" 
                            name="escolaridad[3][comprobante]">
                </div>
                <div class="col-md-1 text-center">                    
                    <input  type="text" 
                            class="form-control"                            
                            value="{{ isset( $estudio->formatoFemsa ) ? $estudio->formatoFemsa->escolaridad[3]->folio : '' }}" 
            ...
            <div class="form-group">
                ...
                <div class="col-md-2 text-center">
                    <input type="hidden" name="escolaridad[4][id]" value="{{ isset( $estudio->formatoFemsa ) ? $estudio->formatoFemsa->escolaridad[4]->id : 0 }}">
                    <input type="hidden" name="escolaridad[4][grado]" value="Otro">
                    <input  type="text" 
                            class="form-control"                              
                            value="{{ isset( $estudio->formatoFemsa ) ? $estudio->formatoFemsa->escolaridad[3]->institucion : '' }}" 
            ...
            <div class="form-group">
                ...
                <div class="col-md-9 text-center">                    
                    <input type="hidden" name="escolaridad_obs[id]" value="{{ isset( $estudio->formatoFemsa ) ? $estudio->formatoFemsa->escolaridad_obs->id : 0 }}">  
                    <input  type="text" 
                            class="form-control"                            
                            value="{{ isset( $estudio->formatoFemsa ) ? $estudio->formatoFemsa->escolaridad_obs->trunco_abandono : '' }}" 
            ...
            <div class="form-group">
                ...
                <div class="col-md-9 text-center">                    
                    <input  type="text" 
                            class="form-control"                            
                            value="{{ isset( $estudio->formatoFemsa ) ? $estudio->formatoFemsa->escolaridad_obs->estudia_horario : '' }}" 
            ...
            <div class="form-group">
                ...
                <div class="col-md-10"> 
                    <textarea class="form-control" rows="3" name="escolaridad_obs[observaciones]">{{ isset( $estudio->formatoFemsa ) ? $estudio->formatoFemsa->escolaridad_obs->observaciones : '' }}</textarea>
                </div>                
            </div>  
            <div class="form-group">
                <hr>
            ...
            <div id="cursos-realizados-container">
                ...
                @if( $estudio->formatoFemsa )
                    @forelse( $estudio->formatoFemsa->cursos as $index => $curso )
                        <div class="form-group">
            ...
            @if( $estudio->formatoFemsa )
                @forelse( $estudio->formatoFemsa->idiomas as $index => $idioma )
                    <div class="form-group">
            ...
            <div id="conocimientos-container">
                @if( $estudio->formatoFemsa )
                    @forelse( $estudio->formatoFemsa->conocmientos_habilidades as $index => $conocimiento )
                        <div class="form-group">
                            <label class="col-md-2 col-md-offset-1 text-center control-label">
                                <a  href="javascript:;" 
