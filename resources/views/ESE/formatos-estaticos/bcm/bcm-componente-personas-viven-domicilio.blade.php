    ...
    <div class="panel-body">
        <div class="form-horizontal">
                ...
                @foreach ($estudio->formatoBcm->vivenEnDomicilio as $index => $persona)
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-2 col-md-offset-2">
                            <input type="text" class="form-control" name="viven_domicilio[0][parentesco]" value="{{ $persona->parentesco }}">
                        </div>
                        <div class="col-md-2">
                            <input type="text" class="form-control" name="viven_domicilio[0][nombre]" value="{{ $persona->nombre }}">
                        </div>
                        <div class="col-md-2">
                            <input type="text" class="form-control" name="viven_domicilio[0][edo_civil]" value="{{ $persona->edo_civil }}">
                        </div>
                        <div class="col-md-2">
                            <input type="text" class="form-control" name="viven_domicilio[0][ocupacion]" value="{{ $persona->ocupacion }}">
                        </div>
                        <div class="col-md-2">
                            <input type="text" class="form-control" name="viven_domicilio[0][depende_del_candidato]" value="{{ $persona->depende_del_candidato }}">
                        </div>
                    </div>    
                @endforeach
            ...
            @else                
                ...
                <div class="form-group">
                    <input type="hidden" name="viven_domicilio[0][id]" value="{{ isset( $estudio->formatoBcm->vivenEnDomicilio ) ? $estudio->formatoBcm->vivenEnDomicilio->id : 0 }}">
                    <div class="col-md-2 col-md-offset-2">
        ...
        <div class="form-horizontal">
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <input type="hidden" name="obs_viven_dom[id]" value="{{ isset( $estudio->formatoBcm->observacionesVivenEnDomicilio ) ? $estudio->formatoBcm->observacionesVivenEnDomicilio->id : 0 }}">
                    <textarea class="form-control" rows="3" name="obs_viven_dom[descripcion]">{{ isset( $estudio->formatoBcm->observacionesVivenEnDomicilio ) ? $estudio->formatoBcm->observacionesVivenEnDomicilio->descripcion : '' }}</textarea>
                </div>
            </div>
        </div>
    </div>
