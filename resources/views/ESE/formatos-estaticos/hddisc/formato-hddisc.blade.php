...
<div id="content" class="content">
	...
	<div class="panel panel-warning" data-sortable-id="ui-widget-12">
		<div class="panel-heading">
			...
			<h4 class="panel-title">Formato HDDISC</h4>
		</div>
		<div class="panel-body">

				{{ Form::open(['route' => ['sig-erp-ese::formato-hddisc.update', $estudio], 'method' => 'put','enctype'=>'multipart/form-data' ]) }}								
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
					...
					@include('ESE.formatos-estaticos.hddisc.hddisc-componente-resumen')
					@include('ESE.formatos-estaticos.hddisc.hddisc-componente-datos-generales')
					@include('ESE.formatos-estaticos.hddisc.hddisc-componente-documentacion')
					@include('ESE.formatos-estaticos.hddisc.hddisc-componente-escolaridad')
					@include('ESE.formatos-estaticos.hddisc.hddisc-componente-datos-familiares')
					@include('ESE.formatos-estaticos.hddisc.hddisc-componente-datos-situacion-economica')
					@include('ESE.formatos-estaticos.hddisc.hddisc-componente-bienes')
					@include('ESE.formatos-estaticos.hddisc.hddisc-componente-informacion-vivienda')
					@include('ESE.formatos-estaticos.hddisc.hddisc-componente-apreciacion-vivienda')
					@include('ESE.formatos-estaticos.hddisc.hddisc-domicilio-ubicacion')
					@include('ESE.formatos-estaticos.hddisc.hddisc-componente-situacion-social')
					
					@include('ESE.formatos-estaticos.hddisc.hddisc-componente-estado-salud')
					@include('ESE.formatos-estaticos.hddisc.hddisc-componente-habitos-costumbres')
					@include('ESE.formatos-estaticos.hddisc.hddisc-componente-disponibilidad')
					
					@include('ESE.formatos-estaticos.hddisc.hddisc-componente-referencias-personales') 
					@include('ESE.formatos-estaticos.hddisc.hddisc-informacion-laboral')
...
{{ Form::open(['url' => 'hddisc-delete-cursos-realizados','method' => 'POST','id' => 'frm-delete-curso-realizado']) }}
	<input type="hidden" name="id_remove_curso_realizado" value="0" id="id_remove_curso_realizado">	
{{ Form::close() }}


{{ Form::open(['url' => 'hddisc-delete-idioma','method' => 'POST','id' => 'frm-delete-idioma']) }}
	<input type="hidden" name="id_remove_idioma" value="0" id="id_remove_idioma">	
{{ Form::close() }}


{{ Form::open(['url' => 'hddisc-delete-conocimiento','method' => 'POST','id' => 'frm-delete-conocimiento']) }}
	<input type="hidden" name="id_remove_conocimiento" value="0" id="id_remove_conocimiento">	
{{ Form::close() }}

{{ Form::open(['url' => 'hddisc-delete-referencia-personal','method' => 'POST','id' => 'frm-delete-ref-personal']) }}
	<input type="hidden" name="id_remove_ref_personal" value="0" id="id_remove_ref_personal">	
{{ Form::close() }}


{{ Form::open(['url' => 'hddisc-delete-referencia-laboral','method' => 'POST','id' => 'frm-delete-ref-laboral']) }}
	<input type="hidden" name="id_remove_ref_laboral" value="0" id="id_remove_ref_laboral">	
{{ Form::close() }}

{{ Form::open(['url' => 'hddisc-delete-dato-familiar','method' => 'POST','id' => 'frm-delete-dato-familiar']) }}
	<input type="hidden" name="id_remove_dato_familiar" value="0" id="id_remove_dato_familiar">	
{{ Form::close() }}

{{ Form::open(['url' => 'hddisc-delete-familiar-padece','method' => 'POST','id' => 'frm-delete-familiar-padece']) }}
...
let index_curso = {{ isset( $estudio->formatoHddisc ) ? count( $estudio->formatoHddisc->cursos ) : '1' }};
...
/***************************************************************************************************************************************************************************************
									INICIO ADD IDIOMAS
***************************************************************************************************************************************************************************************/
let index_idioma = {{ isset( $estudio->formatoHddisc ) ? count( $estudio->formatoHddisc->idiomas ) : '1' }};
...
***************************************************************************************************************************************************************************************/
let index_conocimiento = {{ isset( $estudio->formatoHddisc ) ? count( $estudio->formatoHddisc->conocmientos_habilidades ) : '1' }};
...
***************************************************************************************************************************************************************************************/
let index_referencia_laboral = {{ isset( $estudio->formatoHddisc ) ? count( $estudio->formatoHddisc->informacion_laboral ) : '1' }};
...
***************************************************************************************************************************************************************************************/
let index_referencia_personal = {{ isset( $estudio->formatoHddisc ) ? count( $estudio->formatoHddisc->referencias_personales ) : '1' }};
...
let index_dato_familiar = {{ isset( $estudio->formatoHddisc ) ? count( $estudio->formatoHddisc->datos_familiares ) : '1' }};
...
let index_familiar_padece = {{ isset( $estudio->formatoHddisc ) ? count( $estudio->formatoHddisc->datos_familiares ) : '1' }};
