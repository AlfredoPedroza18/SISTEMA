    ...
    <div class="panel-body">
        <div class="form-horizontal">
            ...
            @if( $estudio->formatoHddisc )
                @forelse( $estudio->formatoHddisc->datos_familiares as $index => $familiar )
                    <div class="form-group">
                        <label class="col-md-2 text-center control-label">
                            <a  href="javascript:;" 
            ...
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <input  type="hidden" name="informacion_familiar[id]" 
                            value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->informacion_familiar->id : '0' }}">
                    <input  type="text" class="form-control" name="informacion_familiar[habita_actualmente]" 
                            value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->informacion_familiar->habita_actualmente : '' }}"> 
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <input  type="text" class="form-control" name="informacion_familiar[relacion]" 
                            value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->informacion_familiar->relacion : '' }}">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <input  type="text" class="form-control" name="informacion_familiar[familiares_extranjero]" 
                            value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->informacion_familiar->familiares_extranjero : '' }}">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <input  type="text" class="form-control" name="informacion_familiar[interior_republica]" 
                            value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->informacion_familiar->interior_republica : '' }}">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <input  type="text" class="form-control" name="informacion_familiar[visita_frecuencia]" 
                            value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->informacion_familiar->visita_frecuencia : '' }}">
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-1 control-label">Observaciones: </label>
                <div class="col-md-11">   
                    <textarea class="form-control" rows="3" name="informacion_familiar[observaciones]">{{ isset( $estudio->formatoHddisc->resumen ) ? $estudio->formatoHddisc->informacion_familiar->observaciones : '' }}</textarea>
                </div>                
            </div>
        </div>
    </div>
