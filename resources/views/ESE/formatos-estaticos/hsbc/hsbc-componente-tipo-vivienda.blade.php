...
<div class="panel panel-primary" data-sortable-id="ui-widget-15">
    ...
    <div class="panel-body">
        <div class="form-horizontal">
            ...
            <div class="form-group">
                <input type="hidden" name="tipo_vivienda[id]" value="{{ isset( $estudio->formatoHsbc->tipoVivienda ) ? $estudio->formatoHsbc->tipoVivienda->id : 0 }}">
                <div class="col-md-2 col-md-offset-2">
                    <input  type="text" 
                            class="form-control" 
                            name="tipo_vivienda[propia]"
                            value="{{ isset( $estudio->formatoHsbc->tipoVivienda ) ? $estudio->formatoHsbc->tipoVivienda->propia : '' }}">
                </div>
                <div class="col-md-2">
                    <input  type="text" 
                            class="form-control" 
                            name="tipo_vivienda[hipotecada]"
                            value="{{ isset( $estudio->formatoHsbc->tipoVivienda ) ? $estudio->formatoHsbc->tipoVivienda->hipotecada : '' }}">
                </div>
                <div class="col-md-2">
                    <input  type="text" 
                            class="form-control" 
                            name="tipo_vivienda[rentada]"
                            value="{{ isset( $estudio->formatoHsbc->tipoVivienda ) ? $estudio->formatoHsbc->tipoVivienda->rentada : '' }}">
                </div>
                <div class="col-md-2">
                    <input  type="text" 
                            class="form-control" 
                            name="tipo_vivienda[prestada]"
                            value="{{ isset( $estudio->formatoHsbc->tipoVivienda ) ? $estudio->formatoHsbc->tipoVivienda->prestada : '' }}">
                </div>
                <div class="col-md-2">
                    <input  type="text" 
                            class="form-control" 
                            name="tipo_vivienda[padres]"
                            value="{{ isset( $estudio->formatoHsbc->tipoVivienda ) ? $estudio->formatoHsbc->tipoVivienda->padres : '' }}">
                </div>
            </div>
        </div>
        <div class="form-horizontal">
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <textarea class="form-control" rows="3" name="tipo_vivienda[observaciones]">
