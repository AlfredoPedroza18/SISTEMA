        ...
        <div class="form-horizontal">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <div class="col-md-6 text-center">   
                                        <input type="hidden" name="vivienda_nivel_economico[id]" value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->info_vivienda_nivel_economico->id : '0' }}">                
                                            <input  type="text" 
                                                    name="vivienda_nivel_economico[alta]" 
                                                    class="form-control"
                                                    value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->info_vivienda_nivel_economico->alta : '' }}">
                                ...
                                <td>
                                    ...
                                    <div class="col-md-6 text-center">                   
                                        <input type="hidden" name="vivienda_construccion[id]" value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->vivienda_construccion->id : '0' }}">                
                                            <input  type="text" 
                                                    name="vivienda_construccion[antigua]" 
                                                    class="form-control"
                                                    value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->vivienda_construccion->antigua : '' }}">
                                ...
                                <td>
                                    ...
                                    <div class="col-md-6 text-center"> 
                                        <input type="hidden" name="vivienda_conservacion[id]" value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->vivienda_conservacion->id : '0' }}">                                  
                                            <input  type="text" 
                                                    name="vivienda_conservacion[excelente]" 
                                                    class="form-control"
                                                    value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->vivienda_conservacion->excelente : '' }}">
                                ...
                                <td>
                                    ...
                                    <div class="col-md-6 text-center">                   
                                        <input type="hidden" name="vivienda_conservacion_mobiliario[id]" value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->vivienda_conservacion->id : '0' }}">                                  
                                            <input  type="text" 
                                                    name="vivienda_conservacion_mobiliario[completo]" 
                                                    class="form-control"
                                                    value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->vivienda_calidad_mobiliario->completo : '' }}">
                                ...
                                <td>
                                    ...
                                    <div class="col-md-6 text-center">                  
                                        <input type="hidden" name="vivienda_corte[id]" value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->vivienda_corte->id : '0' }}">                                   
                                            <input  type="text" 
                                                    name="vivienda_corte[variado]" 
                                                    class="form-control"
                                                    value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->vivienda_corte->variado : '' }}">
                                ...
                                <td>
                                    ...
                                    <div class="col-md-6 text-center">                   
                                        <input  type="text" 
                                                ...
                                                class="form-control"
                                                value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->info_vivienda_nivel_economico->media_alta : '' }}">
                                ...
                                <td>
                                    ...
                                    <div class="col-md-6 text-center">                   
                                        <input  type="text" 
                                                ...
                                                class="form-control"
                                                value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->vivienda_construccion->sencilla : '' }}">
                                ...
                                <td>
                                    ...
                                    <div class="col-md-6 text-center">                   
                                        <input  type="text" 
                                                ...
                                                class="form-control"
                                                value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->vivienda_conservacion->bueno : '' }}">
                                ...
                                <td>
                                    ...
                                    <div class="col-md-6 text-center">                   
                                        <input  type="text" 
                                                ...
                                                class="form-control"
                                                value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->vivienda_calidad_mobiliario->incompleto : '' }}">
                                ...
                                <td>
                                    ...
                                    <div class="col-md-6 text-center">                   
                                        <input  type="text" 
                                                ...
                                                class="form-control"
                                                value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->vivienda_corte->conservador : '' }}">
                                ...
                                <td>
                                    ...
                                    <div class="col-md-6 text-center">                   
                                        <input  type="text" 
                                                ...
                                                class="form-control"
                                                value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->info_vivienda_nivel_economico->media : '' }}">
                                ...
                                <td>
                                    ...
                                    <div class="col-md-6 text-center">                   
                                        <input  type="text" 
                                                ...
                                                class="form-control"
                                                value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->vivienda_construccion->moderna : '' }}">
                                ...
                                <td>
                                    ...
                                    <div class="col-md-6 text-center">                   
                                        <input  type="text" 
                                                ...
                                                class="form-control"
                                                value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->vivienda_conservacion->regular : '' }}">
                                ...
                                <td>
                                    ...
                                    <div class="col-md-6 text-center">                   
                                        <input  type="text" 
                                                ...
                                                class="form-control"
                                                value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->vivienda_calidad_mobiliario->escueto : '' }}">
                                ...
                                <td>
                                    ...
                                    <div class="col-md-6 text-center">                   
                                        <input  type="text" 
                                                ...
                                                class="form-control"
                                                value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->vivienda_corte->moderno : '' }}">
                                ...
                                <td>
                                    ...
                                    <div class="col-md-6 text-center">                   
                                        <input  type="text" 
                                                ...
                                                class="form-control"
                                                value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->info_vivienda_nivel_economico->media_baja : '' }}">
                                ...
                                <td>
                                    ...
                                    <div class="col-md-6 text-center">                   
                                        <input  type="text" 
                                                ...
                                                class="form-control"
                                                value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->vivienda_construccion->semi_moderna : '' }}">
                                ...
                                <td>
                                    ...
                                    <div class="col-md-6 text-center">                   
                                        <input  type="text" 
                                                ...
                                                class="form-control"
                                                value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->vivienda_conservacion->malo : '' }}">
                                ...
                                <td>
                                    ...
                                    <div class="col-md-6 text-center">                   
                                        <input  type="text" 
                                                ...
                                                class="form-control"
                                                value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->vivienda_corte->colonial : '' }}">
                                ...
                                <td>
                                    ...
                                    <div class="col-md-6 text-center">                   
                                        <input  type="text" 
                                                ...
                                                class="form-control"
                                                value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->info_vivienda_nivel_economico->baja : '' }}">
                                ...
                                <td>
                                    ...
                                    <div class="col-md-6 text-center">                   
                                        <input  type="text" 
                                                ...
                                                class="form-control"
                                                value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->vivienda_construccion->convencional : '' }}">
                                ...
                                <td>
                                    ...
                                    <div class="col-md-6 text-center">                   
                                        <input  type="text" 
                                                ...
                                                class="form-control"
                                                value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->vivienda_conservacion->pesimo : '' }}">
            ...
            <div class="form-group">
                ...
                <div class="col-md-9 text-center">  
                                <input  type="text" 
                                        ...
                                        class="form-control"
                                        value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->vivienda_corte->condiciones_internas : '' }}">
            ...
            <div class="form-group">
                ...
                <div class="col-md-9 text-center"> 
                                <input  type="text" 
                                        ...
                                        class="form-control"
                                        value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->vivienda_corte->condiciones_externas : '' }}">
            ...
            <div class="form-group">
                ...
                <div class="col-md-2 text-center">                                              
                                <input  type="hidden" 
                                        ...
                                        value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->familiar_empresa->id : '0' }}" >
                ...
                <div class="col-md-5">
                    <input  type="text" 
                            class="form-control"                            
                            value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->familiar_empresa->familiar_empresa_si : '' }}" 
            ...
            <div class="form-group">
                ...
                <div class="col-md-8">
                    <input  type="text" 
                            class="form-control"                            
                            value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->familiar_empresa->reclutador : '' }}" 
            ...
            <div class="form-group">
                ...
                <div class="col-md-8">
                    <input  type="text" 
                            class="form-control"                            
                            value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->familiar_empresa->entero_vacante : '' }}" 
