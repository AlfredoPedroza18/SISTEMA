	...
	<div class="panel-body">
		...
		<div class="form-horizontal">
			<div class="form-group">
				...
				<div class="col-md-4">
					<input type="hidden" name="datos_generales[id]" value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->datos_generales->id : 0 }}">
					<input  type="text" 
					class="form-control" 
					readonly="readonly" 
					...
					<label class="col-md-2 control-label">Sexo: </label>
					 <div class="col-md-3">                    
	                    <select class="form-control" name="datos_generales[sexo]">
	                        ...
	                        <option value="2" 
                                    @if( $estudio->formatoGent ) 
                                            @if( $estudio->formatoGent->datos_generales->sexo == '2' ) 
                                                selected="selected"
                                            @endif
                                    @endif
                                     >Femenino</option>
	            ...
	            <div class="form-group">
					...
					<div class="col-md-2">                    
						<input  type="text" 
						class="form-control"                            
						value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->datos_generales->edad : '' }}" 
					...
					<div class="col-md-2">                    
						<input  type="text" 
						class="form-control"                            
						value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->datos_generales->fecha_nacimiento : '' }}" 
					...
					<div class="col-md-2">                    
						<input  type="text" 
						class="form-control"                            
						value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->datos_generales->lugar_nacimiento : '' }}" 
				...
				<div class="form-group">
					...
					<div class="col-md-2">                    
						<input  type="text" 
						class="form-control"                            
						value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->datos_generales->nacionalidad : '' }}" 
					...
					<div class="col-md-2">                    
						<input  type="text" 
						class="form-control"                            
						value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->datos_generales->edo_civil : '' }}" 
					...
					<div class="col-md-2">                    
						<input  type="text" 
						class="form-control"                            
						value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->datos_generales->fecha_matrimonio : '' }}" 
	            ...
	            <div class="form-group">     
					...
					<div class="col-md-9">                    
						<input  type="text" 
						class="form-control"                            
						value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->datos_generales->calle : '' }}" 
				...
				<div class="form-group">
					...
					<div class="col-md-2">                    
						<input  type="text" 
						class="form-control"                            
						value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->datos_generales->no_exterior : '' }}" 
					...
					<div class="col-md-2">                    
						<input  type="text" 
						class="form-control"                            
						value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->datos_generales->no_interior : '' }}" 
					...
					<div class="col-md-2">                    
						<input  type="text" 
						class="form-control"                            
						value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->datos_generales->delegacion : '' }}" 
				...
				<div class="form-group">
					...
					<div class="col-md-2">                    
						<input  type="text" 
						class="form-control"                            
						value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->datos_generales->colonia : '' }}" 
					...
					<div class="col-md-2">                    
						<input  type="text" 
						class="form-control"                            
						value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->datos_generales->email : '' }}" 
					...
					<div class="col-md-2">                    
						...
						value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->datos_generales->telefono : '' }}" 
				...
				<div class="form-group">
					...
					<div class="col-md-2">                    
						<input  type="text" 
						class="form-control"                            
						value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->datos_generales->cp : '' }}" 
					...
					<div class="col-md-2">                    
						<input  type="text" 
						class="form-control"                            
						value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->datos_generales->tiempo_domicilio : '' }}" 
					...
					<div class="col-md-2">                    
						...
						maxlength="13" 
						class="form-control telefono"                            
						value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->datos_generales->celular : '' }}" 
				...
				<div class="form-group">
					...
					<div class="col-md-4">                    
						<input  type="text" 
						class="form-control"                            
						value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->datos_generales->puesto : '' }}" 
					...
					<div class="col-md-3">                    
						...
						maxlength="13" 
						class="form-control telefono"                            
						value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->datos_generales->telefono_recados : '' }}" 
				...
				<div class="form-group">               
					...
					<div class="col-md-9">                    
						<input  type="text" 
						class="form-control"                            
						value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->datos_generales->entre_calles : '' }}" 
