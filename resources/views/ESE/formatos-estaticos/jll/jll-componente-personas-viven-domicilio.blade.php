    ...
    <div class="panel-body">
        <div class="form-horizontal">
            ...
            @else                
                ...
                <div class="form-group">
                    <input type="hidden" name="viven_domicilio[0][id]" value="{{ isset( $estudio->formatoJll->vivenEnDomicilio ) ? $estudio->formatoJll->vivenEnDomicilio->id : 0 }}">
                    <div class="col-md-2 col-md-offset-2">
        ...
        <div class="form-horizontal">
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <input type="hidden" name="obs_viven_dom[id]" value="{{ isset( $estudio->formatoJll->observacionesVivenEnDomicilio ) ? $estudio->formatoJll->observacionesVivenEnDomicilio->id : 0 }}">
                    <textarea class="form-control" rows="3" name="obs_viven_dom[descripcion]">{{ isset( $estudio->formatoJll->observacionesVivenEnDomicilio ) ? $estudio->formatoJll->observacionesVivenEnDomicilio->descripcion : '' }}</textarea>
                </div>
            </div>
        </div>
    </div>
