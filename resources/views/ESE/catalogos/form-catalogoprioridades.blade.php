...
<ol class="breadcrumb ">
        ...
        <li><a href="{{route('sig-erp-ese::CatalogoTiposServicio.index')}}">Catálogo de servicios</a></li> 


		<li>Alta Prioridades</li>

   </ol>

<h1 class="page-header text-center">Prioridades <small>Alta</small></h1>
	...
	<div class="panel panel-inverse" data-sortable-id="ui-widget-14">
                        ...
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Prioridades <small>Alta</small></h4>

                        </div>

                        <div class="panel-body">

                        <form id="form-alta-prioridades">
...
<!-- ================== BEGIN PAGE LEVEL JS ================== --> 
    ...
    function hacer_click_Prioridades(valor){





    var datos = $("#form-alta-prioridades").serialize();
            ...
            success: function(response){
                ...
                if(response.status_alta == 'success'){
                    ...
                    setTimeout(function(){
                        ...
                        location.href = '{{ route("sig-erp-ese::CatalogoPrioridades.index") }}';
