...
<li><a href="{{ route('sig-erp-ese::catalogosese.index') }}">Catálogos ESE</a></li>
		<li><a href="{{route('sig-erp-ese::AvisoPrivacidad.index')}}">Aviso de Privacidad</a></li>
		<li>Alta Aviso de Privacidad</li>
   </ol>
<h1 class="page-header text-center">Aviso de Privacidad <small>Alta</small></h1>
	...
	<div class="panel panel-inverse" data-sortable-id="ui-widget-14">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Aviso de Privacidad <small>Alta</small></h4>
                        </div>
                        <div class="panel-body">
                        <form id="form-alta-avisoprivacidad">

                          @include('ESE.catalogos.avisoprivacidadcreate')
                        </form>
   </div>
 </div>
@endsection
...
<!-- ================== BEGIN PAGE LEVEL JS ================== -->
    ...
    var datos = $("#form-alta-avisoprivacidad").serialize();
        ...
        $.ajax({
            ...
            success: function(response){
                ...
                if(response.status_alta == 'success'){
                    ...
                    setTimeout(function(){
                        location.href = '{{ route("sig-erp-ese::AvisoPrivacidad.index") }}';
                    });
