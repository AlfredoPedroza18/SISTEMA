...
<ol class="breadcrumb ">
        ...
        <li><a href="{{route('sig-erp-ese::CatalogoTiposServicio.index')}}">Cátalogo de servicios</a></li> 

	

		<li>Alta Modalidades</li>

   </ol>

<h1 class="page-header text-center">Modalidades <small>Alta</small></h1>
	...
	<div class="panel panel-inverse" data-sortable-id="ui-widget-14">
                        ...
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Modalidades <small>Alta</small></h4>

                        </div>

                        <div class="panel-body">

                        <form id="form-alta-modalidades">

                       

                          @include('ESE.catalogos.modalidadescreate')
...
<!-- ================== BEGIN PAGE LEVEL JS ================== --> 
    ...
    function hacer_click_Modalidades(valor){





    var datos = $("#form-alta-modalidades").serialize();
            ...
            success: function(response){
                ...
                if(response.status_alta == 'success'){
                    ...
                    setTimeout(function(){
                        ...
                        location.href = '{{ route("sig-erp-ese::CatalogoModalidades.index") }}';
