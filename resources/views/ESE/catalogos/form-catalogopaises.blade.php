...
<li><a href="{{ route('sig-erp-ese::catalogosese.index') }}">Catálogos ESE</a></li>
		<li><a href="{{route('sig-erp-ese::CatalogoPaises.index')}}">Paises</a></li>
		<li>Alta Paises</li>
   </ol>
<h1 class="page-header text-center">Paises <small>Alta</small></h1>
	...
	<div class="panel panel-inverse" data-sortable-id="ui-widget-14">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Paises <small>Alta</small></h4>
                        </div>
                        <div class="panel-body">
                        <form id="form-alta-paises">
                       
                          @include('ESE.catalogos.paisescreate')
                        </form>
   </div>
 </div>
@endsection
...
<!-- ================== BEGIN PAGE LEVEL JS ================== --> 
    ...
    {!! Html::script('assets/js/sweetalert.min.js') !!}
     ...
     <script>
    function hacer_click_Paises(valor){


    var datos = $("#form-alta-paises").serialize();
        ...
        $.ajax({
            ...
            success: function(response){
                ...
                if(response.status_alta == 'success'){
                    ...
                    setTimeout(function(){
                        location.href = '{{ route("sig-erp-ese::CatalogoPaises.index") }}';
                    });
