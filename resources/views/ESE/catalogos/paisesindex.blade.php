...
<div class="content">
    ...
    <li><a href="{{ route('sig-erp-ese::catalogosese.index') }}">Catálogos ESE</a></li>
		...
		<h1 class="page-header text-center">Países</h1>


			<div class="row">
					<div class="col-md-12 text-right">

								<a href="{{ route('sig-erp-ese::CatalogoPaises.create') }}" class="btn btn-inverse btn-icon btn-circle btn-lg" data-toggle="tooltip" data-placement="top" title="" data-original-title="Alta de Pais">
				...
				<div class="panel panel-inverse" data-sortable-id="ui-widget-14">
						<div class="panel-heading">
							<div class="panel-heading-btn">
								...
								<h4 class="panel-title">Catálogo Países</h4>
						...
						@foreach($paises as $pais)
							<tr>
								...
								<td class="text-center">
									<a href="{{route('sig-erp-ese::CatalogoPaises.edit',$pais->IdPais)}}" class="btn btn-primary btn-icon btn-circle btn-sm btn-editar-registro" data-toggle="tooltip" data-placement="top" title="Editar Registro"><i class="fa fa-pencil"></i></a>&nbsp&nbsp
										<input type="hidden"  value="" data-id="">

                                    {{ Form::open([ 'route' => ['sig-erp-ese::CatalogoPaises.destroy',
                                        $pais->IdPais],
                                        'method' => 'DELETE',
                                        'class'  => 'pull-right'
                                        ]) }}
