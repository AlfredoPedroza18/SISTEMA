...
<li><a href="{{route('sig-erp-ese::CatalogoTiposServicio.index')}}">Catálogos de servicios</a></li>

		<li>Edición Catálogo Tipos de Servicio</li>

   </ol>

<h1 class="page-header text-center">Catálogo Tipos de Servicio <small>Edición</small></h1>
	...
	<div class="panel panel-inverse" data-sortable-id="ui-widget-14">
                        ...
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Catálogo Tipos de Servicio <small>Edición</small></h4>
                       ...
                       {!! Form::model($IdTipos,
                        ...
                        ['route'=>['sig-erp-ese::CTiposServicios.update',$IdTipos],
