...
<div class="content">
    ...
    <li><a href="{{ route('sig-erp-ese::catalogosese.index') }}">Catálogos ESE</a></li>
	    ...
	    <li>Catálogo Personal - Analistas</li>
		...
		<h1 class="page-header text-center">Personal</h1>
			    ...
			    <div class="row">
                    ...
                    <!-- <div class="col-md-2">
								...
								<a href="{{url('CatalogoInvestigadores')}}" class="btn btn-inverse btn-icon btn-circle btn-lg" data-toggle="tooltip" data-placement="top" title="" data-original-title="Investigadores">
									<i class="fa fa-user-plus fa-1x" aria-hidden="true"></i>
								</a>
                    ...
                    <div class="col-md-2">
								...
								<a href="{{url('CatalogoAnalistas')}}" class="btn btn-inverse btn-icon btn-circle btn-lg" data-toggle="tooltip" data-placement="top" title="" data-original-title="Analistas">
									<i class="fa fa-user-plus fa-1x" aria-hidden="true"></i>
								</a>
				...
				<div class="panel panel-inverse" data-sortable-id="ui-widget-14">
						<div class="panel-heading">
							<div class="panel-heading-btn">
								...
								<h4 class="panel-title">Catálogo Personal - Analistas</h4>
						...
						@foreach($empleados as $empleado)
							<tr>
								...
								<td class="text-center">
									<a href="{{route('sig-erp-ese::CatalogoEmpleados.edit',$empleado->IdEmpleado)}}" class="btn btn-primary btn-icon btn-circle btn-sm btn-editar-registro" data-toggle="tooltip" data-placement="top" title="Editar Registro"><i class="fa fa-pencil"></i></a>&nbsp&nbsp
