...
<li><a href="{{ route('sig-erp-ese::catalogosese.index') }}">Catálogos ESE</a></li>
		...
		<li>Edición Aviso de Privacidad</li>
   </ol>
<h1 class="page-header text-center">Aviso de Privacidad <small>Edición</small></h1>

	<div class="panel panel-inverse" data-sortable-id="ui-widget-14">
                        <div class="panel-heading">
                            <div class="panel-heading-btn">
                            </div>
                            <h4 class="panel-title">Tipos de Servicio <small>Edición</small></h4>
                        </div>
                        <div class="panel-body">
                       {!! Form::model($IdAvisoPriv,
                        ['route'=>['sig-erp-ese::AvisoPrivacidad.update',$IdAvisoPriv],
                        'id'=>'form-edit-tiposservicio','method'=>'PUT'])
                        !!}
