...
<li><a href="{{ route('sig-erp-ese::catalogosese.index') }}">Catálogos ESE</a></li>
		...
		<li>Edición Paises</li>
   </ol>
<h1 class="page-header text-center">Paises <small>Edición</small></h1>

	<div class="panel panel-inverse" data-sortable-id="ui-widget-14">
                        <div class="panel-heading">
                            <div class="panel-heading-btn">
                            </div>
                            <h4 class="panel-title">Paises <small>Edición</small></h4>
                        </div>
                        <div class="panel-body">
                       {!! Form::model($IdPais,
                        ['route'=>['sig-erp-ese::CatalogoPaises.update',$IdPais],
                        'id'=>'form-edit-paises','method'=>'PUT'])
                        !!}
