...
<li><a href="{{route('sig-erp-ese::CatalogoTiposServicio.index')}}">Cátalogo de servicios</a></li>
		...
		<li>Edición Modalidades</li>

   </ol>

<h1 class="page-header text-center">Modalidades <small>Edición</small></h1>
	...
	<div class="panel panel-inverse" data-sortable-id="ui-widget-14">
                        ...
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Modalidades <small>Edición</small></h4>

                        </div>

                        <div class="panel-body">

                       {!! Form::model($IdModalidad,

                        ['route'=>['sig-erp-ese::CatalogoModalidades.update',$IdModalidad],

                        'id'=>'form-edit-modalidades','method'=>'PUT'])
