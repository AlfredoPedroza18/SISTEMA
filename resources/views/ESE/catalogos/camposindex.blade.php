                ...
                <div class="modal fade" id="create">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form method="GET" action="{{url('GuardarCampo')}}">
                                <div class="modal-body">
                                        ...
                                        <select class="form-control" id="cntC" name="cntC" required >
                                            ...
                                            <option value="{{ $c->IdAgrupador }}" >{{ $c->Etiqueta }}</option>
                                            @endforeach
                                        </select>
                ...
                <div class="modal fade" id="edit-modal">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form id="form-impuesto-edit" method="GET" action="{{url('GuardarCC')}}">

                                <div class="modal-body">
                                        <label for="nombreA" class="col-form-label">Nombre:</label>
                                        <input type="text" id="nombrecampo" name="nombrecampo" class="form-control" required/>
                                        <label for="nombreA" class="col-form-label">Clasificación:</label>
                                        <input type="text" id="clasificacioncampo" name="clasificacioncampo" class="form-control" required disabled="disabled"/>
                                        <label for="cntA" class="col-form-label">Agrupador:</label>
                        ...
                        <div class="form-group" >
                            ...
                            <div class="input-group">
                                <select class="form-control" name="cnt" onchange="mostrarValor(this.value);">
                                    <option>Seleccione un Agrupador</option>
                                    @foreach($agrupador as $c)
                                    <option value="{{ $c->IdAgrupador }}" >{{ $c->Etiqueta }}</option>
                                    @endforeach
                                </select>
              ...
              <th></th>
						...
						@foreach($campos as $campo)
							<tr>
                                ...
                                <a href="javascript:;" onclick="CampoEdicion({{$campo->IdEntrada}});" class="btn btn-primary btn-icon btn-circle btn-sm btn-editar-registro btn-edit-agrupador">
                ...
                <td> <span class='glyphicon glyphicon-chevron-up arriba'></span>  <span class='glyphicon glyphicon-chevron-down down abajo'> </span> <input class="form-control" type="number" id="num" value="{{ $campo->Orden }}" style="width:100%;"> </td>
...
<script type="text/javascript">
    ...
    function CampoEdicion(id_agrupador){
        // let index 		= $('.btn-edit-agrupador').index(this);
        //     let id_agrupador	= $( $('.id-agrupador').get( index ) ).val();
            // alert(id_agrupador);
    		getCampo( id_agrupador );
	...
	var iniciarTabla = function(){
         ...
         function camponombreUQ(){
            $("#alerta").html("<label style='color:#ffa100;'> <strong> Buscando si el nombre existe </strong> </label>");
             datos = $("#camponombreC").val();
                ...
                $.ajax({
                    ...
                    success: function(response){
                        ...
                        if(response>0){
                            $("#alerta").html("<label style='color:#ffa100;'> <strong> El Nombre del Campo ya existe </strong> </label>");
