...
<li><a href="{{route('sig-erp-ese::CatalogoTiposServicio.index')}}">Catálogos de servicos</a></li>

	

		<li>Alta Catálogo Tipos de Servicio</li>

   </ol>

<h1 class="page-header text-center">Catálogo Tipos de Servicio <small>Alta</small></h1>
	...
	<div class="panel panel-inverse" data-sortable-id="ui-widget-14">
                        ...
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Catálogo Tipos de Servicio <small>Alta</small></h4>

                        </div>

                        <div class="panel-body">

                        <form id="form-alta-tiposservicio">



                          @include('ESE.catalogos.ctiposscreate')
            ...
            success: function(response){
                ...
                if(response.status_alta == 'success'){
                    ...
                    setTimeout(function(){
                        ...
                        location.href = '{{ route("sig-erp-ese::CTiposServicios.index") }}';
