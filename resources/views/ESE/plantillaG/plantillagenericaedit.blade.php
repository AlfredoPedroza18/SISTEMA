...
<li><a href="{{ route('sig-erp-ese::configuracion.index') }}">Configuraciones</a></li>
      <li><a href="javascript:;">Plantilla Genérica</a></li> 
		<li><a href="{{route('sig-erp-ese::CatalogoTiposServicio.index')}}">Plantilla Genérica</a></li>
		<li>Edición Plantilla Genérica</li>
   </ol>
<h1 class="page-header text-center">Plantilla Genérica <small>Edición</small></h1>
	...
	<div class="panel panel-inverse" data-sortable-id="ui-widget-14">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Plantilla Genérica <small>Edición</small></h4>
                        </div>
                        <div class="panel-body">
                       {!! Form::model($IdPlantillaGenerica,
                        ['route'=>['sig-erp-ese::PlantillaGenerica.update',$IdPlantillaGenerica],
                        'id'=>'form-edit-plantillagenerica','method'=>'PUT'])
                        !!}
                       
                          @include('ESE.plantillaG.plantillagedit')
                       {!! Form::close() !!}
   </div>
 </div>
@endsection
