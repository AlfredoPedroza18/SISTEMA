...
<div class="page-break">
  <img src="assets/img/favi-ico/gsh.jpg" alt="logo gent" width="150px" style="margin: -20 0 0 -20;">
  ...
  <table class="tabla">
    ...
    <tr>
      ...
      <td class="gris_blanca" @if($Disponibilidad=="Bueno" ) style="background-color: #3B9DD9;" @endif>&nbsp;</td>
      <td class="gris_blanca" @if($Disponibilidad=="Regular" ) style="background-color: #3B9DD9;" @endif>&nbsp;</td>
      <td class="gris_blanca" @if($Disponibilidad=="Malo" ) style="background-color: #3B9DD9;" @endif>&nbsp;</td>
    ...
    <tr>
      ...
      <td class="gris_blanca" @if($Puntualidad=="Bueno" ) style="background-color: #3B9DD9;" @endif>&nbsp;</td>
      <td class="gris_blanca" @if($Puntualidad=="Regular" ) style="background-color: #3B9DD9;" @endif>&nbsp;</td>
      <td class="gris_blanca" @if($Puntualidad=="Malo" ) style="background-color: #3B9DD9;" @endif>&nbsp;</td>
    </tr>
    <tr>
      <td class="gris_blanca">Seriedad</td>
      <td class="gris_blanca" @if($Seriedad=="Bueno" ) style="background-color: #3B9DD9;" @endif>&nbsp;</td>
      <td class="gris_blanca" @if($Seriedad=="Regular" ) style="background-color: #3B9DD9;" @endif>&nbsp;</td>
      <td class="gris_blanca" @if($Seriedad=="Malo" ) style="background-color: #3B9DD9;" @endif>&nbsp;</td>
    </tr>
    <tr>
      <td class="gris_blanca">Actitud</td>
      <td class="gris_blanca" @if($Actitud=="Bueno" ) style="background-color: #3B9DD9;" @endif>&nbsp;</td>
      <td class="gris_blanca" @if($Actitud=="Regular" ) style="background-color: #3B9DD9;" @endif>&nbsp;</td>
      <td class="gris_blanca" @if($Actitud=="Malo" ) style="background-color: #3B9DD9;" @endif>&nbsp;</td>
    </tr>
    <tr>
      <td class="gris_blanca">Confiabilidad</td>
      <td class="gris_blanca" @if($Confiabilidad=="Bueno" ) style="background-color: #3B9DD9;" @endif>&nbsp;</td>
      <td class="gris_blanca" @if($Confiabilidad=="Regular" ) style="background-color: #3B9DD9;" @endif>&nbsp;</td>
      <td class="gris_blanca" @if($Confiabilidad=="Malo" ) style="background-color: #3B9DD9;" @endif>&nbsp;</td>
    </tr>
    <tr>
      <td class="gris_blanca">Seguridad en sí mismo</td>
      <td class="gris_blanca" @if($Seguridad=="Bueno" ) style="background-color: #3B9DD9;" @endif>&nbsp;</td>
      <td class="gris_blanca" @if($Seguridad=="Regular" ) style="background-color: #3B9DD9;" @endif>&nbsp;</td>
      <td class="gris_blanca" @if($Seguridad=="Malo" ) style="background-color: #3B9DD9;" @endif>&nbsp;</td>
    </tr>
    <tr>
      <td class="gris_blanca">Presentación</td>
      <td class="gris_blanca" @if($Presentacion=="Bueno" ) style="background-color: #3B9DD9;" @endif>&nbsp;</td>
      <td class="gris_blanca" @if($Presentacion=="Regular" ) style="background-color: #3B9DD9;" @endif>&nbsp;</td>
      <td class="gris_blanca" @if($Presentacion=="Malo" ) style="background-color: #3B9DD9;" @endif>&nbsp;</td>
    </tr>
...
<div class="page-break">
  ...
  <table class="tabla">
    <tr>
      ...
      <td class="gris_blanca" style="text-align: center; width: 30px; @if($SitEcoDatoMedEnfermedadCro=='Si') background-color:#3B9DD9 @endif">Si</td>
      <td class="gris_blanca" style="text-align: center; width: 30px; @if($SitEcoDatoMedEnfermedadCro=='No') background-color:#3B9DD9 @endif">No</td>
    ...
    <tr>
      ...
      <td class="gris_blanca" style="text-align: center; @if($SitEcoDatoMedTratamientoMed=='Si') background-color:#3B9DD9 @endif">Si</td>
      <td class="gris_blanca" style="text-align: center; @if($SitEcoDatoMedTratamientoMed=='No') background-color:#3B9DD9 @endif">No</td>
    ...
    <tr>
      ...
      <td class="gris_blanca" style="text-align: center; @if($SitEcoDatoMedAlergico=='Si') background-color:#3B9DD9 @endif">Si</td>
      <td class="gris_blanca" style="text-align: center; @if($SitEcoDatoMedAlergico=='No') background-color:#3B9DD9 @endif">No</td>
    ...
    <tr>
      ...
      <td class="gris_blanca" style="text-align: center; @if($SitEcoDatoMedControlado=='Si') background-color:#3B9DD9 @endif">Si</td>
      <td class="gris_blanca" style="text-align: center; @if($SitEcoDatoMedControlado=='No') background-color:#3B9DD9 @endif">No</td>
      <td class="gris_blanca" style="text-align: center;">¿Cuál?</td>
  ...
  <table class="tabla">
    ...
    <tr>
      ...
      <td class="gris_blanca" style="text-align: center; width: 40px; height: 20px; @if($ViviendaTipoLuz=='Si') background-color:#3B9DD9 @endif">Luz</td>
      <td class="gris_blanca" style="text-align: center; width: 40px; @if($ViviendaTipoAgua=='Si') background-color:#3B9DD9 @endif">Agua</td>
      <td class="gris_blanca" style="text-align: center; width: 40px; @if($ViviendaTipoGas=='Si') background-color:#3B9DD9 @endif">Gas</td>
      <td class="gris_blanca" style="text-align: center; width: 50px; @if($ViviendaTipoDrenaje=='Si') background-color:#3B9DD9 @endif">Drenaje</td>
    </tr>
  </table>
  ...
  <table class="tabla">
    ...
    <tr>
      <td class="gris_blanca" style="text-align: center; height: 20px; width: 148px; @if($ViviendaTipoTipoCasa=='Casa') background-color:#3B9DD9; @endif">Casa</td>
      <td class="gris_blanca" style="text-align: center; height: 20px; width: 148px; @if($ViviendaTipoTipoCasa=='Departamento') background-color:#3B9DD9; @endif">Departamento</td>
      <td class="gris_blanca" style="text-align: center; height: 20px; width: 148px; @if($ViviendaTipoTipoCasa=='Condominio') background-color:#3B9DD9; @endif">Condominio</td>
      <td class="gris_blanca" style="text-align: center; height: 20px; width: 148px; @if($ViviendaTipoTipoCasa=='Unidad Habitacional') background-color:#3B9DD9; @endif">Unidad Habitacional</td>
      <td class="gris_blanca" style="text-align: center; height: 20px; width: 148px; @if($ViviendaTipoTipoCasa=='Vivienda popular') background-color:#3B9DD9; @endif">Vivienda Popular</td>
    </tr>
  </table>
  ...
  <table class="sinTabla2">
    ...
    <tr>
      ...
      <td class="gris_blanca" style="border: solid 1px black; width:80px; @if($SitEcoEgreMenTipo=='Renta') background-color: #3B9DD9  @endif">Renta</td>
      <td class="gris_blanca" style="border: solid 1px black ; width:80px; @if($SitEcoEgreMenTipo=='Hipoteca') background-color: #3B9DD9  @endif">Hipoteca</td>
      <td class="gris_blanca" style="border: solid 1px black ; width:80px; @if($SitEcoEgreMenTipo=='Predial') background-color: #3B9DD9  @endif">Predial</td>
...
<div class="page-break">
  ...
  <table class="tabla">
    ...
    <tr>
      ...
      <td class="gris_blanca" style="@if($SitEcoBienesraices=='Si') background-color: #3B9DD9 ;@endif text-align: center; height: 18px;">Si</td>
      <td class="gris_blanca" style="@if($SitEcoBienesraices=='No') background-color: #3B9DD9 ;@endif text-align: center; height: 18px;">No</td>
   ...
   <table class="tabla" style="margin-top:20px margin-bottom=20px">
    ...
    <table class="tabla">
      <tr>
        ...
        <td class="gris_blaca" style="height: 18px; background-color: #3B9DD9; width: 50px; text-align: center;">@if($AntLegAlgunaVezFueDetenido=='') &nbsp; @else {{$AntLegAlgunaVezFueDetenido}} @endif</td>
      </tr>
      <tr>
    ...
    <table class="tabla">
      <tr>
        ...
        <td class="gris_blanca" style="height: 18px; background-color: #3B9DD9; width: 40px; text-align: center;">@if($LaboFamiliar=='') &nbsp; @else {{$LaboFamiliar}} @endif</td>
      ...
      <tr>
        ...
        <td class="gris_blanca" style="background-color: #3B9DD9; text-align: center;">@if($LaboDisponibilidadViajar=='') &nbsp; @else {{$LaboDisponibilidadViajar}} @endif</td>
      ...
      <tr>
        ...
        <td class="gris_blanca" style="height: 18px; background-color: #3B9DD9; text-align: center;">@if($LaboDisponibiliddadCambiarRes=='') &nbsp; @else {{$LaboDisponibiliddadCambiarRes}} @endif</td>
        <td class="gris" style="height: 18px;">Motivo</td>
    ...
    @for($z=0;$z<=1;$z++) @if($TrayecLaboralAplica[$lo]=='Si' || $TrayecLaboralAplica[$lo]=='SI' || $TrayecLaboralAplica[$lo]=='si' ) <!--<p style="font-family: century-gothic, sans-serif; font-size: 9; text-align: center; margin-bottom: 0;">Trayectoria laboral</p>
      ...
      <table class="tabla" style="margin-top: 0;">
        <tr>
          ...
          <td class="gris_blanca" style="width: 30px;  text-align: center; background-color: #3B9DD9;">@if($TrayecLaboralPertenecioSindica[$lo]=='') &nbsp; @else @if($TrayecLaboralPertenecioSindica[$lo]!='No aplica') {{$TrayecLaboralPertenecioSindica[$lo]}} @else N/A @endif @endif</td>
      ...
      <table class="tabla" style="margin-top: 10px;">
        ...
        <tr>
          ...
          <td class="gris_blanca" style=" @if($TrayecLaboralCriHonradez[$lo]=='Excelente') background-color:#3B9DD9; @endif">&nbsp;</td>
          <td class="gris_blanca" style=" @if($TrayecLaboralCriHonradez[$lo]=='Bueno') background-color:#3B9DD9; @endif">&nbsp;</td>
          <td class="gris_blanca" style=" @if($TrayecLaboralCriHonradez[$lo]=='Regular') background-color:#3B9DD9; @endif">&nbsp;</td>
          <td class="gris_blanca" style=" @if($TrayecLaboralCriHonradez[$lo]=='Malo') background-color:#3B9DD9; @endif">&nbsp;</td>
        ...
        <tr>
          ...
          <td class="gris_blanca" style=" @if($TrayecLaboralCriCalidadTrabajo[$lo]=='Excelente') background-color:#3B9DD9; @endif">&nbsp;</td>
          <td class="gris_blanca" style=" @if($TrayecLaboralCriCalidadTrabajo[$lo]=='Bueno') background-color:#3B9DD9; @endif">&nbsp;</td>
          <td class="gris_blanca" style=" @if($TrayecLaboralCriCalidadTrabajo[$lo]=='Regular') background-color:#3B9DD9; @endif">&nbsp;</td>
          <td class="gris_blanca" style=" @if($TrayecLaboralCriCalidadTrabajo[$lo]=='Malo') background-color:#3B9DD9; @endif">&nbsp;</td>
        </tr>
        <tr>
          <td class="gris_blanca" style="text-align: center;">Relación con superiores </td>
          <td class="gris_blanca" style=" @if($TrayecLaboralCriRelacionSuperi[$lo]=='Excelente') background-color:#3B9DD9; @endif">&nbsp;</td>
          <td class="gris_blanca" style=" @if($TrayecLaboralCriRelacionSuperi[$lo]=='Bueno') background-color:#3B9DD9; @endif">&nbsp;</td>
          <td class="gris_blanca" style=" @if($TrayecLaboralCriRelacionSuperi[$lo]=='Regular') background-color:#3B9DD9; @endif">&nbsp;</td>
          <td class="gris_blanca" style=" @if($TrayecLaboralCriRelacionSuperi[$lo]=='Malo') background-color:#3B9DD9; @endif">&nbsp;</td>
        </tr>
        <tr>
          <td class="gris_blanca" style="text-align: center;">Relación con compañeros</td>
          <td class="gris_blanca" style=" @if($TrayecLaboralCriRelacionCompan[$lo]=='Excelente') background-color:#3B9DD9; @endif">&nbsp;</td>
          <td class="gris_blanca" style=" @if($TrayecLaboralCriRelacionCompan[$lo]=='Bueno') background-color:#3B9DD9; @endif">&nbsp;</td>
          <td class="gris_blanca" style=" @if($TrayecLaboralCriRelacionCompan[$lo]=='Regular') background-color:#3B9DD9; @endif">&nbsp;</td>
          <td class="gris_blanca" style=" @if($TrayecLaboralCriRelacionCompan[$lo]=='Malo') background-color:#3B9DD9; @endif">&nbsp;</td>
        </tr>
        <tr>
          <td class="gris_blanca" style="text-align: center;">Productividad</td>
          <td class="gris_blanca" style=" @if($TrayecLaboralCriProductividad[$lo]=='Excelente') background-color:#3B9DD9; @endif">&nbsp;</td>
          <td class="gris_blanca" style=" @if($TrayecLaboralCriProductividad[$lo]=='Bueno') background-color:#3B9DD9; @endif">&nbsp;</td>
          <td class="gris_blanca" style=" @if($TrayecLaboralCriProductividad[$lo]=='Regular') background-color:#3B9DD9; @endif">&nbsp;</td>
          <td class="gris_blanca" style=" @if($TrayecLaboralCriProductividad[$lo]=='Malo') background-color:#3B9DD9; @endif">&nbsp;</td>
          <td class="gris">Informó:</td>
        </tr>
        <tr>
          <td class="gris_blanca" style="text-align: center;">Iniciativa</td>
          <td class="gris_blanca" style=" @if($TrayecLaboralCriIniciativa[$lo]=='Excelente') background-color:#3B9DD9; @endif">&nbsp;</td>
          <td class="gris_blanca" style=" @if($TrayecLaboralCriIniciativa[$lo]=='Bueno') background-color:#3B9DD9; @endif">&nbsp;</td>
          <td class="gris_blanca" style=" @if($TrayecLaboralCriIniciativa[$lo]=='Regular') background-color:#3B9DD9; @endif">&nbsp;</td>
          <td class="gris_blanca" style=" @if($TrayecLaboralCriIniciativa[$lo]=='Malo') background-color:#3B9DD9; @endif">&nbsp;</td>
        ...
        <tr>
          ...
          <td class="gris_blanca" style=" @if($TrayecLaboralCriPuntualidad[$lo]=='Excelente') background-color:#3B9DD9; @endif">&nbsp;</td>
          <td class="gris_blanca" style=" @if($TrayecLaboralCriPuntualidad[$lo]=='Bueno') background-color:#3B9DD9; @endif">&nbsp;</td>
          <td class="gris_blanca" style=" @if($TrayecLaboralCriPuntualidad[$lo]=='Regular') background-color:#3B9DD9; @endif">&nbsp;</td>
          <td class="gris_blanca" style=" @if($TrayecLaboralCriPuntualidad[$lo]=='Malo') background-color:#3B9DD9; @endif">&nbsp;</td>
          <td class="gris">Puesto</td>
        </tr>
        <tr>
          <td class="gris_blanca" style="text-align: center;">Responsabilidad</td>
          <td class="gris_blanca" style=" @if($TrayecLaboralCriResponsabilida[$lo]=='Excelente') background-color:#3B9DD9; @endif">&nbsp;</td>
          <td class="gris_blanca" style=" @if($TrayecLaboralCriResponsabilida[$lo]=='Bueno') background-color:#3B9DD9; @endif">&nbsp;</td>
          <td class="gris_blanca" style=" @if($TrayecLaboralCriResponsabilida[$lo]=='Regular') background-color:#3B9DD9; @endif">&nbsp;</td>
          <td class="gris_blanca" style=" @if($TrayecLaboralCriResponsabilida[$lo]=='Malo') background-color:#3B9DD9; @endif">&nbsp;</td>
