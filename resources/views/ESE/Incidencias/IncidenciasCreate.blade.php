        ...
        <div class="panel panel-inverse" data-sortable-id="ui-widget-14" data-init="true">
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <button class="form-control btn btn-success" onclick="crearServicio({{$IdCLiente}});">Crear Servicio</button>
                    </div>
...
<script>
    ...
    function crearServicio(idCliente) {
        ...
        if (candidato == "" || fecha == "" || lugar == "" || solicitante == "0") {
            ...
            $.ajax({
                ...
                url: "{{ url('guardarServicio') }}/" + idCliente,
                method: "post",
                dataType: "JSON",
                data: {
                    A: "A"
                ...
                success: function(data) {
                    guardarInputs(data.id_servicio, idCliente);
    ...
    function guardarInputs(idServicio, idCliente) {
        ...
        $.ajax({
                ...
                url: "{{ url('guardarInputs') }}/" + idCliente+"/"+idServicio,
                method: "post",
                dataType: "JSON",
                data: {
                ...
                success: function(data) {
                    swal({
                                title: "<h3>¡ Servicio Creado con exito !</h3> ",
                                html: true,
                                type: "success"
                            });
