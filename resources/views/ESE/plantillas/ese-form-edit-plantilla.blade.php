...
<div class="form-group text-center">
	...
	<div class="col-md-8">
		<div class="input-group">
			...
			<input type="text" class="form-control input-sm" name="nombre" placeholder="Plantilla Para Estudios Socioeconómicos" value="{{ $formato->nombre }}">						    	
		</div>
	</div>
</div>
...
<div class="form-group text-center">
	...
	<div class="col-md-8">
		<div class="input-group">
			...
			<input type="text" class="form-control input-sm" name="descripcion" placeholder="Descripción de la plantilla" value="{{ $formato->descripcion }}">
	...
	<div class="panel panel-info overflow-hidden col-md-12">
		...
		<div id="collapse{{ $componente->id }}" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;">
			<div class="panel-body">
				...
				<div class="col-md-2">
					<input 	type="checkbox" class="btn-select-all" data-clave="{{ $componente->key }}">Seleccionar todos
				</div>
				<hr>
					...
					<div class="row">
						...
						<div class="form-group col-md-4">
							<input 	type="checkbox" 
									name="{{ $campo->key }}" 
									value="{{ $campo->id }}" 
									class="{{ $componente->class_name }} {{ $componente->key }}s" 
									@if( in_array( $campo->id, $campos_asignados ) )
										checked="checked"
									@endif> 
							<label>
								...
								{{--<a tabindex="0"
								   ...
								   <div class="input-group">
								      	...
								      	<input class="form-control input-sm num-rows-class"
								      		   data-rows="{{ $campo->key }}" 
								      		   type="text" 
								      		   name="{{ $campo->key }}-rows" 
								      		   value="{{ $campo->rows }}" 
