                    ...
                    <table class="detalle-cliente">                                        
                        <tbody>
                            ...
                            <tr>                                             
                                ...
                                <td class="letra-componente alinear-izquierda" style="width: 80%;">
                                    {{ isset( $estudio->formatoHddisc->resumen ) ? $estudio->formatoHddisc->resumen->puesto : '' }}
                                </td>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                @if( $estudio->formatoHddisc )
                                    ...
                                    @elseif( $estudio->formatoHddisc->resumen->status == '2' )
                    ...
                    <table class="auto-width">
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <p class="letra-componente justificar">
                                        {{ isset( $estudio->formatoHddisc ) ?  $estudio->formatoHddisc->resumen->situacion_socioeconomica :'' }}
                                    </p>
                                </td>
                            </tr>
                        </tbody>
                    ...
                    <table class="auto-width">
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <p class="letra-componente justificar">
                                        {{ isset( $estudio->formatoHddisc ) ?  $estudio->formatoHddisc->resumen->escolaridad :'' }}
                                    </p>
                                </td>
                            </tr>
                        </tbody>
                    ...
                    <table class="auto-width">
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <p class="letra-componente justificar">
                                        {{ isset( $estudio->formatoHddisc ) ?  $estudio->formatoHddisc->resumen->trayectoria_laboral :'' }}
                                    </p>
                                </td>
                            </tr>
                        </tbody>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="letra-componente justificar" rowspan="7" style="width: 50%;">
                                                    {{ isset( $estudio->formatoHddisc ) ?  $estudio->formatoHddisc->resumen->comentarios :  '' }}
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="letra-componente alinear-izquierda" style="width: 20%;">
                    ...
                    <table class="auto-width">
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <p class="letra-componente justificar">
                                        {{ isset( $estudio->formatoHddisc ) ?  $estudio->formatoHddisc->resumen->incidentes_seguridad :'' }}
                                    </p>
                                </td>
                            </tr>
                        </tbody>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td  colspan="3" class="letra-componente alinear-izquierda" style="width:10%;">
                                                    <p>
                                                        @if( $estudio->formatoHddisc )
                                                        @if( $estudio->formatoHddisc->datos_generales->sexo == '1')
                                                        Masculino
                                                        @else
                                                        Femenino
                                                        @endif
                                    ...
                                    <table class="auto-width">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="letra-componente alinear-izquierda" style="width:20%;">
                                                    <p>
                                                        {{ isset( $estudio->formatoHddisc->datos_generales ) ? $estudio->formatoHddisc->datos_generales->edad : '' }}
                                                    </p>
                                                </td>
                                                <td class="letra-componente alinear-izquierda" style="width:13%;">FECHA DE NAC.:</td>
                                                <td class="letra-componente alinear-izquierda" style="width:20%;">
                                                    <p>
                                                        {{ isset( $estudio->formatoHddisc->datos_generales ) ? $estudio->formatoHddisc->datos_generales->fecha_nacimiento : '' }}</p>
                                                    </td>
                                                    <td class="letra-componente alinear-izquierda" style="width:14%;">LUGAR DE NAC. :</td>
                                                    <td class="letra-componente alinear-izquierda" style="width:20%;">
                                                        <p>
                                                            {{ isset( $estudio->formatoHddisc->datos_generales ) ? $estudio->formatoHddisc->datos_generales->lugar_nacimiento : '' }}
                                                        </p>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        ...
                                        <table class="auto-width">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="letra-componente alinear-izquierda" style="width:20%;">
                                                        <p>
                                                            {{ isset( $estudio->formatoHddisc->datos_generales ) ? $estudio->formatoHddisc->datos_generales->nacionalidad : '' }}
                                                        </p>
                                                    </td>
                                                    <td class="letra-componente alinear-izquierda" style="width:13%;">ESTADO CIVIL:</td>
                                                    <td class="letra-componente alinear-izquierda" style="width:20%;">
                                                        <p>
                                                            {{ isset( $estudio->formatoHddisc->datos_generales ) ? $estudio->formatoHddisc->datos_generales->edo_civil : '' }}
                                                        </p>
                                                    </td>
                                                    <td class="letra-componente alinear-izquierda" style="width:14%;">FECHA DE MATRIMONIO:</td>
                                                    <td class="letra-componente alinear-izquierda" style="width:20%;">
                                                        <p> 
                                                            {{ isset( $estudio->formatoHddisc->datos_generales ) ? $estudio->formatoHddisc->datos_generales->fecha_matrimonio : '' }}
                                                        </p>
                                                    </td>                                                
                                                </tr>
                                            </tbody>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td  colspan="3" class="letra-componente alinear-izquierda" style="width:87%;">
                                                        <p>
                                                            {{ isset( $estudio->formatoHddisc->datos_generales ) ? $estudio->formatoHddisc->datos_generales->calle : ''}}
                                                        </p>
                                                    </td>                                                           
                                                </tr>
                                            </tbody>
                                        ...
                                        <table class="auto-width">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="letra-componente alinear-izquierda" style="width:20%;">
                                                        <p>
                                                            {{ isset( $estudio->formatoHddisc->datos_generales ) ? $estudio->formatoHddisc->datos_generales->no_exterior : '' }}
                                                        </p>
                                                    </td>
                                                    <td class="letra-componente alinear-izquierda" style="width:13%;">NÚMERO INTERIOR:</td>
                                                    <td class="letra-componente alinear-izquierda" style="width:20%;">
                                                        <p>
                                                            {{ isset( $estudio->formatoHddisc->datos_generales ) ? $estudio->formatoHddisc->datos_generales->no_interior : '' }}
                                                        </p>
                                                    </td>
                                                    <td class="letra-componente alinear-izquierda" style="width:14%;">DELEGACIÓN Ó MUNICIPIO:</td>
                                                    <td class="letra-componente alinear-izquierda" style="width:20%;">
                                                        <p> 
                                                            {{ isset( $estudio->formatoHddisc->datos_generales ) ? $estudio->formatoHddisc->datos_generales->delegacion : '' }}
                                                        </p>
                                                    </td>                                                
                                                </tr>
                                            </tbody>
                                        ...
                                        <table class="auto-width">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="letra-componente alinear-izquierda" style="width:20%;">
                                                        <p>
                                                            {{ isset( $estudio->formatoHddisc->datos_generales ) ? $estudio->formatoHddisc->datos_generales->colonia : '' }}
                                                        </p>
                                                    </td>
                                                    <td class="letra-componente alinear-izquierda" style="width:13%;">EMAIL:</td>
                                                    <td class="letra-componente alinear-izquierda" style="width:20%;">
                                                        <p>
                                                            {{ isset( $estudio->formatoHddisc->datos_generales ) ? $estudio->formatoHddisc->datos_generales->email : '' }}
                                                        </p>
                                                    </td>
                                                    <td class="letra-componente alinear-izquierda" style="width:14%;">TELÉFONO:</td>
                                                    <td class="letra-componente alinear-izquierda" style="width:20%;">
                                                        <p> 
                                                            {{ isset( $estudio->formatoHddisc->datos_generales ) ? $estudio->formatoHddisc->datos_generales->telefono : '' }}
                                                        </p>
                                                    </td>                                                
                                                </tr>
                                            </tbody>
                                        ...
                                        <table class="auto-width">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="letra-componente alinear-izquierda" style="width:20%;">
                                                        <p>
                                                            {{ isset( $estudio->formatoHddisc->datos_generales ) ? $estudio->formatoHddisc->datos_generales->cp : '' }}
                                                        </p>
                                                    </td>
                                                    <td class="letra-componente alinear-izquierda" style="width:13%;">TIEMPO EN EL DOMICILIO:</td>
                                                    <td class="letra-componente alinear-izquierda" style="width:20%;">
                                                        <p>
                                                            {{ isset( $estudio->formatoHddisc->datos_generales ) ? $estudio->formatoHddisc->datos_generales->tiempo_domicilio : '' }}
                                                        </p>
                                                    </td>
                                                    <td class="letra-componente alinear-izquierda" style="width:14%;">CELULAR:</td>
                                                    <td class="letra-componente alinear-izquierda" style="width:20%;">
                                                        <p> 
                                                            {{ isset( $estudio->formatoHddisc->datos_generales ) ? $estudio->formatoHddisc->datos_generales->celular : '' }}
                                                        </p>
                                                    </td>                                                
                                                </tr>
                                            </tbody>
                                    ...
                                    <td class="table-border">
                                        <table  class="auto-width">
                                            <tbody>
                                                <tr>
                                                    <td  class="letra-componente alinear-izquierda" style="width:20%;">PUESTO:</td>
                                                    <td colspan="3" class="letra-componente alinear-izquierda" style="width:50%;">
                                                        <p> 
                                                            {{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->datos_generales->puesto : '' }}
                                                        </p>
                                                    </td>
                                                    <td class="letra-componente alinear-izquierda" style="width:15%;">TELÉFONO RECADOS:</td>
                                                    <td  colspan="3" class="letra-componente alinear-izquierda" style="width:15%;">
                                                        <p>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="letra-componente alinear-izquierda" style="width:70%;">
                                                        <p>
                                                            {{ isset( $estudio->formatoHddisc->datos_generales ) ? $estudio->formatoHddisc->datos_generales->entre_calles : '' }}  </p>
                                                        </td>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="letra-componente alinear-izquierda table-border" style="width: 13%;">
                                                            <p class="border-footer">
                                                                {{ isset($estudio->formatoHddisc ) ? $estudio->formatoHddisc->documentacion->acta_no : '' }}
                                                            </p>
                                                        </td>
                                                        <td class="letra-componente alinear-izquierda table-border" style="width: 12%;">AÑO:</td>
                                                        <td class="letra-componente alinear-izquierda table-border" style="width: 13%;">
                                                            <p class="border-footer">
                                                                {{ isset($estudio->formatoHddisc ) ? $estudio->formatoHddisc->documentacion->acta_anio : '' }}
                                                            </p>
                                                        </td> 
                                                        <td class="letra-componente alinear-izquierda table-border" style="width: 12%;">LIBRO:</td>
                                                        <td class="letra-componente alinear-izquierda table-border" style="width: 13%;">
                                                            <p class="border-footer">
                                                                {{ isset($estudio->formatoHddisc ) ? $estudio->formatoHddisc->documentacion->acta_libro : '' }}
                                                            </p>
                                                        </td> 
                                                        <td class="letra-componente alinear-izquierda table-border" style="width: 12%;">OFICIALIA:</td>
                                                        <td class="letra-componente alinear-izquierda table-border" style="width: 13%;">
                                                            <p class="border-footer">
                                                                {{ isset($estudio->formatoHddisc ) ? $estudio->formatoHddisc->documentacion->acta_oficialia : '' }}
                                                            </p>
                                                        </td> 
                                        ...
                                        <td class="letra-componente alinear-izquierda" style="width:15%;"><p> 
                                            {{ isset($estudio->formatoHddisc ) ? $estudio->formatoHddisc->documentacion->acta_corroboro : '' }}
                                        </p></td>
                                    </tr>
                                    <tr>
                                        <td style="width:25%;">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="letra-componente alinear-izquierda table-border" style="width:25%;">
                                                            <p class="border-footer">
                                                                {{ isset($estudio->formatoHddisc ) ? $estudio->formatoHddisc->documentacion->ine_clave_: '' }}
                                                            </p>
                                                        </td>
                                                        <td class="letra-componente alinear-izquierda table-border" style="width:25%;">NÚMERO:</td>
                                                        <td class="letra-componente alinear-izquierda table-border" style="width:25%;">
                                                            <p class="border-footer">
                                                                {{ isset($estudio->formatoHddisc ) ? $estudio->formatoHddisc->documentacion->ine_no: '' }}
                                                            </p>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                            ...
                                                            <table class="auto-width">
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td class="letra-componente alinear-derecha table-border" style="width:10%;">SI&nbsp;</td>
                                                                        <td class="letra-componente alinear-izquierda" style="width:10%;">
                                                                            @if( $estudio->formatoHddisc)
                                                                                @if( $estudio->formatoHddisc->documentacion->ine_direccion_actual == '1')
                                                                                    <div style="background-color:#FF8000; width: 100%; height: 100%; margin: 0; padding: 0; ">&nbsp;</div>
                                                                                @endif
                                                                            @endif
                                                                        </td>
                                                                        <td class="letra-componente alinear-derecha table-border" style="width:10%;">NO&nbsp;</td>
                                                                        <td class="letra-componente alinear-izquierda" style="width:10%;">
                                                                            @if( $estudio->formatoHddisc)
                                                                                @if( $estudio->formatoHddisc->documentacion->ine_direccion_actual == '2')
                                                                                    <div style="background-color:#FF8000; width: 100%; height: 100%; margin: 0; padding: 0; ">&nbsp;</div>
                                                                                @endif
                                                                            @endif
                                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="5" class="letra-componente alinear-izquierda table-border" >
                                                            <p class="border-footer">
                                                                {{ isset($estudio->formatoHddisc ) ? $estudio->formatoHddisc->documentacion->ine_direccion: '' }}
                                                            </p>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                        ...
                                        <td class="letra-detalle-jll-label" style="width:15%;">
                                            <p> 
                                                {{ isset($estudio->formatoHddisc ) ? $estudio->formatoHddisc->documentacion->ine__corroboro : '' }}
                                            </p>
                                        </td>
                                    </tr>
                                    <tr>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="letra-componente alinear-izquierda table-border">
                                                            {{ isset($estudio->formatoHddisc ) ? $estudio->formatoHddisc->documentacion->curp : '' }}
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        ...
                                        <td class="letra-componente alinear-izquierda" style="width:15%;">
                                            <p>
                                                {{ isset($estudio->formatoHddisc ) ? $estudio->formatoHddisc->documentacion->curp_corroboro : '' }}
                                            </p>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="letra-componente alinear-izquierda table-border" style="width:60%;">
                                            <p>
                                                {{ isset($estudio->formatoHddisc ) ? $estudio->formatoHddisc->documentacion->rfc_no : '' }}
                                            </p>
                                        </td>
                                        <td class="letra-componente alinear-izquierda" style="width:15%;">
                                            <p>
                                                {{ isset($estudio->formatoHddisc ) ? $estudio->formatoHddisc->documentacion->rfc_corroboro: '' }}
                                            </p>
                                        </td>
                                    </tr>
                                    <tr>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="letra-componente alinear-izquierda table-border" style="width: 35%;">
                                                            <p class="border-footer">
                                                                {{ isset($estudio->formatoHddisc ) ? $estudio->formatoHddisc->documentacion->afore_no : '' }}
                                                            </p>
                                                        </td>
                                                        <td class="letra-componente alinear-izquierda table-border" style="width: 15%;">INSTITUCIÓN:</td>
                                                        <td class="letra-componente alinear-izquierda table-border" style="width: 35%;">
                                                            <p class="border-footer">
                                                                {{ isset($estudio->formatoHddisc ) ? $estudio->formatoHddisc->documentacion->afore_institucion : '' }}
                                                            </p>
                                                        </td> 
                                        ...
                                        <td class="letra-componente alinear-izquierda" style="width:15%;">
                                            <p>
                                                {{ isset($estudio->formatoHddisc ) ? $estudio->formatoHddisc->documentacion->afore_corroboro : '' }}
                                            </p>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="letra-componente alinear-izquierda table-border" style="width:60%;">
                                            <p>
                                                {{ isset($estudio->formatoHddisc ) ? $estudio->formatoHddisc->documentacion->nss_no : '' }}
                                            </p>
                                        </td>
                                        <td class="letra-componente alinear-izquierda" style="width:15%;">
                                            <p>
                                                {{ isset($estudio->formatoHddisc ) ? $estudio->formatoHddisc->documentacion->nss_corroboro : '' }}
                                            </p>
                                        </td>
                                    </tr>
                                    <tr>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="letra-componente alinear-izquierda table-border" style="width:80%;">
                                                            <p class="border-footer">
                                                                {{ isset($estudio->formatoHddisc ) ? $estudio->formatoHddisc->documentacion->ce_institucion: '' }}
                                                            </p>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td class="letra-componente alinear-izquierda table-border" style="width:80%;">
                                                            <p class="border-footer">
                                                                {{ isset($estudio->formatoHddisc ) ? $estudio->formatoHddisc->documentacion->ce_documento: '' }}
                                                            </p>
                                                        </td>
                                                        <td class="letra-componente alinear-izquierda table-border" style="width:20%;">FOLIO:</td>
                                                        <td class="letra-componente alinear-izquierda table-border" style="width:80%;">
                                                            <p class="border-footer">
                                                                {{ isset($estudio->formatoHddisc ) ? $estudio->formatoHddisc->documentacion->ce_folio: '' }}
                                                            </p>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td class="letra-componente alinear-izquierda table-border" style="width:80%;">
                                                            <p class="border-footer">
                                                                {{ isset($estudio->formatoHddisc ) ? $estudio->formatoHddisc->documentacion->ce_grado: '' }}
                                                            </p>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td class="letra-componente alinear-izquierda table-border" style="width:80%;">
                                                            <p class="border-footer">
                                                                {{ isset($estudio->formatoHddisc ) ? $estudio->formatoHddisc->documentacion->ce_licenciatura: '' }}
                                                            </p>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                        ...
                                        <td class="letra-componente alinear-izquierda" style="width:15%;">
                                            <p>
                                                {{ isset($estudio->formatoHddisc ) ? $estudio->formatoHddisc->documentacion->ce_corroboro : '' }}
                                            </p>
                                        </td>
                                    </tr>
                                    <tr>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td  class="letra-componente alinear-izquierda table-border" style="width:75%;">
                                                            <p class="border-footer">
                                                                {{ isset($estudio->formatoHddisc ) ? $estudio->formatoHddisc->documentacion->cd_titular: '' }}
                                                            </p>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td  class="letra-componente alinear-izquierda table-border" style="width:75%;">
                                                            <p class="border-footer">
                                                                {{ isset($estudio->formatoHddisc ) ? $estudio->formatoHddisc->documentacion->cd_servicio_fecha: '' }}
                                                            </p>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                        ...
                                        <td class="letra-componente alinear-izquierda" style="width:15%;">
                                            <p>
                                                {{ isset($estudio->formatoHddisc ) ? $estudio->formatoHddisc->documentacion->cd_corroboro : '' }}
                                            </p>
                                        </td>
                                    </tr>
                                    <tr>
                                            ...
                                            <table class="auto-width">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td  class="letra-componente alinear-izquierda table-border" style="width:75%;">
                                                            <p class="border-footer">
                                                                {{ isset($estudio->formatoHddisc ) ? $estudio->formatoHddisc->documentacion->licencia_manejo_tipo: '' }}
                                                            </p>
                                                        </td> 
                                                    </tr>
                                                    <tr>                                                           
                                                        ...
                                                        <td  class="letra-componente alinear-izquierda table-border" style="width:75%;">
                                                            <p class="border-footer">
                                                                {{ isset($estudio->formatoHddisc ) ? $estudio->formatoHddisc->documentacion->licencia_manejo_no_vig: '' }}
                                                            </p>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                        ...
                                        <td class="letra-componente alinear-izquierda" style="width:15%;">
                                            <p>
                                                {{ isset($estudio->formatoHddisc ) ? $estudio->formatoHddisc->documentacion->licencia_manejo_corroboro : '' }}
                                            </p>
                                        </td>
                                    </tr>
                                    <tr>
                                            ...
                                            <table class="auto-width">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td  class="letra-componente alinear-izquierda table-border" style="width:75%">
                                                            <p class="border-footer">
                                                                {{ isset($estudio->formatoHddisc ) ? $estudio->formatoHddisc->documentacion->cedula_no: '' }}
                                                            </p>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                        ...
                                        <td class="letra-componente alinear-izquierda" style="width:15%;">
                                            <p>
                                                {{ isset($estudio->formatoHddisc ) ? $estudio->formatoHddisc->documentacion->cedula_corroboro : '' }}
                                            </p>
                                        </td>
                                    </tr>
                                    <tr>
                                            ...
                                            <table class="auto-width">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td  class="letra-componente alinear-izquierda table-border" style="width:75%;">
                                                            <p class="border-footer">
                                                                {{ isset($estudio->formatoHddisc ) ? $estudio->formatoHddisc->documentacion->pasaporte_no: '' }}
                                                            </p>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                        ...
                                        <td class="letra-componente alinear-izquierda" style="width:15%;">
                                            <p>
                                                {{ isset($estudio->formatoHddisc ) ? $estudio->formatoHddisc->documentacion->pasaporte_corroboro : '' }}
                                            </p>
                                        </td>
                                    </tr>
                                    <tr>
                                            ...
                                            <table class="auto-width">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td  class="letra-componente alinear-izquierda table-border" style="width:75%;">
                                                            <p class="border-footer">
                                                                {{ isset($estudio->formatoHddisc ) ? $estudio->formatoHddisc->documentacion->infonavit_no: '' }}
                                                            </p>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                        ...
                                        <td class="letra-componente alinear-izquierda" style="width:15%;">
                                            <p>
                                                {{ isset($estudio->formatoHddisc ) ? $estudio->formatoHddisc->documentacion->infonavit_corroboro : '' }}
                                            </p>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                            ...
                                            <table class="auto-width">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td  class="letra-componente alinear-izquierda table-border" style="width:75%;">
                                                            <p class="border-footer">
                                                                {{ isset($estudio->formatoHddisc ) ? $estudio->formatoHddisc->documentacion->fonacot_no: '' }}
                                                            </p>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                        ...
                                        <td class="letra-componente alinear-izquierda" style="width:15%;">
                                            <p>
                                                {{ isset($estudio->formatoHddisc ) ? $estudio->formatoHddisc->documentacion->fonacot_corroboro : '' }}
                                            </p>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                            ...
                                            <table class="auto-width">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td  class="letra-componente alinear-izquierda table-border" style="width:75%;">
                                                            <p class="border-footer">
                                                                {{ isset($estudio->formatoHddisc ) ? $estudio->formatoHddisc->documentacion->cartilla_matricula: '' }}
                                                            </p>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td  class="letra-componente alinear-izquierda table-border" style="width:75%;">
                                                            <p class="border-footer">
                                                                {{ isset($estudio->formatoHddisc ) ? $estudio->formatoHddisc->documentacion->cartilla_liberacion: '' }}
                                                            </p>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                        ...
                                        <td class="letra-componente alinear-izquierda" style="width:15%;">
                                            <p>
                                                {{ isset($estudio->formatoHddisc ) ? $estudio->formatoHddisc->documentacion->cartilla_corroboro : '' }}
                                            </p>
                                        </td>
                                    </tr>
                                    <tr>
                                            ...
                                            <table class="auto-width">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td  class="letra-componente alinear-izquierda table-border" style="width:75%;">
                                                            <p class="border-footer">
                                                                {{ isset($estudio->formatoHddisc ) ? $estudio->formatoHddisc->documentacion->actam_juzgado: '' }}
                                                            </p>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td  class="letra-componente alinear-izquierda table-border" style="width:75%;">
                                                            <p class="border-footer">
                                                                {{ isset($estudio->formatoHddisc ) ? $estudio->formatoHddisc->documentacion->actam_no: '' }}
                                                            </p>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                        ...
                                        <td class="letra-componente alinear-izquierda" style="width:15%;">
                                            <p>
                                                {{ isset($estudio->formatoHddisc ) ? $estudio->formatoHddisc->documentacion->actam_corroboro : '' }}
                                            </p>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td colspan="3" class="letra-componente alinear-izquierda table-border" style="width:75%;">
                                                            <p class="border-footer">
                                                                {{ isset($estudio->formatoHddisc ) ? $estudio->formatoHddisc->documentacion->recibo_percepciones_empresa: '' }}
                                                            </p>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td  class="letra-componente alinear-izquierda table-border" style="width:75%;">
                                                            <p class="border-footer">
                                                                {{ isset($estudio->formatoHddisc ) ? $estudio->formatoHddisc->documentacion->recibo_percepciones_puesto: '' }}
                                                            </p>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td  class="letra-componente alinear-izquierda table-border" style="width:75%;">
                                                            <p class="border-footer">
                                                                {{ isset($estudio->formatoHddisc ) ? $estudio->formatoHddisc->documentacion->recibo_percepciones_ingreso: '' }}
                                                            </p>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                        ...
                                        <td class="letra-componente alinear-izquierda" style="width:15%;">
                                            <p>
                                                {{ isset($estudio->formatoHddisc ) ? $estudio->formatoHddisc->documentacion->recibo_percepciones_corroboro : '' }}
                                            </p>
                                        </td>
                                    </tr> 
                                </tbody>
                                ...
                                <table class="auto-width">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <p class="letra-componente justificar">
                                                    {{ isset($estudio->formatoHddisc ) ?$estudio->formatoHddisc->documentacion->observaciones : '' }}
                                                </p>
                                            </td>
                                        </tr>
                                    </tbody>
                                ...
                                <table class="tabla-componente">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td colspan="2" class="table-border">
                                                <table class="tabla-componente">
                                                    ...
                                                    <tbody>
                                                        @if( $estudio->formatoHddisc )
                                                        @foreach( $estudio->formatoHddisc->escolaridad as $row )
                                                        <tr>                                                                             
                                        ...
                                        <tr>                                                                        
                                            ...
                                            <td style="width: 65%;">
                                                <p class="letra-componente alinear-izquierda">
                                                    {{ isset($estudio->formatoHddisc ) ? $estudio->formatoHddisc->escolaridad_obs->trunco_abandono : '' }}
                                                </p>
                                            </td>
                                        </tr>
                                        <tr>                                                                        
                                            ...
                                            <td style="width: 65%;">
                                                <p class="letra-componente alinear-izquierda">
                                                    {{ isset($estudio->formatoHddisc ) ? $estudio->formatoHddisc->escolaridad_obs->estudia_horario : '' }}
                                                </p>
                                            </td>
                                        </tr>
                                        <tr>
                                                ...
                                                <table class="auto-width">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <p class="letra-componente justificar">
                                                                    {{ isset($estudio->formatoHddisc ) ? $estudio->formatoHddisc->escolaridad_obs->observaciones : '' }}
                                                                </p>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                            ...
                                            <td>
                                                <table class="tabla-componente">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @if( $estudio->formatoHddisc)
                                                        @foreach ($estudio->formatoHddisc->cursos as $curso)
                                                        <tr>
                        ...
                        <tr>
                                        ...
                                        <tr>
                                            <td class="table-border">
                                                <table class="tabla-componente">
                                                    ...
                                                    <tbody>
                                                        @if( $estudio->formatoHddisc)
                                                        @foreach ($estudio->formatoHddisc->idiomas as $index => $idioma )
                                                        <tr>  
                                            ...
                                            <tr>
                                                <td class="table-border">
                                                    <table class="tabla-componente">
                                                        ...
                                                        <tbody>
                                                            @if( $estudio->formatoHddisc )
                                                            @foreach ($estudio->formatoHddisc->conocmientos_habilidades as $index => $conocimiento)
                                                            <tr>
                                                                <td class="letra-componente alinear-centro" style="width:5%;">
                                                                    <p>
                                                                        {{ ($index+1) }}
                                            ...
                                            <tr>
                                                <td class="table-border">
                                                    <table class="tabla-componente">
                                                        ...
                                                        <tbody>
                                                            @if( $estudio->formatoHddisc )
                                                            @foreach( $estudio->formatoHddisc->datos_familiares as $familiar )
                                                            <tr>                                                                             
                                        ...
                                        <tbody>
                                            ...
                                            <tr>                                                                        
                                                ...
                                                <td class="letra-componente alinear-izquierda" style="width: 60%;">
                                                    <p>
                                                        {{ isset($estudio->formatoHddisc ) ? $estudio->formatoHddisc->informacion_familiar->habita_actualmente : '' }}
                                                    </p>
                                                </td>
                                            </tr>
                                            <tr>                                                                        
                                                ...
                                                <td class="letra-componente alinear-izquierda" style="width: 60%;">
                                                    <p>
                                                        {{ isset($estudio->formatoHddisc ) ? $estudio->formatoHddisc->informacion_familiar->relacion : '' }}
                                                    </p>
                                                </td>
                                            </tr>
                                            <tr>                                                                        
                                                ...
                                                <td class="letra-componente alinear-izquierda" style="width: 60%;">
                                                    <p>
                                                        {{ isset($estudio->formatoHddisc ) ? $estudio->formatoHddisc->informacion_familiar->familiares_extranjero : '' }}
                                                    </p>
                                                </td>
                                            </tr>
                                            <tr>                                                                        
                                                ...
                                                <td class="letra-componente alinear-izquierda" style="width: 70%;">
                                                    <p>
                                                        {{ isset($estudio->formatoHddisc ) ? $estudio->formatoHddisc->informacion_familiar->interior_republica : '' }}
                                                    </p>
                                                </td>
                                            </tr>
                                            <tr>                                                                        
                                                ...
                                                <td class="letra-componente alinear-izquierda" style="width: 70%;">
                                                    <p>
                                                        {{ isset($estudio->formatoHddisc ) ? $estudio->formatoHddisc->informacion_familiar->visita_frecuencia : '' }}
                                                    </p>
                                                </td>
                                            </tr>                                                                    
                                        </tbody>
                                    ...
                                    <table class="auto-width">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    <p class="letra-componente justificar">
                                                        {{ isset($estudio->formatoHddisc ) ? $estudio->formatoHddisc->informacion_familiar->observaciones : '' }}
                                                    </p>
                                                </td>
                                            </tr>
                                        </tbody>
                            ...
                            <tr>
                                <td colspan="3" class="table-border">
                                                    ...
                                                    <table class="tabla-componente">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td class="letra-componente alinear-izquierda" style="width:20%;">
                                                                    <p>
                                                                        {{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->aportacion1 :''}}
                                                                    </p>
                                                                </td>
                                                                <td class="letra-componente alinear-izquierda " style="width:20%;">
                                                                    <p>
                                                                        {{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->i_concepto1 :''}}
                                                                    </p>
                                                                </td>
                                                                <td class="letra-componente alinear-derecha " style="width:15%;">
                                                                    <p>
                                                                        @if( $estudio->formatoHddisc )
                                                                            @if( $estudio->formatoHddisc->situacion_economica->i_monto1 > '0' )
                                                                                ${{ number_format( $estudio->formatoHddisc->situacion_economica->i_monto1 ,2 ) }}
                                                                            @else
                                                                                --
                                                                            @endif
                                                                        @endif
                                                                    ...
                                                                    <p>
                                                                        {{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->e_concepto1 :''}}
                                                                    </p>
                                                                </td>
                                                                <td class="letra-componente alinear-derecha" style="width:15%;">
                                                                    <p>
                                                                        ...
                                                                        @if( $estudio->formatoHddisc )
                                                                            @if( $estudio->formatoHddisc->situacion_economica->e_monto1 > '0' )
                                                                                ${{ number_format( $estudio->formatoHddisc->situacion_economica->e_monto1 ,2 ) }}
                                                                            @else
                                                                                --
                                                                            @endif
                                                                        @endif
                                                            ...
                                                            <tr>
                                                                <td class="letra-componente alinear-izquierda" style="width:20%;">
                                                                    <p>
                                                                        {{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->aportacion2 :''}}
                                                                    </p>
                                                                </td>
                                                                <td class="letra-componente alinear-izquierda" style="width:20%;">
                                                                    <p>
                                                                        {{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->i_concepto2 :''}}
                                                                    </p>
                                                                </td>
                                                                <td class="letra-componente alinear-derecha" style="width:15%;">
                                                                    <p>
                                                                        ...
                                                                        @if( $estudio->formatoHddisc )
                                                                            @if( $estudio->formatoHddisc->situacion_economica->i_monto2 > '0' )
                                                                                ${{ number_format( $estudio->formatoHddisc->situacion_economica->i_monto2 ,2 ) }}
                                                                            @else
                                                                                --
                                                                            @endif
                                                                        @endif
                                                                ...
                                                                <td class="letra-componente alinear-izquierda" style="width:30%;">
                                                                    <p>
                                                                        {{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->e_concepto2 :''}}
                                                                    </p>
                                                                </td>
                                                                <td class="letra-componente alinear-derecha" style="width:15%;">
                                                                    <p>
                                                                        @if( $estudio->formatoHddisc )
                                                                            @if( $estudio->formatoHddisc->situacion_economica->e_monto2 > '0' )
                                                                                ${{ number_format( $estudio->formatoHddisc->situacion_economica->e_monto2 ,2 ) }}
                                                                            @else
                                                                                --
                                                                            @endif
                                                                        @endif
                                                            ...
                                                            <tr>
                                                                <td class="letra-componente alinear-izquierda" style="width:20%;">
                                                                    <p>
                                                                        {{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->aportacion3 :''}}
                                                                    </p>
                                                                </td>
                                                                <td class="letra-componente alinear-izquierda" style="width:20%;">
                                                                    <p>
                                                                        {{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->i_concepto3 :''}}
                                                                    </p>
                                                                </td>
                                                                <td class="letra-componente alinear-derecha" style="width:15%;">
                                                                    <p>
                                                                        ...
                                                                        @if( $estudio->formatoHddisc )
                                                                            @if( $estudio->formatoHddisc->situacion_economica->i_monto3 > '0' )
                                                                                ${{ number_format( $estudio->formatoHddisc->situacion_economica->i_monto3 ,2 ) }}
                                                                            @else
                                                                                --
                                                                            @endif
                                                                        @endif
                                                                ...
                                                                <td class="letra-componente alinear-izquierda" style="width:30%;">
                                                                    <p>
                                                                        {{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->e_concepto3 :''}}
                                                                    </p>
                                                                </td>
                                                                <td class="letra-componente alinear-derecha" style="width:15%;">
                                                                    <p>
                                                                        @if( $estudio->formatoHddisc )
                                                                            @if( $estudio->formatoHddisc->situacion_economica->e_monto3 > '0' )
                                                                                ${{ number_format( $estudio->formatoHddisc->situacion_economica->e_monto3 ,2 ) }}
                                                                            @else
                                                                                --
                                                                            @endif
                                                                        @endif
                                                            ...
                                                            <tr>
                                                                <td class="letra-componente alinear-izquierda" style="width:20%;">
                                                                    <p>
                                                                        {{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->aportacion4 :''}}
                                                                    </p>
                                                                </td>
                                                                <td class="letra-componente alinear-izquierda" style="width:20%;">
                                                                    <p>
                                                                        {{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->i_concepto4 :''}}
                                                                    </p>
                                                                </td>
                                                                <td class="letra-componente alinear-derecha" style="width:15%;">
                                                                    <p>
                                                                        ...
                                                                        @if( $estudio->formatoHddisc )
                                                                            @if( $estudio->formatoHddisc->situacion_economica->i_monto4 > '0' )
                                                                                ${{ number_format( $estudio->formatoHddisc->situacion_economica->i_monto4 ,2 ) }}
                                                                            @else
                                                                                --
                                                                            @endif
                                                                        @endif
                                                                ...
                                                                <td class="letra-componente alinear-izquierda" style="width:30%;">
                                                                    <p>
                                                                        {{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->e_concepto4 :''}}
                                                                    </p>
                                                                </td>
                                                                <td class="letra-componente alinear-derecha" style="width:15%;">
                                                                    <p>
                                                                        @if( $estudio->formatoHddisc )
                                                                            @if( $estudio->formatoHddisc->situacion_economica->e_monto4 > '0' )
                                                                                ${{ number_format( $estudio->formatoHddisc->situacion_economica->e_monto4 ,2 ) }}
                                                                            @else
                                                                                --
                                                                            @endif
                                                                        @endif
                                                            ...
                                                            <tr>
                                                                <td class="letra-componente alinear-izquierda" style="width:20%;">
                                                                    <p>
                                                                        {{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->aportacion5 :''}}
                                                                    </p>
                                                                </td>
                                                                <td class="letra-componente alinear-izquierda" style="width:20%;">
                                                                    <p>
                                                                        {{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->i_concepto5 :''}}
                                                                    </p>
                                                                </td>
                                                                <td class="letra-componente alinear-derecha" style="width:15%;">
                                                                    <p>
                                                                        ...
                                                                        @if( $estudio->formatoHddisc )
                                                                            @if( $estudio->formatoHddisc->situacion_economica->i_monto5 > '0' )
                                                                                ${{ number_format( $estudio->formatoHddisc->situacion_economica->i_monto5 ,2 ) }}
                                                                            @else
                                                                                --
                                                                            @endif
                                                                        @endif
                                                                ...
                                                                <td class="letra-componente alinear-izquierda" style="width:30%;">
                                                                    <p>
                                                                        {{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->e_concepto5 :''}}
                                                                    </p>
                                                                </td>
                                                                <td class="letra-componente alinear-derecha" style="width:15%;">
                                                                    <p>
                                                                        @if( $estudio->formatoHddisc )
                                                                            @if( $estudio->formatoHddisc->situacion_economica->e_monto5 > '0' )
                                                                                ${{ number_format( $estudio->formatoHddisc->situacion_economica->e_monto5 ,2 ) }}
                                                                            @else
                                                                                --
                                                                            @endif
                                                                        @endif
                                                            ...
                                                            <tr>
                                                                <td class="letra-componente alinear-izquierda" style="width:20%;">
                                                                    <p>
                                                                        {{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->aportacion6 :''}}
                                                                    </p>
                                                                </td>
                                                                <td class="letra-componente alinear-izquierda" style="width:20%;">
                                                                    <p>
                                                                        {{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->i_concepto6 :''}}
                                                                    </p>
                                                                </td>
                                                                <td class="letra-componente alinear-derecha" style="width:15%;">
                                                                    <p>
                                                                        ...
                                                                        @if( $estudio->formatoHddisc )
                                                                            @if( $estudio->formatoHddisc->situacion_economica->i_monto6 > '0' )
                                                                                ${{ number_format( $estudio->formatoHddisc->situacion_economica->i_monto6 ,2 ) }}
                                                                            @else
                                                                                --
                                                                            @endif
                                                                        @endif
                                                                ...
                                                                <td class="letra-componente alinear-izquierda" style="width:30%;">
                                                                    <p>
                                                                        {{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->e_concepto6 :''}}
                                                                    </p>
                                                                </td>
                                                                <td class="letra-componente alinear-derecha" style="width:15%;">
                                                                    <p>
                                                                        @if( $estudio->formatoHddisc )
                                                                            @if( $estudio->formatoHddisc->situacion_economica->e_monto6 > '0' )
                                                                                ${{ number_format( $estudio->formatoHddisc->situacion_economica->e_monto6 ,2 ) }}
                                                                            @else
                                                                                --
                                                                            @endif
                                                                        @endif
                                                            ...
                                                            <tr>
                                                                <td class="letra-componente alinear-izquierda" style="width:20%;">
                                                                    <p>
                                                                        {{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->aportacion7 :''}}
                                                                    </p>
                                                                </td>
                                                                <td class="letra-componente alinear-izquierda" style="width:20%;">
                                                                    <p>
                                                                        {{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->i_concepto7 :''}}
                                                                    </p>
                                                                </td>
                                                                <td class="letra-componente alinear-derecha" style="width:15%;">
                                                                    <p>
                                                                        ...
                                                                        @if( $estudio->formatoHddisc )
                                                                            @if( $estudio->formatoHddisc->situacion_economica->i_monto7 > '0' )
                                                                                ${{ number_format( $estudio->formatoHddisc->situacion_economica->i_monto7 ,2 ) }}
                                                                            @else
                                                                                --
                                                                            @endif
                                                                        @endif
                                                                ...
                                                                <td class="letra-componente alinear-izquierda" style="width:30%;">
                                                                    <p>
                                                                        {{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->e_concepto7 :''}}
                                                                    </p>
                                                                </td>
                                                                <td class="letra-componente alinear-derecha" style="width:15%;">
                                                                    <p>
                                                                        @if( $estudio->formatoHddisc )
                                                                            @if( $estudio->formatoHddisc->situacion_economica->e_monto7 > '0' )
                                                                                ${{ number_format( $estudio->formatoHddisc->situacion_economica->e_monto7 ,2 ) }}
                                                                            @else
                                                                                --
                                                                            @endif
                                                                        @endif
                                                            ...
                                                            <tr>
                                                                <td class="letra-componente alinear-izquierda" style="width:20%;">
                                                                    <p>
                                                                        {{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->aportacion8 :''}}
                                                                    </p>
                                                                </td>
                                                                <td class="letra-componente alinear-izquierda" style="width:20%;">
                                                                    <p>
                                                                        {{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->i_concepto8 :''}}
                                                                    </p>
                                                                </td>
                                                                <td class="letra-componente alinear-derecha" style="width:15%;">
                                                                    <p>
                                                                        ...
                                                                        @if( $estudio->formatoHddisc )
                                                                            @if( $estudio->formatoHddisc->situacion_economica->i_monto8 > '0' )
                                                                                ${{ number_format( $estudio->formatoHddisc->situacion_economica->i_monto8 ,2 ) }}
                                                                            @else
                                                                                --
                                                                            @endif
                                                                        @endif
                                                                ...
                                                                <td class="letra-componente alinear-izquierda" style="width:30%;">
                                                                    <p>
                                                                        {{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->e_concepto8 :''}}
                                                                    </p>
                                                                </td>
                                                                <td class="letra-componente alinear-derecha" style="width:15%;">
                                                                    <p>
                                                                        @if( $estudio->formatoHddisc )
                                                                            @if( $estudio->formatoHddisc->situacion_economica->e_monto8 > '0' )
                                                                                ${{ number_format( $estudio->formatoHddisc->situacion_economica->e_monto8 ,2 ) }}
                                                                            @else
                                                                                --
                                                                            @endif
                                                                        @endif                                                                        
                                                            ...
                                                            <tr>
                                                                <td class="letra-componente alinear-izquierda" style="width:20%;">
                                                                    <p>
                                                                        {{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->aportacion9 :''}}
                                                                    </p>
                                                                </td>
                                                                <td class="letra-componente alinear-izquierda" style="width:20%;">
                                                                    <p>
                                                                        {{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->i_concepto9 :''}}
                                                                    </p>
                                                                </td>
                                                                <td class="letra-componente alinear-derecha" style="width:15%;">
                                                                    <p>
                                                                        ...
                                                                        @if( $estudio->formatoHddisc )
                                                                            @if( $estudio->formatoHddisc->situacion_economica->i_monto9 > '0' )
                                                                                ${{ number_format( $estudio->formatoHddisc->situacion_economica->i_monto9 ,2 ) }}
                                                                            @else
                                                                                --
                                                                            @endif
                                                                        @endif
                                                                ...
                                                                <td class="letra-componente alinear-izquierda" style="width:30%;">
                                                                    <p>
                                                                        {{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->e_concepto9 :''}}
                                                                    </p>
                                                                </td>
                                                                <td class="letra-componente alinear-derecha" style="width:15%;">
                                                                    <p>
                                                                        @if( $estudio->formatoHddisc )
                                                                            @if( $estudio->formatoHddisc->situacion_economica->e_monto9 > '0' )
                                                                                ${{ number_format( $estudio->formatoHddisc->situacion_economica->e_monto9 ,2 ) }}
                                                                            @else
                                                                                --
                                                                            @endif
                                                                        @endif
                                                            ...
                                                            <tr>
                                                                <td class="letra-componente alinear-izquierda" style="width:20%;">
                                                                    <p>
                                                                        {{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->aportacion10 :''}}
                                                                    </p>
                                                                </td>
                                                                <td class="letra-componente alinear-izquierda" style="width:20%;">
                                                                    <p>
                                                                        {{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->i_concepto10 :''}}
                                                                    </p>
                                                                </td>
                                                                <td class="letra-componente alinear-derecha" style="width:15%;">
                                                                    <p>
                                                                        ...
                                                                        @if( $estudio->formatoHddisc )
                                                                            @if( $estudio->formatoHddisc->situacion_economica->i_monto10 > '0' )
                                                                                ${{ number_format( $estudio->formatoHddisc->situacion_economica->i_monto10 ,2 ) }}
                                                                            @else
                                                                                --
                                                                            @endif
                                                                        @endif
                                                                ...
                                                                <td class="letra-componente alinear-izquierda" style="width:30%;">
                                                                    <p>
                                                                        {{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->e_concepto10 :''}}
                                                                    </p>
                                                                </td>
                                                                <td class="letra-componente alinear-derecha" style="width:15%;">
                                                                    <p>
                                                                        @if( $estudio->formatoHddisc )
                                                                            @if( $estudio->formatoHddisc->situacion_economica->e_monto10 > '0' )
                                                                                ${{ number_format( $estudio->formatoHddisc->situacion_economica->e_monto10 ,2 ) }}
                                                                            @else
                                                                                --
                                                                            @endif
                                                                        @endif
                                                            ...
                                                            <tr>
                                                                <td class="letra-componente alinear-izquierda" style="width:20%;">
                                                                    <p>
                                                                        {{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->aportacion11 :''}}
                                                                    </p>
                                                                </td>
                                                                <td class="letra-componente alinear-izquierda" style="width:20%;">
                                                                    <p>
                                                                        {{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->i_concepto11 :''}}
                                                                    </p>
                                                                </td>
                                                                <td class="letra-componente alinear-derecha" style="width:15%;">
                                                                    <p>
                                                                        ...
                                                                        @if( $estudio->formatoHddisc )
                                                                            @if( $estudio->formatoHddisc->situacion_economica->i_monto11 > '0' )
                                                                                ${{ number_format( $estudio->formatoHddisc->situacion_economica->i_monto11 ,2 ) }}
                                                                            @else
                                                                                --
                                                                            @endif
                                                                        @endif
                                                                ...
                                                                <td class="letra-componente alinear-izquierda" style="width:30%;">
                                                                    <p>
                                                                        {{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->e_concepto11 :''}}
                                                                    </p>
                                                                </td>
                                                                <td class="letra-componente alinear-derecha" style="width:15%;">
                                                                    <p>
                                                                        @if( $estudio->formatoHddisc )
                                                                            @if( $estudio->formatoHddisc->situacion_economica->e_monto11 > '0' )
                                                                                ${{ number_format( $estudio->formatoHddisc->situacion_economica->e_monto11 ,2 ) }}
                                                                            @else
                                                                                --
                                                                            @endif
                                                                        @endif
                                                            ...
                                                            <tr>
                                                                <tr>
                                                                    ...
                                                                    <td class="letra-componente alinear-derecha" style="width:15%;">
                                                                        <p>
                                                                            ${{ isset( $estudio->formatoHddisc ) ? number_format($estudio->formatoHddisc->situacion_economica->i_total,2) :''}}
                                                                        </p>
                                                                    </td>                                                                        
                                                                    ...
                                                                    <td class="letra-componente alinear-derecha" style="width:15%;">
                                                                        <p>
                                                                            ${{ isset( $estudio->formatoHddisc ) ? number_format($estudio->formatoHddisc->situacion_economica->e_total,2) :''}}
                                                                        </p>
                                                                    </td>
                                                                </tr>                                                                                         
                                            ...
                                            <table class="auto-width">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <p class="letra-componente justificar">
                                                                {{ isset($estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->deficit : '' }}
                                                            </p>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                                    ...
                                                    <tr>
                                                        <td class="table-border">
                                                            <table class="tabla-componente">
                                                                ...
                                                                <tbody>
                                                                    @if( $estudio->formatoHddisc )
                                                                    @foreach( $estudio->formatoHddisc->bienes as $bien )
                                                                    <tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="letra-componente alinear-derecha" style="width:10%;">
                                                                            <p>
                                                                                ${{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->bienes_totales->valor : '0.00' }}
                                                                            </p>
                                                                        </td>                                                                        
                                                                        <td class="letra-componente alinear-derecha" style="width:10%;">
                                                                            <p>
                                                                                ${{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->bienes_totales->pagado  : '0.00' }}

                                                                            </p>
                                                                        </td>
                                                                        <td class="letra-componente alinear-derecha" style="width:10%;">
                                                                            <p>
                                                                                ${{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->bienes_totales->adeudo  : '0.00' }}
                                                                            </p>
                                                                        </td>
                                                                    </tr>                                                                                         
                                                                    @endif
                                            ...
                                            <table class="auto-width">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <p class="letra-componente alinear-izquierda">
                                                                {{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->bienes_totales->ubicacion : '' }}
                                                            </p>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                                                            ...
                                                                            <table class="tabla-componente">
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td 
                                                                                            @if( $estudio->formatoHddisc )
                                                                                            @if( trim( $estudio->formatoHddisc->tipo_vivienda->propia ) != ''  )
                                                                                    ...
                                                                                    <tr>
                                                                                        <td 
                                                                                            @if( $estudio->formatoHddisc )
                                                                                            @if( trim( $estudio->formatoHddisc->tipo_vivienda->rentada ) != ''  )
                                                                                            style="background-color:#FF8000; width: 30%;"
                                                                                            @else
                                                                                            style="width: 30%;"
                                                                                            @endif
                                                                                    ...
                                                                                    <tr>
                                                                                        <td 
                                                                                            @if( $estudio->formatoHddisc )
                                                                                            @if( trim( $estudio->formatoHddisc->tipo_vivienda->hipotecada ) != ''  )
                                                                                            style="background-color:#FF8000; width: 30%;"
                                                                                            @else
                                                                                            style="width: 30%;"
                                                                                            @endif
                                                                                    ...
                                                                                    <tr>
                                                                                        <td 
                                                                                            @if( $estudio->formatoHddisc )
                                                                                            @if( trim( $estudio->formatoHddisc->tipo_vivienda->congelada ) != ''  )
                                                                                            style="background-color:#FF8000; width: 30%;"
                                                                                            @else
                                                                                            style="width: 30%;"
                                                                                            @endif
                                                                                    ...
                                                                                    <tr>
                                                                                        <td 
                                                                                            @if( $estudio->formatoHddisc )
                                                                                            @if( trim( $estudio->formatoHddisc->tipo_vivienda->prestada ) != ''  )
                                                                                            style="background-color:#FF8000; width: 30%;"
                                                                                            @else
                                                                                            style="width: 30%;"
                                                                                            @endif
                                                                                    ...
                                                                                    <tr>
                                                                                        <td 
                                                                                            @if( $estudio->formatoHddisc )
                                                                                            @if( trim( $estudio->formatoHddisc->tipo_vivienda->de_padres ) != ''  )
                                                                                            style="background-color:#FF8000; width: 30%;"
                                                                                            @else
                                                                                            style="width: 30%;"
                                                                                            @endif
                                                                                    ...
                                                                                    <tr>
                                                                                        <td 
                                                                                            @if( $estudio->formatoHddisc )
                                                                                            @if( trim( $estudio->formatoHddisc->tipo_vivienda->otro ) != ''  )
                                                                                            style="background-color:#FF8000; width: 30%;"
                                                                                            @else
                                                                                            style="width: 30%;"
                                                                                            @endif
                                                                            ...
                                                                            <table class="tabla-componente">
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td 
                                                                                            @if( $estudio->formatoHddisc )
                                                                                            @if( trim( $estudio->formatoHddisc->tipo_propiedad->casa ) != ''  )
                                                                                            style="background-color:#FF8000; width: 30%;"
                                                                                            @else
                                                                                            style="width: 30%;"
                                                                                            @endif
                                                                                    ...
                                                                                    <tr>
                                                                                        <td 
                                                                                            @if( $estudio->formatoHddisc )
                                                                                            @if( trim( $estudio->formatoHddisc->tipo_propiedad->depto ) != ''  )
                                                                                            style="background-color:#FF8000; width: 30%;"
                                                                                            @else
                                                                                            style="width: 30%;"
                                                                                            @endif
                                                                                    ...
                                                                                    <tr>
                                                                                        <td 
                                                                                            @if( $estudio->formatoHddisc )
                                                                                            @if( trim( $estudio->formatoHddisc->tipo_propiedad->duplex ) != ''  )
                                                                                            style="background-color:#FF8000; width: 30%;"
                                                                                            @else
                                                                                            style="width: 30%;"
                                                                                            @endif
                                                                                    ...
                                                                                    <tr>
                                                                                        <td 
                                                                                            @if( $estudio->formatoHddisc )
                                                                                            @if( trim( $estudio->formatoHddisc->tipo_propiedad->condominio ) != ''  )
                                                                                            style="background-color:#FF8000; width: 30%;"
                                                                                            @else
                                                                                            style="width: 30%;"
                                                                                            @endif
                                                                                    ...
                                                                                    <tr>
                                                                                        <td 
                                                                                            @if( $estudio->formatoHddisc )
                                                                                            @if( trim( $estudio->formatoHddisc->tipo_propiedad->vecindad ) != ''  )
                                                                                            style="background-color:#FF8000; width: 30%;"
                                                                                            @else
                                                                                            style="width: 30%;"
                                                                                            @endif
                                                                                    ...
                                                                                    <tr>
                                                                                        <td 
                                                                                            @if( $estudio->formatoHddisc )
                                                                                            @if( trim( $estudio->formatoHddisc->tipo_propiedad->cuarto ) != ''  )
                                                                                            style="background-color:#FF8000; width: 30%;"
                                                                                            @else
                                                                                            style="width: 30%;"
                                                                                            @endif
                                                                                    ...
                                                                                    <tr>
                                                                                        <td 
                                                                                            @if( $estudio->formatoHddisc )
                                                                                            @if( trim( $estudio->formatoHddisc->tipo_propiedad->otro ) != ''  )
                                                                                            style="background-color:#FF8000; width: 30%;"
                                                                                            @else
                                                                                            style="width: 30%;"
                                                                                            @endif
                                                                            ...
                                                                            <table class="tabla-componente">
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td
                                                                                            @if( $estudio->formatoHddisc )
                                                                                            @if( trim($estudio->formatoHddisc->info_vivienda_servicios->luz) != '' )
                                                                                            style="background-color:#FF8000; width: 30%;"
                                                                                            @else
                                                                                            style="width: 30%;"
                                                                                            @endif
                                                                                    ...
                                                                                    <tr>
                                                                                        <td
                                                                                            @if( $estudio->formatoHddisc )
                                                                                            @if( trim($estudio->formatoHddisc->info_vivienda_servicios->agua) != '' )
                                                                                            style="background-color:#FF8000; width: 30%;"
                                                                                            @else
                                                                                            style="width: 30%;"
                                                                                            @endif
                                                                                    ...
                                                                                    <tr>
                                                                                        <td
                                                                                            @if( $estudio->formatoHddisc )
                                                                                            @if( trim($estudio->formatoHddisc->info_vivienda_servicios->pavimento) != '' )
                                                                                            style="background-color:#FF8000; width: 30%;"
                                                                                            @else
                                                                                            style="width: 30%;"
                                                                                            @endif
                                                                                    ...
                                                                                    <tr>
                                                                                        <td
                                                                                            @if( $estudio->formatoHddisc )
                                                                                            @if( trim($estudio->formatoHddisc->info_vivienda_servicios->drenaje) != '' )
                                                                                            style="background-color:#FF8000; width: 30%;"
                                                                                            @else
                                                                                            style="width: 30%;"
                                                                                            @endif
                                                                                    ...
                                                                                    <tr>
                                                                                        <td
                                                                                            @if( $estudio->formatoHddisc )
                                                                                            @if( trim($estudio->formatoHddisc->info_vivienda_servicios->telefono) != '' )
                                                                                            style="background-color:#FF8000; width: 30%;"
                                                                                            @else
                                                                                            style="width: 30%;"
                                                                                            @endif
                                                                                    ...
                                                                                    <tr>
                                                                                        <td
                                                                                            @if( $estudio->formatoHddisc )
                                                                                            @if( trim($estudio->formatoHddisc->info_vivienda_servicios->seg_publica) != '' )
                                                                                            style="background-color:#FF8000; width: 30%;"
                                                                                            @else
                                                                                            style="width: 30%;"
                                                                                            @endif
                                                                                    ...
                                                                                    <tr>
                                                                                        <td
                                                                                            @if( $estudio->formatoHddisc )
                                                                                            @if( trim($estudio->formatoHddisc->info_vivienda_servicios->alumbrado) != '' )
                                                                                            style="background-color:#FF8000; width: 30%;"
                                                                                            @else
                                                                                            style="width: 30%;"
                                                                                            @endif
                                                                            ...
                                                                            <table class="tabla-componente">
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td
                                                                                            @if( $estudio->formatoHddisc )
                                                                                            @if( trim( $estudio->formatoHddisc->info_vivienda_distribucion->sala ) != '' )
                                                                                            style="background-color:#FF8000; width: 30%;"
                                                                                            @else
                                                                                            style="width: 30%;"
                                                                                            @endif
                                                                                    ...
                                                                                    <tr>
                                                                                        <td
                                                                                            @if( $estudio->formatoHddisc )
                                                                                            @if( trim( $estudio->formatoHddisc->info_vivienda_distribucion->comedor ) != '' )
                                                                                            style="background-color:#FF8000; width: 30%;"
                                                                                            @else
                                                                                            style="width: 30%;"
                                                                                            @endif
                                                                                    ...
                                                                                    <tr>
                                                                                        <td
                                                                                            @if( $estudio->formatoHddisc )
                                                                                            @if( trim( $estudio->formatoHddisc->info_vivienda_distribucion->recamara ) != '' )
                                                                                            style="background-color:#FF8000; width: 30%;"
                                                                                            @else
                                                                                            style="width: 30%;"
                                                                                            @endif
                                                                                    ...
                                                                                    <tr>
                                                                                        <td
                                                                                            @if( $estudio->formatoHddisc )
                                                                                            @if( trim( $estudio->formatoHddisc->info_vivienda_distribucion->cocina ) != '' )
                                                                                            style="background-color:#FF8000; width: 30%;"
                                                                                            @else
                                                                                            style="width: 30%;"
                                                                                            @endif
                                                                                    ...
                                                                                    <tr>
                                                                                        <td
                                                                                            @if( $estudio->formatoHddisc )
                                                                                            @if( trim( $estudio->formatoHddisc->info_vivienda_distribucion->banio ) != '' )
                                                                                            style="background-color:#FF8000; width: 30%;"
                                                                                            @else
                                                                                            style="width: 30%;"
                                                                                            @endif
                                                                                    ...
                                                                                    <tr>
                                                                                        <td
                                                                                            @if( $estudio->formatoHddisc )
                                                                                            @if( trim( $estudio->formatoHddisc->info_vivienda_distribucion->garaje ) != '' )
                                                                                            style="background-color:#FF8000; width: 30%;"
                                                                                            @else
                                                                                            style="width: 30%;"
                                                                                            @endif
                                                                                    ...
                                                                                    <tr>
                                                                                        <td
                                                                                            @if( $estudio->formatoHddisc )
                                                                                            @if( trim( $estudio->formatoHddisc->info_vivienda_distribucion->biblioteca ) != '' )
                                                                                            style="background-color:#FF8000; width: 30%;"
                                                                                            @else
                                                                                            style="width: 30%;"
                                                                                            @endif
                                                                            ...
                                                                            <table class="tabla-componente">
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td
                                                                                            @if( $estudio->formatoHddisc )
                                                                                            @if( trim( $estudio->formatoHddisc->info_vivienda_distribucion->jardin ) != '' )
                                                                                            style="background-color:#FF8000; width: 30%;"
                                                                                            @else
                                                                                            style="width: 30%;"
                                                                                            @endif
                                                                                    ...
                                                                                    <tr>
                                                                                        <td
                                                                                            @if( $estudio->formatoHddisc )
                                                                                            @if( trim( $estudio->formatoHddisc->info_vivienda_distribucion->zotehuela ) != '' )
                                                                                            style="background-color:#FF8000; width: 30%;"
                                                                                            @else
                                                                                            style="width: 30%;"
                                                                                            @endif
                                                                                    ...
                                                                                    <tr>
                                                                                        <td
                                                                                            @if( $estudio->formatoHddisc )
                                                                                            @if( trim( $estudio->formatoHddisc->info_vivienda_distribucion->patio ) != '' )
                                                                                            style="background-color:#FF8000; width: 30%;"
                                                                                            @else
                                                                                            style="width: 30%;"
                                                                                            @endif
                                                                                    ...
                                                                                    <tr>
                                                                                        <td
                                                                                            @if( $estudio->formatoHddisc )
                                                                                            @if( trim( $estudio->formatoHddisc->info_vivienda_distribucion->estudio ) != '' )
                                                                                            style="background-color:#FF8000; width: 30%;"
                                                                                            @else
                                                                                            style="width: 30%;"
                                                                                            @endif
                                                                                    ...
                                                                                    <tr>
                                                                                        <td
                                                                                            @if( $estudio->formatoHddisc )
                                                                                            @if( trim( $estudio->formatoHddisc->info_vivienda_distribucion->cuarto_servicio ) != '' )
                                                                                            style="background-color:#FF8000; width: 30%;"
                                                                                            @else
                                                                                            style="width: 30%;"
                                                                                            @endif
                                                                            ...
                                                                            <table class="tabla-componente" >
                                                                                <tbody>
                                                                                    <tr>
                                                                                        ...
                                                                                        <td class="letra-componente alinear-izquierda" style="width: 60%">
                                                                                            {{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->tipo_vivienda->viven_domicilio : '' }}
                                                                                        </td>
                                                                                    </tr>
                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td
                                                                                            ...
                                                                                            @if( $estudio->formatoHddisc )
                                                                                            @if( trim( $estudio->formatoHddisc->info_vivienda_nivel_economico->alta ) != '' )
                                                                                            style="background-color:#FF8000; width: 30%;"
                                                                                            @else
                                                                                            style="width: 30%;"
                                                                                            @endif
                                                                                    ...
                                                                                    <tr>
                                                                                        <td
                                                                                            ...
                                                                                            @if( $estudio->formatoHddisc )
                                                                                            @if( trim( $estudio->formatoHddisc->info_vivienda_nivel_economico->media_alta ) != '' )
                                                                                            style="background-color:#FF8000; width: 30%;"
                                                                                            @else
                                                                                            style="width: 30%;"
                                                                                            @endif
                                                                                    ...
                                                                                    <tr>
                                                                                        <td
                                                                                            ...
                                                                                            @if( $estudio->formatoHddisc )
                                                                                            @if( trim( $estudio->formatoHddisc->info_vivienda_nivel_economico->media ) != '' )
                                                                                            style="background-color:#FF8000; width: 30%;"
                                                                                            @else
                                                                                            style="width: 30%;"
                                                                                            @endif
                                                                                    ...
                                                                                    <tr>
                                                                                        <td
                                                                                            ...
                                                                                            @if( $estudio->formatoHddisc )
                                                                                            @if( trim( $estudio->formatoHddisc->info_vivienda_nivel_economico->media_baja ) != '' )
                                                                                            style="background-color:#FF8000; width: 30%;"
                                                                                            @else
                                                                                            style="width: 30%;"
                                                                                            @endif
                                                                                    ...
                                                                                    <tr>
                                                                                        <td
                                                                                            ...
                                                                                            @if( $estudio->formatoHddisc )
                                                                                            @if( trim( $estudio->formatoHddisc->info_vivienda_nivel_economico->baja ) != '' )
                                                                                            style="background-color:#FF8000; width: 30%;"
                                                                                            @else
                                                                                            style="width: 30%;"
                                                                                            @endif
                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td
                                                                                            ...
                                                                                            @if( $estudio->formatoHddisc )
                                                                                            @if( trim($estudio->formatoHddisc->vivienda_construccion->antigua) != '' )
                                                                                            style="background-color:#FF8000; width: 30%;"
                                                                                            @else
                                                                                            style="width: 30%;"
                                                                                            @endif
                                                                                    ...
                                                                                    <tr>
                                                                                        <td
                                                                                            ...
                                                                                            @if( $estudio->formatoHddisc )
                                                                                            @if( trim($estudio->formatoHddisc->vivienda_construccion->sencilla) != '' )
                                                                                            style="background-color:#FF8000; width: 30%;"
                                                                                            @else
                                                                                            style="width: 30%;"
                                                                                            @endif
                                                                                    ...
                                                                                    <tr>
                                                                                        <td
                                                                                            ...
                                                                                            @if( $estudio->formatoHddisc )
                                                                                            @if( trim($estudio->formatoHddisc->vivienda_construccion->moderna) != '' )
                                                                                            style="background-color:#FF8000; width: 30%;"
                                                                                            @else
                                                                                            style="width: 30%;"
                                                                                            @endif
                                                                                    ...
                                                                                    <tr>
                                                                                        <td
                                                                                            ...
                                                                                            @if( $estudio->formatoHddisc )
                                                                                            @if( trim($estudio->formatoHddisc->vivienda_construccion->semi_moderna) != '' )
                                                                                            style="background-color:#FF8000; width: 30%;"
                                                                                            @else
                                                                                            style="width: 30%;"
                                                                                            @endif
                                                                                    ...
                                                                                    <tr>
                                                                                        <td
                                                                                            ...
                                                                                            @if( $estudio->formatoHddisc )
                                                                                            @if( trim($estudio->formatoHddisc->vivienda_construccion->convencional) != '' )
                                                                                            style="background-color:#FF8000; width: 30%;"
                                                                                            @else
                                                                                            style="width: 30%;"
                                                                                            @endif
                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td
                                                                                            ...
                                                                                            @if( $estudio->formatoHddisc )
                                                                                            @if( trim( $estudio->formatoHddisc->vivienda_conservacion->excelente ) != '' )
                                                                                            style="background-color:#FF8000; width: 30%;"
                                                                                            @else
                                                                                            style="width: 30%;"
                                                                                            @endif
                                                                                    ...
                                                                                    <tr>
                                                                                        <td
                                                                                            ...
                                                                                            @if( $estudio->formatoHddisc )
                                                                                            @if( trim( $estudio->formatoHddisc->vivienda_conservacion->bueno ) != '' )
                                                                                            style="background-color:#FF8000; width: 30%;"
                                                                                            @else
                                                                                            style="width: 30%;"
                                                                                            @endif
                                                                                    ...
                                                                                    <tr>
                                                                                        <td
                                                                                            ...
                                                                                            @if( $estudio->formatoHddisc )
                                                                                            @if( trim( $estudio->formatoHddisc->vivienda_conservacion->regular ) != '' )
                                                                                            style="background-color:#FF8000; width: 30%;"
                                                                                            @else
                                                                                            style="width: 30%;"
                                                                                            @endif
                                                                                    ...
                                                                                    <tr>
                                                                                        <td
                                                                                            ...
                                                                                            @if( $estudio->formatoHddisc )
                                                                                            @if( trim( $estudio->formatoHddisc->vivienda_conservacion->malo ) != '' )
                                                                                            style="background-color:#FF8000; width: 30%;"
                                                                                            @else
                                                                                            style="width: 30%;"
                                                                                            @endif
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td
                                                                                            ...
                                                                                            @if( $estudio->formatoHddisc )
                                                                                            @if( trim( $estudio->formatoHddisc->vivienda_conservacion->pesimo ) != '' )
                                                                                            style="background-color:#FF8000; width: 30%;"
                                                                                            @else
                                                                                            style="width: 30%;"
                                                                                            @endif
                                                                            ...
                                                                            <table class="tabla-componente">
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td                                                                                            
                                                                                            @if( $estudio->formatoHddisc )
                                                                                            @if( trim( $estudio->formatoHddisc->vivienda_calidad_mobiliario->completo ) !='' )
                                                                                            style="background-color:#FF8000; width: 30%;"
                                                                                            @else
                                                                                            style="width: 30%;"
                                                                                            @endif
                                                                                    ...
                                                                                    <tr>
                                                                                        <td                                                                                            
                                                                                            @if( $estudio->formatoHddisc )
                                                                                            @if( trim( $estudio->formatoHddisc->vivienda_calidad_mobiliario->incompleto ) !='' )
                                                                                            style="background-color:#FF8000; width: 30%;"
                                                                                            @else
                                                                                            style="width: 30%;"
                                                                                            @endif
                                                                                    ...
                                                                                    <tr>
                                                                                        <td                                                                                            
                                                                                            @if( $estudio->formatoHddisc )
                                                                                            @if( trim( $estudio->formatoHddisc->vivienda_calidad_mobiliario->escueto ) !='' )
                                                                                            style="background-color:#FF8000; width: 30%;"
                                                                                            @else
                                                                                            style="width: 30%;"
                                                                                            @endif
                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td
                                                                                            ...
                                                                                            @if( $estudio->formatoHddisc )
                                                                                            @if( trim( $estudio->formatoHddisc->vivienda_corte->variado ) != '' )
                                                                                            style="background-color:#FF8000; width: 30%;"
                                                                                            @else
                                                                                            style="width: 30%;"
                                                                                            @endif
                                                                                    ...
                                                                                    <tr>
                                                                                        <td
                                                                                            ...
                                                                                            @if( $estudio->formatoHddisc )
                                                                                            @if( trim( $estudio->formatoHddisc->vivienda_corte->conservador ) != '' )
                                                                                            style="background-color:#FF8000; width: 30%;"
                                                                                            @else
                                                                                            style="width: 30%;"
                                                                                            @endif
                                                                                    ...
                                                                                    <tr>
                                                                                        <td
                                                                                            ...
                                                                                            @if( $estudio->formatoHddisc )
                                                                                            @if( trim( $estudio->formatoHddisc->vivienda_corte->moderno ) != '' )
                                                                                            style="background-color:#FF8000; width: 30%;"
                                                                                            @else
                                                                                            style="width: 30%;"
                                                                                            @endif
                                                                                    ...
                                                                                    <tr>
                                                                                        <td
                                                                                            ...
                                                                                            @if( $estudio->formatoHddisc )
                                                                                            @if( trim( $estudio->formatoHddisc->vivienda_corte->colonial ) != '' )
                                                                                            style="background-color:#FF8000; width: 30%;"
                                                                                            @else
                                                                                            style="width: 30%;"
                                                                                            @endif
                                                                                    ...
                                                                                    <tr>
                                                                                        <td
                                                                                            ...
                                                                                            @if( $estudio->formatoHddisc )
                                                                                            @if( trim( $estudio->formatoHddisc->vivienda_corte->sencillo ) != '' )
                                                                                            style="background-color:#FF8000; width: 30%;"
                                                                                            @else
                                                                                            style="width: 30%;"
                                                                                            @endif
                                            ...
                                            <table class="auto-width">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td style="width: 50%;">
                                                            <p class="letra-componente alinear-izquierda">
                                                                {{ isset($estudio->formatoHddisc ) ?$estudio->formatoHddisc->vivienda_corte->condiciones_internas : '' }}
                                                            </p>
                                                        </td>
                                                        <td style="width: 50%;">
                                                            <p class="letra-componente alinear-izquierda">
                                                                {{ isset($estudio->formatoHddisc ) ?$estudio->formatoHddisc->vivienda_corte->condiciones_externas : '' }}
                                                            </p>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                                    ...
                                                    <tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td  colspan="4" class="letra-componente alinear-izquierda table-border" style="width: 75%">
                                                                            <p class="border-footer">
                                                                                @if( $estudio->formatoHddisc )
                                                                                @if( $estudio->formatoHddisc->familiar_empresa->familiar_empresa == '1' )
                                                                                {{ $estudio->formatoHddisc->familiar_empresa->familiar_empresa_si }}
                                                                                @else
                                                                                N/A
                                                                                @endif
                                                                                @endif
                                                        ...
                                                        <td>
                                                            <p class="border-footer letra-componente alinear-izquierda">
                                                                Medio: {{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->familiar_empresa->entero_vacante : '' }}
                                                            </p>
                                                            <p class="border-footer letra-componente alinear-izquierda">
                                                                Nombre del reclutador: {{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->familiar_empresa->reclutador : '' }}
                                                            </p>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            ...
                                            <table class="tabla-componente">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td style="width: 50%">
                                                            <p class="letra-componente alinear-izquierda">
                                                                {{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->ubicacion_domicilio->distancia_domicilio: '' }}
                                                            </p>
                                                        </td >
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td style="width: 50%">
                                                            <p class="letra-componente alinear-izquierda">
                                                                {{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->ubicacion_domicilio->transporte_utiliza: '' }}
                                                            </p>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td class="letra-componente alinear-izquierda">
                                                            {{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_social->pertenece_organizaciones : '' }}
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                                            ...
                                                            <table class="tabla-componente">
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td
                                                                            @if( $estudio->formatoHddisc ) 
                                                                            @if( $estudio->formatoHddisc->situacion_social->demanda_laboral == '1' )
                                                                            style="background-color:#FF8000; width: 10%;"
                                                                            @else
                                                                            style="width: 10%;"
                                                                            @endif 
                                                                        ...
                                                                        <td
                                                                            @if( $estudio->formatoHddisc ) 
                                                                            @if( $estudio->formatoHddisc->situacion_social->demanda_laboral == '2' )
                                                                            style="background-color:#FF8000; width: 10%;"
                                                                            @else
                                                                            style="width: 10%;"
                                                                            @endif 
                                                                        ...
                                                                        <td  class="letra-componente alinear-izquierda table-border" style="width: 40%">
                                                                            @if( $estudio->formatoHddisc ) 
                                                                            @if( $estudio->formatoHddisc->situacion_social->demanda_laboral == '1' )
                                                                            {{ $estudio->formatoHddisc->situacion_social->motivo_demanda }}
                                                                            @else
                                                                            N/A
                                                                            @endif 
                                                                            @endif
                                            ...
                                            <table class="tabla-componente">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td class="letra-componente alinear-centro" style="width: 25%">
                                                            <p>
                                                                {{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_social->interes_corto_plazo : '' }}
                                                            </p>
                                                        </td>
                                                        <td class="letra-componente alinear-centro" style="width: 25%">
                                                            <p>
                                                                {{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_social->interes_mediano_plazo : '' }}
                                                            </p>
                                                        </td>
                                                        <td class="letra-componente alinear-centro" style="width: 25%">
                                                            <p>
                                                                {{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_social->interes_largo_plazo : '' }}
                                                            </p>
                                                        </td>

                                                        <td class="letra-componente alinear-centro" style="width: 25%">
                                                            <p>
                                                                {{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_social->pasatiempos : '' }}
                                                            </p>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                                            ...
                                                            <table class="tabla-componente">
                                                                <tbody>
                                                                    <tr>
                                                                        <td
                                                                            @if( $estudio->formatoHddisc ) 
                                                                            @if( $estudio->formatoHddisc->enfermedad->estado_salud == '1' )
                                                                            style="background-color:#FF8000; width: 10%;"
                                                                            @else
                                                                            style="width: 10%;"
                                                                            @endif 
                                                                        ...
                                                                        <td
                                                                            @if( $estudio->formatoHddisc ) 
                                                                            @if( $estudio->formatoHddisc->enfermedad->estado_salud == '2' )
                                                                            style="background-color:#FF8000; width: 10%;"
                                                                            @else
                                                                            style="width: 10%;"
                                                                            @endif 
                                                                        ...
                                                                        <td 
                                                                            @if( $estudio->formatoHddisc ) 
                                                                            @if( $estudio->formatoHddisc->enfermedad->estado_salud == '3' )
                                                                            style="background-color:#FF8000; width: 10%;"
                                                                            @else
                                                                            style="width: 10%;"
                                                                            @endif 
                                                                                ...
                                                                                <table class="tabla-componente">
                                                                                    <tbody>
                                                                                        <tr>
                                                                                            <td 
                                                                                                @if( $estudio->formatoHddisc ) 
                                                                                                @if( $estudio->formatoHddisc->enfermedad->anemia == '1' )
                                                                                            ...
                                                                                            <td 
                                                                                                @if( $estudio->formatoHddisc ) 
                                                                                                @if( $estudio->formatoHddisc->enfermedad->asma == '1' )
                                                                                                style="background-color:#FF8000; width: 5%"
                                                                                                @else
                                                                                                style="width: 5%"
                                                                                                @endif 
                                                                                            ...
                                                                                            <td 
                                                                                                @if( $estudio->formatoHddisc ) 
                                                                                                @if( $estudio->formatoHddisc->enfermedad->gripe == '1' )
                                                                                                style="background-color:#FF8000; width: 5%"
                                                                                                @else
                                                                                                style="width: 5%"
                                                                                                @endif 
                                                                                            ...
                                                                                            <td 
                                                                                                @if( $estudio->formatoHddisc ) 
                                                                                                @if( $estudio->formatoHddisc->enfermedad->presion_alta == '1' )
                                                                                                style="background-color:#FF8000; width: 5%"
                                                                                                @else
                                                                                                style="width: 5%"
                                                                                                @endif 
                                                                                            ...
                                                                                            <td 
                                                                                                @if( $estudio->formatoHddisc ) 
                                                                                                @if( $estudio->formatoHddisc->enfermedad->epilepsia == '1' )
                                                                                                style="background-color:#FF8000; width: 5%"
                                                                                                @else
                                                                                                style="width: 5%"
                                                                                                @endif 
                                                                                        ...
                                                                                        <tr>
                                                                                            <td 
                                                                                                @if( $estudio->formatoHddisc ) 
                                                                                                @if( $estudio->formatoHddisc->enfermedad->gastritis == '1' )
                                                                                                style="background-color:#FF8000; width: 5%"
                                                                                                @else
                                                                                                style="width: 5%"
                                                                                                @endif 
                                                                                            ...
                                                                                            <td 
                                                                                                @if( $estudio->formatoHddisc ) 
                                                                                                @if( $estudio->formatoHddisc->enfermedad->espalda == '1' )
                                                                                                style="background-color:#FF8000; width: 5%"
                                                                                                @else
                                                                                                style="width: 5%"
                                                                                                @endif 
                                                                                            ...
                                                                                            <td 
                                                                                                @if( $estudio->formatoHddisc ) 
                                                                                                @if( $estudio->formatoHddisc->enfermedad->migrania == '1' )
                                                                                                style="background-color:#FF8000; width: 5%"
                                                                                                @else
                                                                                                style="width: 5%"
                                                                                                @endif 
                                                                                            ...
                                                                                            <td 
                                                                                                @if( $estudio->formatoHddisc ) 
                                                                                                @if( $estudio->formatoHddisc->enfermedad->presion_baja == '1' )
                                                                                                style="background-color:#FF8000; width: 5%"
                                                                                                @else
                                                                                                style="width: 5%"
                                                                                                @endif 
                                                                                            ...
                                                                                            <td 
                                                                                                @if( $estudio->formatoHddisc ) 
                                                                                                @if( $estudio->formatoHddisc->enfermedad->problemas_cardiacos == '1' )
                                                                                                style="background-color:#FF8000; width: 5%"
                                                                                                @else
                                                                                                style="width: 5%"
                                                                                                @endif 
                                                                                        ...
                                                                                        <tr>
                                                                                            <td
                                                                                                @if( $estudio->formatoHddisc ) 
                                                                                                @if( $estudio->formatoHddisc->enfermedad->ulcera == '1' )
                                                                                                style="background-color:#FF8000; width: 5%"
                                                                                                @else
                                                                                                style="width: 5%"
                                                                                                @endif 
                                                                                            ...
                                                                                            <td
                                                                                                @if( $estudio->formatoHddisc ) 
                                                                                                @if( $estudio->formatoHddisc->enfermedad->artritis == '1' )
                                                                                                style="background-color:#FF8000; width: 5%"
                                                                                                @else
                                                                                                style="width: 5%"
                                                                                                @endif 
                                                                                            ...
                                                                                            <td
                                                                                                @if( $estudio->formatoHddisc ) 
                                                                                                @if( $estudio->formatoHddisc->enfermedad->bronquitis == '1' )
                                                                                                style="background-color:#FF8000; width: 5%"
                                                                                                @else
                                                                                                style="width: 5%"
                                                                                                @endif 
                                                                                            ...
                                                                                            <td
                                                                                                @if( $estudio->formatoHddisc ) 
                                                                                                @if( $estudio->formatoHddisc->enfermedad->rinon == '1' )
                                                                                                style="background-color:#FF8000; width: 5%"
                                                                                                @else
                                                                                                style="width: 5%"
                                                                                                @endif 
                                                                            ...
                                                                            <table class="tabla-componente">
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td
                                                                                            @if( $estudio->formatoHddisc ) 
                                                                                            @if( $estudio->formatoHddisc->padecimiento->acidez == '1' )
                                                                                            style="background-color:#FF8000; width: 5%"
                                                                                            @else
                                                                                            style="width: 5%"
                                                                                            @endif 
                                                                                        ...
                                                                                        <td
                                                                                            @if( $estudio->formatoHddisc ) 
                                                                                            @if( $estudio->formatoHddisc->padecimiento->ansiedad == '1' )
                                                                                            style="background-color:#FF8000; width: 5%"
                                                                                            @else
                                                                                            style="width: 5%"
                                                                                            @endif 
                                                                                        ...
                                                                                        <td
                                                                                            @if( $estudio->formatoHddisc ) 
                                                                                            @if( $estudio->formatoHddisc->padecimiento->dolor_cabeza == '1' )
                                                                                            style="background-color:#FF8000; width: 5%"
                                                                                            @else
                                                                                            style="width: 5%"
                                                                                            @endif 
                                                                                        ...
                                                                                        <td
                                                                                            @if( $estudio->formatoHddisc ) 
                                                                                            @if( $estudio->formatoHddisc->padecimiento->estrenimiento == '1' )
                                                                                            style="background-color:#FF8000; width: 5%"
                                                                                            @else
                                                                                            style="width: 5%"
                                                                                            @endif 
                                                                                    ...
                                                                                    <tr>
                                                                                        <td
                                                                                            @if( $estudio->formatoHddisc ) 
                                                                                            @if( $estudio->formatoHddisc->padecimiento->insomnio == '1' )
                                                                                            style="background-color:#FF8000; width: 5%"
                                                                                            @else
                                                                                            style="width: 5%"
                                                                                            @endif 
                                                                                        ...
                                                                                        <td
                                                                                            @if( $estudio->formatoHddisc ) 
                                                                                            @if( $estudio->formatoHddisc->padecimiento->escalofrios == '1' )
                                                                                            style="background-color:#FF8000; width: 5%"
                                                                                            @else
                                                                                            style="width: 5%"
                                                                                            @endif 
                                                                                        ...
                                                                                        <td
                                                                                            @if( $estudio->formatoHddisc ) 
                                                                                            @if( $estudio->formatoHddisc->padecimiento->manos_temblorosas == '1' )
                                                                                            style="background-color:#FF8000; width: 5%"
                                                                                            @else
                                                                                            style="width: 5%"
                                                                                            @endif 
                                                                                        ...
                                                                                        <td
                                                                                            @if( $estudio->formatoHddisc ) 
                                                                                            @if( $estudio->formatoHddisc->padecimiento->alergia == '1' )
                                                                                            style="background-color:#FF8000; width: 5%"
                                                                                            @else
                                                                                            style="width: 5%"
                                                                                            @endif 
                                                                                        ...
                                                                                        <td class="letra-componente alinear-centro" style="width: 10%">
                                                                                            @if( $estudio->formatoHddisc ) 
                                                                                            @if( $estudio->formatoHddisc->padecimiento->alergia == '1' )
                                                                                                {{ $estudio->formatoHddisc->padecimiento->tipo }}
                                                                                            @endif 
                                                                                            N/A
                                                                                            @endif
                                                                                        </td>
                                                                                    ...
                                                                                    <tr>
                                                                                        <td
                                                                                            @if( $estudio->formatoHddisc ) 
                                                                                            @if( $estudio->formatoHddisc->padecimiento->debilidad == '1' )
                                                                                            style="background-color:#FF8000; width: 5%"
                                                                                            @else
                                                                                            style="width: 5%"
                                                                                            @endif 
                                                                                        ...
                                                                                        <td
                                                                                            @if( $estudio->formatoHddisc ) 
                                                                                            @if( $estudio->formatoHddisc->padecimiento->mareos == '1' )
                                                                                            style="background-color:#FF8000; width: 5%"
                                                                                            @else
                                                                                            style="width: 5%"
                                                                                            @endif 
                                                                                        ...
                                                                                        <td
                                                                                            @if( $estudio->formatoHddisc ) 
                                                                                            @if( $estudio->formatoHddisc->padecimiento->taquicardia == '1' )
                                                                                            style="background-color:#FF8000; width: 5%"
                                                                                            @else
                                                                                            style="width: 5%"
                                                                                            @endif 
                                                                            ...
                                                                            <table class="tabla-componente">
                                                                                <tbody>
                                                                                    <tr>
                                                                                        ...
                                                                                        <td
                                                                                            @if( $estudio->formatoHddisc ) 
                                                                                            @if( $estudio->formatoHddisc->padecimiento->tratamiento_medico == '1' )
                                                                                            style="background-color:#FF8000; width: 5%"
                                                                                            @else
                                                                                            style="width: 5%"
                                                                                            @endif 
                                                                                        ...
                                                                                        <td class="letra-componente alinear-centro" style="width: 40%">
                                                                                            ...
                                                                                            @if( $estudio->formatoHddisc->padecimiento->tratamiento_medico == '1' )
                                                                                                ...
                                                                                                {{ $estudio->formatoHddisc->padecimiento->tratamiento_medico_desc }}
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td
                                                                                            @if( $estudio->formatoHddisc ) 
                                                                                            @if( $estudio->formatoHddisc->padecimiento->medicamento_controlado == '1' )
                                                                                            style="background-color:#FF8000; width: 5%"
                                                                                            @else
                                                                                            style="width: 5%"
                                                                                            @endif 
                                                                                        ...
                                                                                        <td class="letra-componente alinear-centro" style="width: 40%">
                                                                                            ...
                                                                                            @if( $estudio->formatoHddisc->padecimiento->medicamento_controlado == '1' )
                                                                                                ...
                                                                                                {{ $estudio->formatoHddisc->padecimiento->medicamento_controlado_desc }}
                                                    ...
                                                    <tr>
                                                        <td class="table-border">
                                                            <table class="tabla-componente">
                                                                ...
                                                                <tbody>
                                                                    @if( $estudio->formatoHddisc )
                                                                    @foreach( $estudio->formatoHddisc->padecimiento_familiar as $familiar )
                                                                    <tr>
                                            ...
                                            <table class="auto-width">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td 
                                                            @if( $estudio->formatoHddisc ) 
                                                            @if( $estudio->formatoHddisc->atencion_medica->atencion_medica == '1' )
                                                            style="background-color:#FF8000; width: 10%"
                                                            @else
                                                            style="width: 10%"
                                                            @endif
                                                        ...
                                                        <td
                                                            @if( $estudio->formatoHddisc ) 
                                                            @if( $estudio->formatoHddisc->atencion_medica->atencion_medica == '2' )
                                                            style="background-color:#FF8000; width: 10%"
                                                            @else
                                                            style="width: 10%"
                                                            @endif 
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="4" class="letra-componente alinear-izquierda" style="width: 59%">
                                                            ...
                                                            @if( $estudio->formatoHddisc->atencion_medica->atencion_medica == '1' )
                                                                ...
                                                                {{ $estudio->formatoHddisc->atencion_medica->padecimiento }}
                                            ...
                                            <table class="tabla-componente">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="letra-componente alinear-izquierda" style="width: 20%">
                                                            <p>
                                                                {{  isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->atencion_medica->accidente_llamar : ' '}}
                                                            </p>
                                                        </td>
                                                        ...
                                                        <td class="letra-componente alinear-izquierda" style="width: 20%">
                                                            <p>
                                                                {{  isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->atencion_medica->telefono : ' '}}
                                                            </p>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                                    ...
                                                    <tr>
                                                        <td colspan="2" class="table-border">
                                                            <table class="tabla-componente">
                                                                ...
                                                                <tbody>
                                                                    @if( $estudio->formatoHddisc )
                                                                    @foreach( $estudio->formatoHddisc->habitos_detalle as $row )
                                                                    <tr>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="8" class="letra-componente alinear-izquierda table-border" style="width: 70%;">
                                                            <p class="border-footer">
                                                                {{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->habitos->cuales : '' }}
                                                            </p>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td colspan="3" class="letra-componente alinear-izquierda" style="width: 70%">
                                                                            <p>
                                                                                {{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->disponibilidad->empleado_actualmente : '' }}
                                                                            </p>                                                                            
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td colspan="3" class="letra-componente alinear-izquierda" style="width: 70%">
                                                                            <p>
                                                                                @if( $estudio->formatoHddisc )
                                                                                    @if( $estudio->formatoHddisc->disponibilidad->dispuesto_viajar == '1' )
                                                                                        Si
                                                                                    @else
                                                                                        No
                                                                                    @endif
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td colspan="3" class="letra-componente alinear-izquierda" style="width:70%"> 
                                                                            <p>
                                                                                @if( $estudio->formatoHddisc )
                                                                                    @if( $estudio->formatoHddisc->disponibilidad->cambiar_residencia == '1' )
                                                                                        Si
                                                                                    @else
                                                                                        No
                                                                                    @endif
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td colspan="3" class="letra-componente alinear-izquierda" style="width: 70%">
                                                                            <p>
                                                                                {{ isset( $estudio->formatoHddisc->disponibilidad) ? $estudio->formatoHddisc->disponibilidad->comenzar_trabajar: '' }}
                                                                            </p>                                                                            
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td class="letra-componente alinear-izquierda" style="width: 20%">
                                                                            <p>
                                                                                @if( $estudio->formatoHddisc )
                                                                                @if( $estudio->formatoHddisc->familiar_empresa == '1' )
                                                                                <div style="background-color:#FF8000; width: 100%; height: 100%; margin: 0; padding: 0; ">&nbsp;</div>
                                                                                @endif
                                                                                NO
                                                                                @endif
                                                                        ...
                                                                        <td class="letra-componente alinear-izquierda" style="width: 40%">
                                                                            <p>
                                                                                @if( $estudio->formatoHddisc )
                                                                                @if( $estudio->formatoHddisc->familiar_empresa == '1' )
                                                                                {{ $estudio->formatoHddisc->familiar_empresa_detalle }}
                                                                                @else
                                                                                N/A
                                                                                @endif
                                                                                @endif
                                                ...
                                                <td colspan="3" class="table-border">
                                                    <table class="tabla-componente">
                                                        <tbody>
                                                            ...
                                                            @if( $estudio->formatoHddisc )
                                                            @foreach ($estudio->formatoHddisc->referencias_personales  as $index => $referencia)
                                                            <tr>
                                                                <td colspan="3" class="table-border">
                                                                    &nbsp;
                                                                </td>
                                    ...
                                    @if( $estudio->formatoHddisc )
                                    @foreach ($estudio->formatoHddisc->informacion_laboral  as $referencia)
                                    <tr>
                                        <td colspan="3" class="table-border">
                                            &nbsp;
                                        </td>
                                                    ...
                                                    <td  colspan="3" >
                                                        <table class="tabla-componente">
                                                            <tbody>
                                                                <tr>
                                                                    <td class="table-border">
                                                                        <p class="alinear-izquierda label">
