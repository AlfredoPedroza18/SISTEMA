...
<div class="content">
	<ol class="breadcrumb ">
        <li><a href="javascript:;">Nuevo / Solicitar Servicio</a></li>
		...
		<h1 class="page-header text-center">Crear Servicio</h1>
                <!-- <div class="row">
				...
				<div class="panel panel-inverse" data-sortable-id="ui-widget-14">
						<div class="panel-heading">
							<div class="panel-heading-btn">
								...
								<h4 class="panel-title">Crear Servicio</h4>
                            ...
                            <div class="col-md-4 col-sm-6 animacion-modulos">
                                <div class="widget widget-stats bg-purple">
                                    <div class="stats-icon stats-icon-lg"><i class="fa fa-1x fa-book"></i></div>
                                        <div class="stats-title" id="plantillac" name="plantillac">{{ $p->Plantilla }}</div>
                                            <br><br>
                                            <div class="row">
                                            <div class="stats-link col-md-12">
                                                <a class="stats-link col-md-6" href="#">Ver Plantilla <i class="fa fa-arrow-circle-o-left"></i></a>
                                                <a class="stats-link col-md-15"href="#">Seleccionar <i class="fa fa-arrow-circle-o-right"></i></a>
                                            </div>
                                            </div>
