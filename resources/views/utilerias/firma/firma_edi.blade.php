            ...
            <div class="panel panel-inverse" data-sortable-id="ui-widget-14" data-init="true">
                ...
                <div class="panel-body">
                    ...
                    <div class="row" align=right>
                        ...
                        <div class="col-md-12 ">
                            <input type="button" value="Guardar Plantilla" class="btn btn-success" onclick="editarPlantilla()">
                        </div>
...
<script>
    ...
    function editarPlantilla() {
        swal({
                title: "¿Estás seguro?",
                text: "Estás por actualizar una plantilla.",
                type: "warning",
    ...
    function editarPlantillas() {
        ...
        $.ajax({
            ...
            success: function(response) {
                    ...
                    swal({
                        title: "<h3>¡Plantilla actualizada exitosamente!</h3> ",
                        html: true,
                        type: "success",
