    ...
    <nav class="navbar fixed-top navbar-expand-lg navbar-light white scrolling-navbar">
      <div class="container">
        ...
        <a class="navbar-brand waves-effect" href="{{ url('login') }}" >
          <strong data-aos="fade-down" data-aos-duration="3000" class="nav-link waves-effect"><img src="assets/acceso/img/nube.png" width="90"> SIG-ERP BIENVENIDO </strong>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
              <a data-aos="fade-down" data-aos-duration="3000" class="nav-link waves-effect" href="#" target="_blank"></a>
            </li>
            <li class="nav-item">
...
<div class="jumbotron text-center hoverable p-4">
  ...
  <div class="row">
    ...
    <div data-aos="fade-right"  data-aos-duration="1300" class="view overlay">
      <img src="assets/acceso/img/foto-tipo/proveedor.png" class="img-fluid" style="width: 100%;
    ...
    {{ csrf_field() }}
  <h5 class="card-header secondary-color-dark white-text text-center py-4">
  ...
  <img src="assets/acceso/img/logos/proveedor.png" class="rounded-circle" width="110" alt="woman avatar">
  </div>
  <br>
...
<div class="md-form">
  ...
  <!-- Sign in button -->
  <button class="btn btn-warning btn-block my-4" type="submit">Iniciar Sesion <i class="fa fa-sign-in ml-2"></i></button>
  ...
  <a href="https://www.facebook.com/GenTOutsourcing/?ref=hl" class="nav-link waves-effect" target="_blank">
