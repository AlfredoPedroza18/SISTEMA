            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group block1">
                            ...
                            {!! Form::select('Genero', ['1'=>'Masculino','2'=>'Femenino'], null, ['class'=>'form-control', 'id'=>'Genero', 'required'=>'required']) !!}
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            {!! Form::label('FechaN', 'Fecha de nacimiento:') !!}
                            {!! Form::date('FechaN', null, ['class'=>'form-control', 'id'=>'FechaN', 'required'=>'required']) !!}
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group block1">
                            {!! Form::label('Curp', 'CURP:') !!}
                            {!! Form::text('Curp', null, ['class'=>'form-control', 'id'=>'Curp', 'required'=>'required', 'placeholder'=>'CURP', 'maxlength'=>'18']) !!}<br/>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group block1">
                            ...
                            {!! Form::text('Nickname', $IdCliente, ['class'=>'form-control', 'id'=>'Nickname', 'required'=>'required', 'readonly']) !!}<br/>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            {!! Form::text('Mensaje', null, ['class'=>'form-control', 'id'=>'Mensaje', 'required'=>'required']) !!}<br/>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group block1">
                            {!! Form::label('Cliente', 'Cliente:') !!}<br/>
                            {!! Form::label('Cliente', $IdCliente, ['class'=>'form-control', 'id'=>'Cliente', 'required'=>'required']) !!}<br/>
                        </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-md-3 col-md-offset-8 text-right">
                        {!! Form::submit('Guardar y Enviar Correo', ['class'=>'btn btn-success btn-block']) !!}
                    </div>
                </div>
                {!! Html::style('assets/css/empleado/empleadocss.css') !!}
                {!! Html::script('assets/js/empleado/empleadojs.js') !!}
                {!! Form::close() !!}
            </div>
        </div>
    </div>
