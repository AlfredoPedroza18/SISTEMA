		...
		<div class="col-md-12 ui-sortable">
			<div class="panel panel-inverse" data-sortable-id="ui-widget-1">
		        <div class="panel-heading">
		            ...
		            <h4 class="panel-title text-center">Listado de Permisos Nomina</h4>
		        </div>
		            	...
		            	<div class="col-md-12 col-sm-12 col-xs-12">
                          ...
                          <th>Acción</th>
                            ...
                            <td class="text-center">
				            					<a href="{{ action('Administrador\PermisosNomController@edit',['id'=>$rol->id]) }}" class="btn btn-primary btn-icon btn-circle btn-sm btn-editar-registro-responsivo" data-toggle="tooltip" data-placement="bottom" title="Editar Usuario"><i class="fa fa-pencil"></i></a>&nbsp&nbsp
				            				</td>
