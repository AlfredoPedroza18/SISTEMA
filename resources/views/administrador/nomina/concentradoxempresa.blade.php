    ...
    <div class="content">
        ...
        <div class="panel panel-inverse" data-sortable-id="ui-widget-14">
            ...
            <div class="panel-body">
                    ...
                    <div class="col-md-12">
                            {{-- Form********************--}}
                            @if (Request::path() == 'ConcentradoxEmpresaC')
                            <a href="{{ url('Concentrado-Cliente') }}" class="btn btn-danger btn-xs">Regresar</a>
                            @else
                            <a href="{{  url('Concentrado') }}" class="btn btn-danger btn-xs">Regresar</a>
                            @endif
