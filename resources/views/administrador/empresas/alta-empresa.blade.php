...
<!-- ================== BEGIN PAGE LEVEL JS ================== --> 
    ...
    <script type="text/javascript">
      document.getElementById('FormaJuridica').onchange = function() {
        localStorage.setItem('selectedtem', document.getElementById('FormaJuridica').value);
      };

      if (localStorage.getItem('selectedtem')) {
        document.getElementById('FormaJuridica').options[localStorage.getItem('selectedtem')].selected = true;
        ...
        if(valor==2){
          ...
          $('#fecha_inicio_operaciones').val('');
          $('#fecha_registro_mercantil').val('');
          $('#clase_pm').val('');
