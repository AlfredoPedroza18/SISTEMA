...
<ol class="breadcrumb">
    <li><a href="{{route('catalogo_fondo')}}">Catálogo de Fondo Encuesta</a></li>
        <li class="active">
            Alta-Catálogo_de_Fondo_Encuesta
        </li>
    </li>
</ol>

<h1 class="page-header text-center">Catálogo de Fondo Encuesta <small>Alta</small></h1>

<div class="panel panel-inverse" data-sortable-id="ui-widget-14">
    <div class="panel-heading">
        <h4 class="panel-title">Catálogo de Fondo Encuesta <small>Alta</small></h4>
    </div>
        
    <div class="panel-body">
            <form id="form-alta-tiposservicio" action="{{route('store_imagen_fondo')}}" method="POST" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="jumbotron">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="note note-success">
                                ...
                                <h4>Imagen de Fondo Encuesta</h4>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-3 col-md-offset-8 text-left">
                            <input type="submit" name="Guardar" value="Guardar Política Cliente" class="btn btn-success btn-block">
                        </div>
                    </div>
                </div>
