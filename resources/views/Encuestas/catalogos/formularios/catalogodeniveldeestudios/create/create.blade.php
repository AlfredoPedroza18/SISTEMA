...
<ol class="breadcrumb">
    <li><a href="{{route('catalogo_nivel_estudios')}}">Catálogo de Nivel de Estudios</a></li>
        <li class="active">
            Alta de Nivel de Estudios
        </li>
    </li>
</ol>

<h1 class="page-header text-center">Catálogo de Nivel de Estudios <small>Alta</small></h1>

<div class="panel panel-inverse" data-sortable-id="ui-widget-14">
    <div class="panel-heading">
        <h4 class="panel-title">Catálogo de Nivel de Estudios <small>Alta</small></h4>
    </div>
        
    <div class="panel-body"> 
    <form id="form-alta-tiposservicio" action="{{route('store_nuevo_nivel_estudios_encuesta')}}" method="POST">
        {{ csrf_field() }}
        <div class="jumbotron">
            <div class="row">
                <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-6">
                    <label>{{ Form::label ('descripcion', '* Nivel de Estudio')}}</label>
