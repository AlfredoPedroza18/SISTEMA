...
<ol class="breadcrumb">
    <li><a href="{{route('catalogo_antiguedad_puesto')}}">Catálogo de Antigüedad de Puesto</a></li>
        <li class="active">
            Alta de Antigüedad de Puesto
        </li>
    </li>
</ol>

<h1 class="page-header text-center">Catálogo de Antigüedad de Puesto<small>Alta</small></h1>

<div class="panel panel-inverse" data-sortable-id="ui-widget-14">
    <div class="panel-heading">
        <h4 class="panel-title">Catálogo de Antigüedad de Puesto <small>Alta</small></h4>
    </div>
        
    <div class="panel-body"> 
    <form id="form-alta-tiposservicio" action="{{route('store_nueva_antiguedad_de_puesto')}}" method="POST">
        {{ csrf_field() }}
        <div class="jumbotron">
            <div class="row">
                <div class="col-md-12">
            ...
            <div class="row">
                ...
                <div class="row">
                    <div class="col-md-2 col-md-offset-9 text-left">
                        <input type="submit" name="Guardar" value="Guardar Antiguedades" class="btn btn-success btn-block">
                    </div>
                </div>
            </div>  
