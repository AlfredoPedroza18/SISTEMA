                ...
                <div class="jumbotron">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            {{ Form::text('Correo',$Correo,['class' => 'form-control','id'=>'Correo','placeholder'=>'','data-parsley-group'=>'wizard-step-1','required'=>'required'])}}
                        ...
                        <div class="form-group col-md-4">
                            ...
                            {{ Form::text('Telefono',$Telefono,['class' => 'form-control phone_with_ddd','id'=>'Telefono','placeholder'=>'','data-parsley-group'=>'wizard-step-1','required'=>'required'])}}
