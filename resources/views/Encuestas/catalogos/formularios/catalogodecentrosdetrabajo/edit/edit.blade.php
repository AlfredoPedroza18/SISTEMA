...
<ol class="breadcrumb">
    <li><a href="{{route('catalogo_centros_de_trabajo')}}">Catálogo de Centro de Trabajo</a></li>
        <li class="active">
            Edición-Catálogo_de_Centro_de_Trabajo 
        </li>
    </li>
</ol>

<h1 class="page-header text-center">Catálogo de Centros de Trabajo <small>Edición</small></h1>

<div class="panel panel-inverse" data-sortable-id="ui-widget-14">
    <div class="panel-heading">
        <h4 class="panel-title">Catálogo de Centros de Trabajo <small>Edición</small></h4>
    </div>
        
    <div class="panel-body">
            <form id="form-alta-tiposservicio" action="{{ route('centros_de_trabajo_update',['id'=>$IdCentro])}}" method="POST">
                {{ csrf_field() }}
                <div class="jumbotron">
                    <div class="row">
                        <div class="col-md-12">
