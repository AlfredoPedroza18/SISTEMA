...
<ol class="breadcrumb">
    <li><a href="{{route('catalogo_tipo_personal')}}">Catálogo de Tipo de Personal</a></li>
        <li class="active">
            Alta-Catálogo_de_Tipo_de_Personal
        </li>
    </li>
</ol>

<h1 class="page-header text-center">Catálogo de Tipo de Personal <small>Alta</small></h1>

<div class="panel panel-inverse" data-sortable-id="ui-widget-14">
    <div class="panel-heading">
        <h4 class="panel-title">Catálogo de Tipo de Personal <small>Alta</small></h4>
    </div>
        
    <div class="panel-body">
            <form id="form-alta-tiposservicio" action="{{route('store_tipo_de_personal')}}" method="POST">
                {{ csrf_field() }}
                <div class="jumbotron">
                    <div class="row">
                        <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <label>{{ Form::label ('descripcion', '* Tipo de Personal')}}</label>
                    ...
                    <div class="row">
                        <div class="col-md-3 col-md-offset-8 text-left">
                            <input type="submit" name="Guardar" value="Guardar Tipo de Personal" class="btn btn-success btn-block">
                        </div>
                    </div>
                </div>
