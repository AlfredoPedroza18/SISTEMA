...
<ol class="breadcrumb">
    <li><a href="{{route('catalogo_estados_civiles')}}">Catálogo de Estados Civiles</a></li>
        <li class="active">
            Alta-Catálogo_de_Estados_Civiles 
        </li>
    </li>
</ol>

<h1 class="page-header text-center">Catálogo de Estados Civiles <small>Alta</small></h1>

<div class="panel panel-inverse" data-sortable-id="ui-widget-14">
    <div class="panel-heading">
        <h4 class="panel-title">Catálogo de Estados Civiles <small>Alta</small></h4>
    </div>
        
    <div class="panel-body">
            <form id="form-alta-tiposservicio" action="{{route('store_estados_civiles')}}" method="POST">
                {{ csrf_field() }}
                <div class="jumbotron">
                    <div class="row">
                        <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-3 col-md-offset-8 text-left">
                            <input type="submit" name="Guardar" value="Guardar Estado Civil" class="btn btn-success btn-block">
                        </div>
                    </div>
                </div>
