...
<ol class="breadcrumb">
    <li><a href="{{route('catalogo_experiencia_laboral')}}">Catálogo de Experiencia Laboral</a></li>
        <li class="active">
            Alta-Catálogo_de_Experiencia_Laboral
        </li>
    </li>
</ol>

<h1 class="page-header text-center">Catálogo de Experiencia Laboral <small>Alta</small></h1>

<div class="panel panel-inverse" data-sortable-id="ui-widget-14">
    <div class="panel-heading">
        <h4 class="panel-title">Catálogo de Experiencia Laboral <small>Alta</small></h4>
    </div>
        
    <div class="panel-body">
            <form id="form-alta-tiposservicio" action="{{route('store_experiencia_laboral')}}" method="POST">
                {{ csrf_field() }}
                <div class="jumbotron">
                    <div class="row">
                        <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-3 col-md-offset-8 text-left">
                            <input type="submit" name="Guardar" value="Guardar Experiencia Laboral" class="btn btn-success btn-block">
                        </div>
                    </div>
                </div>
