...
<ol class="breadcrumb">
    <li><a href="{{route('catalogo_rango_edades')}}">Catálogo de Tipo de Rango de Edades</a></li>
        <li class="active">
            Edición de Rango de Edades
        </li>
    </li>
</ol>

<h1 class="page-header text-center">Catálogo de Rango de Edades <small>Edición</small></h1>

<div class="panel panel-inverse" data-sortable-id="ui-widget-14">
    <div class="panel-heading">
        <h4 class="panel-title">Catálogo de Rango de Edades <small>Edición</small></h4>
    </div>
        
    <div class="panel-body">
            <form id="form-alta-tiposservicio" action="{{ route('rango_de_edad_update',['id'=>$IdRango])}}" method="POST">
                {{ csrf_field() }}
                <div class="jumbotron">
                    <div class="row">
                        <div class="col-md-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <label>{{ Form::label ('Inicio', '* Edad Inicial')}}</label>
                            {{ Form::text('Inicio',$Inicio,['class' => 'form-control','id'=>'Inicio','placeholder'=>'','data-parsley-group'=>'wizard-step-1','required'=>'required'])}}
                        </div>

                        <div class="col-md-6">
                            <label>{{ Form::label ('Fin', '* Edad Final')}}</label>
                            {{ Form::text('Fin',$Fin,['class' => 'form-control','id'=>'Fin','placeholder'=>'','data-parsley-group'=>'wizard-step-1','required'=>'required'])}}
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-3 col-md-offset-8 text-left">
                            <input type="submit" name="Guardar" value="Guardar Rango de Edades" class="btn btn-success btn-block">
                        </div>
                    </div>
                </div>
