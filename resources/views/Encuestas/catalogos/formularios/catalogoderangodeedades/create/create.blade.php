...
<ol class="breadcrumb">
    <li><a href="{{route('catalogo_rango_edades')}}">Catálogo de Rango de edades</a></li>
        <li class="active">
            Alta de Rango de Edad
        </li>
    </li>
</ol>

<h1 class="page-header text-center">Catálogo de Rango de Edad <small>Alta</small></h1>

<div class="panel panel-inverse" data-sortable-id="ui-widget-14">
    <div class="panel-heading">
        <h4 class="panel-title">Catálogo de Tipo de Rango de Edad <small>Alta</small></h4>
    </div>
        
    <div class="panel-body"> 
    <form id="form-alta-tiposservicio" action="{{route('store_nuevo_rango_de_edad')}}" method="POST">
        {{ csrf_field() }}
        <div class="jumbotron">
            <div class="row">
                <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-6">
                 ...
                 <div class="col-md-6">
                    ...
                    {{ Form::number('inicio','',['class' => 'form-control','id'=>'inicio','placeholder'=>'','data-parsley-group'=>'wizard-step-1','required'=>'required','min' => 1])}}
                 </div>

                 <div class="col-md-6">
                    <label>{{ Form::label ('fin', '* Edad Final')}}</label>
                    {{ Form::number('fin','',['class' => 'form-control','id'=>'fin','placeholder'=>'','data-parsley-group'=>'wizard-step-1','required'=>'required','min' => 1])}}
                 </div>
