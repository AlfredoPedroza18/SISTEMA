...
<ol class="breadcrumb">
    <li><a href="{{route('catalogo_tipo_puesto')}}">Catálogo de Tipo de Puesto</a></li>
        <li class="active">
            Edición de Tipo de Puesto
        </li>
    </li>
</ol>

<h1 class="page-header text-center">Catálogo de Tipo de Puesto <small>Edición</small></h1>

<div class="panel panel-inverse" data-sortable-id="ui-widget-14">
    <div class="panel-heading">
        <h4 class="panel-title">Catálogo de Tipo de Puesto <small>Edición</small></h4>
    </div>
        
    <div class="panel-body">
            <form id="form-alta-tiposservicio" action="{{ route('tipo_puesto_update',['id'=>$IdTipoPuesto])}}" method="POST">
                {{ csrf_field() }}
                <div class="jumbotron">
                    <div class="row">
                        <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <label>{{ Form::label ('descripcion', '* Tipo de Puesto')}}</label>
                    ...
                    <div class="row">
                        <div class="col-md-3 col-md-offset-8 text-left">
                            <input type="submit" name="Guardar" value="Guardar Tipo de Puesto" class="btn btn-success btn-block">
                        </div>
                    </div>
                </div>
