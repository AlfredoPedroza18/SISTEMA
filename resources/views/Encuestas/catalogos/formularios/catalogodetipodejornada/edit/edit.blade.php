...
<ol class="breadcrumb">
    <li><a href="{{route('catalogo_tipo_jornada')}}">Catálogo de Tipo de Jornada</a></li>
        <li class="active">
            Edición-Tipo_de_Jornada
        </li>
    </li>
</ol>

<h1 class="page-header text-center">Catálogo de Tipo de Jornada <small>Edición</small></h1>

<div class="panel panel-inverse" data-sortable-id="ui-widget-14">
    <div class="panel-heading">
        <h4 class="panel-title">Catálogo de Tipo de Jornada <small>Edición</small></h4>
    </div>
        
    <div class="panel-body">
            <form id="form-alta-tiposservicio" action="{{ route('tipo_de_jornada_update',['id'=>$IdTipoJornada])}}" method="POST">
                {{ csrf_field() }}
                <div class="jumbotron">
                    <div class="row">
                        <div class="col-md-12">
