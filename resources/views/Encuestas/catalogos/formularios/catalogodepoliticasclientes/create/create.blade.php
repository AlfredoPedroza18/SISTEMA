...
<ol class="breadcrumb">
    <li><a href="{{route('catalogo_politicas_clientes')}}">Catálogo de Políticas Clientes</a></li>
        <li class="active">
            Alta-Catálogo_de_Políticas_Clientes
        </li>
    </li>
</ol>

<h1 class="page-header text-center">Catálogo de Políticas Clientes <small>Alta</small></h1>

<div class="panel panel-inverse" data-sortable-id="ui-widget-14">
    <div class="panel-heading">
        <h4 class="panel-title">Catálogo de Políticas Clientes <small>Alta</small></h4>
    </div>
        
    <div class="panel-body">
            <form id="form-alta-tiposservicio" action="{{route('store_politicas_clientes')}}" method="POST" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="jumbotron">
                    <div class="row">
                        <div class="col-md-12">
