...
<ol class="breadcrumb">
    <li><a href="{{route('catalogo_quejas')}}">Catálogo de Tipo de Queja</a></li>
        <li class="active">
            Edición-Tipo_de_Queja
        </li>
    </li>
</ol>

<h1 class="page-header text-center">Catálogo de Tipo de Queja <small>Edición</small></h1>

<div class="panel panel-inverse" data-sortable-id="ui-widget-14">
    <div class="panel-heading">
        <h4 class="panel-title">Catálogo de Tipo de Queja <small>Edición</small></h4>
    </div>
        
    <div class="panel-body">
            <form id="form-alta-tiposservicio" action="{{ route('tipo_de_queja_update',['id'=>$IdTipoQueja])}}" method="POST">
                {{ csrf_field() }}
                <div class="jumbotron">
                    <div class="row">
                        <div class="col-md-12">
