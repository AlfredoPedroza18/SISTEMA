...
<ol class="breadcrumb">
    <li><a href="{{ route('sugerencias',['id'=>$IdServicio]) }}">Sugerencias</a></li>
        <li class="active">
            Edición-Estatus
        </li>
    </li>
...
<h1 class="page-header text-center">Estatus <small>Edición</small></h1>

<div class="panel panel-inverse" data-sortable-id="ui-widget-14">
    <div class="panel-heading">
        <h4 class="panel-title">Estatus <small>Edición</small></h4>
    </div>
        
    <div class="panel-body">
            <form id="form-alta-tiposservicio" action="{{ route('tipo_de_estatus_update',['id'=>$IdSugerencia]) }}" method="POST">
                {{ csrf_field() }}
                <input type="hidden" value="{{$IdServicio}}" name="servicio">
                <div class="jumbotron">
                    <div class="row">
                        <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <label>{{ Form::label ('estatus', '* Estatus')}}</label>

                            {{ Form::text('estatus',$Estatus,['class' => 'form-control','id'=>'estatus','placeholder'=>'','data-parsley-group'=>'wizard-step-1','required'=>'required'])}}
                        </div>
                    </div>

                    <div class="row">
                        <div class="col-md-6">
                            <label>{{ Form::label('Informacion', '* Comentario') }}</label>

                            <textarea class="form-control" name="Informacion" id="Informacion" rows="6" cols="80">{{$comentario}}</textarea>
                        </div>
                    </div>
