...
<ol class="breadcrumb">
    <li><a href="{{route('configuracion_fecha_encuesta')}}">Fecha_Encuesta</a></li>
        <li class="active">
            Edición-Fecha_Encuesta
        </li>
    </li>
</ol>

<h1 class="page-header text-center">Fecha Encuesta<small>Edición</small></h1>

<div class="panel panel-inverse" data-sortable-id="ui-widget-14">
    <div class="panel-heading">
        <h4 class="panel-title">Fecha Encuesta<small>Edición</small></h4>
    </div>
        
    <div class="panel-body">
            <form id="form-alta-tiposservicio" action="{{route('fecha_encuesta_update',['id'=>$IdFechaEncuesta])}}"method="POST">
                {{ csrf_field() }}
                <div class="jumbotron">
                    <div class="row">
                        <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <input type="hidden" id="descripcion" name="descripcion" value="{{$IdEncuesta}}">
                            <label>Encuesta: {{$Descripcion}}</label>
                            <br>
                            <br>
                        </div>
                        <div class="col-md-6">
                            ...
                            {{ Form::date('fecha',$Fecha,['class' => 'form-control','id'=>'descripcion','placeholder'=>'','data-parsley-group'=>'wizard-step-1','required'=>'required'])}}
                        </div>
                    </div>
