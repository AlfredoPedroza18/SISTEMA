...
<ol class="breadcrumb">
    <li><a href="{{route('configuracion_dimension_pregunta')}}">Dimensiones Preguntas</a></li>
        <li class="active">
            Alta Nueva Dimensión Pregunta
        </li>
    </li>
</ol>

<h1 class="page-header text-center">Dimensión Pregunta <small>Alta</small></h1>

<div class="panel panel-inverse" data-sortable-id="ui-widget-14">
    <div class="panel-heading">
        <h4 class="panel-title">Dimensión Pregunta <small>Alta</small></h4>
    </div>
        
    <div class="panel-body">
            <form id="form-alta-tiposservicio" action="{{route('store_dimension_pregunta')}}" method="POST">
                {{ csrf_field() }}
                <div class="jumbotron">
                    <div class="row">
                        <div class="col-md-12">
