...
<ol class="breadcrumb">
    <li><a href="{{route('configuracion_grupo_de_respuestas')}}">Configuración-Grupo_de_Respuestas</a></li>
        <li class="active">
            Edición-Grupo_de_Respuestas
        </li>
    </li>
</ol>

<h1 class="page-header text-center">Grupo de Respuestas<small>Edición</small></h1>

<div class="panel panel-inverse" data-sortable-id="ui-widget-14">
    <div class="panel-heading">
        <h4 class="panel-title">Grupo de Respuestas<small>Edición</small></h4>
    </div>
        
    <div class="panel-body">
            <form id="form-alta-tiposservicio" action="{{ route('grupo_de_respuestas_update',['id'=>$IdGrupoRespuesta])}}" method="POST">
                {{ csrf_field() }}
                <div class="jumbotron">
                    <div class="row">
                        <div class="col-md-12">
