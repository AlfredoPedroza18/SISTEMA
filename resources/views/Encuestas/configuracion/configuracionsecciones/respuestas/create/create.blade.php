...
<ol class="breadcrumb">
    <li><a href="{{route('configuracion_respuestas')}}">Configuración-Respuestas</a></li>
        <li class="active">
            Alta-Respuestas
        </li>
    </li>
...
<h1 class="page-header text-center">Respuestas<small>Alta</small></h1>

<div class="panel panel-inverse" data-sortable-id="ui-widget-14">
    <div class="panel-heading">
        <h4 class="panel-title">Respuestas<small>Alta</small></h4>
    </div>
        
    <div class="panel-body">
            <form id="form-alta-tiposservicio" action="{{route('store_respuestas')}}" method="POST">
                {{ csrf_field() }}
                <div class="jumbotron">
                    <div class="row">
                        <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <label>{{ Form::label ('descripcion', '* Respuestas')}}</label>
                    ...
                    <div class="row">
                        <div class="col-md-3 col-md-offset-8 text-left">
                            <input type="submit" name="Guardar" value="Guardar Respuestas" class="btn btn-success btn-block">
                        </div>
                    </div>
                </div>
