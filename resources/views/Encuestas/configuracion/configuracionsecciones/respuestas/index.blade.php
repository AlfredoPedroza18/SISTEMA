...
<div class="row">
    <div class="col-md-12 text-right">
        <a href="{{ route('respuestas_create')}}" class="btn btn-inverse btn-icon btn-circle btn-lg" data-toggle="tooltip" data-placement="top" title="" data-original-title="Alta de modalidad"> <i class="fa fa-user-plus fa-1x"aria-hidden="true"></i></a>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="text-center">
                <a href="{{ route('respuestas_edit',['id'=>$r->IdRespuesta])}}" class="btn btn-primary btn-icon btn-circle btn-sm btn-editar-registro" data-toggle="tooltip" data-placement="top" title="Editar Registro"><i class="fa fa-pencil"></i></a>&nbsp&nbsp 
                
                <input type="hidden" value="" data-id="">
                
                {{ Form::open([ 'route' => ['respuestas_destroy',
                    $r->IdRespuesta],
                    'method' => 'DELETE',
                    'class'  => 'pull-right'
                    ]) }}
