...
<ol class="breadcrumb">
    <li><a href="{{route('configuracion_correos')}}">Configuración-Correos</a></li>
        <li class="active">
            Edición-Correos
        </li>
    </li>
...
<h1 class="page-header text-center">Correos<small>Edición</small></h1>

<div class="panel panel-inverse" data-sortable-id="ui-widget-14">
    <div class="panel-heading">
        <h4 class="panel-title">Correos<small>Edición</small></h4>
    </div>
        
    <div class="panel-body">
            <form id="form-alta-tiposservicio" action="{{ route('correos_update',['id'=>$IdMail])}}" method="POST">
                {{ csrf_field() }}
                <div class="jumbotron">
                    <div class="row">
                        <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <label>{{ Form::label ('descripcion', '* Correo')}}</label>
                            <textarea class="form-control" name="descripcion" id="descripcion" cols="30" rows="10" required>{{$Descripcion}}</textarea>
