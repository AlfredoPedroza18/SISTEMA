...
<ol class="breadcrumb">
    <li><a href="{{route('configuracion_dimension')}}">Dimensiones</a></li>
        <li class="active">
            Alta Nueva Dimensión
        </li>
    </li>
</ol>

<h1 class="page-header text-center">Dimensiones <small>Alta</small></h1>

<div class="panel panel-inverse" data-sortable-id="ui-widget-14">
    <div class="panel-heading">
        <h4 class="panel-title">Dimensión <small>Alta</small></h4>
    </div>
        
    <div class="panel-body">
            <form id="form-alta-tiposservicio" action="{{route('store_dimension')}}" method="POST">
                {{ csrf_field() }}
                <div class="jumbotron">
                    <div class="row">
                        <div class="col-md-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <label>{{ Form::label ('dominio', '* Dominio')}}</label>
                            <select class="form-control" name="dominio" id="dominio" required>
                                <option value="">Seleccione un Dominio</option>
                                @foreach($listaDominio as $lista)
                                <option value="{{$lista->IdDominio}}">{{$lista->Descripcion}}</option>
                                @endforeach
                            </select>
                            <br>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-3 col-md-offset-8 text-left">
                            <input type="submit" name="Guardar" value="Guardar Dimensión" class="btn btn-success btn-block">
                        </div>
                    </div>
                </div>
