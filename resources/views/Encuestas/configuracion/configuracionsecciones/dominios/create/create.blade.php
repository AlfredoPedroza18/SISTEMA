...
<ol class="breadcrumb">
    <li><a href="{{route('configuracion_dominios')}}">Configuración Dominios</a></li>
        <li class="active">
            Alta Nuevo Dominio
        </li>
    </li>
...
<h1 class="page-header text-center">Configuración Dominios <small>Alta</small></h1>

<div class="panel panel-inverse" data-sortable-id="ui-widget-14">
    <div class="panel-heading">
        <h4 class="panel-title">Configuración Dominios <small>Alta</small></h4>
    </div>
        
    <div class="panel-body">
            <form id="form-alta-tiposservicio" action="{{route('store_configuracion_nuevo_dominio')}}" method="POST">
                {{ csrf_field() }}
                <div class="jumbotron">
                    <div class="row">
                        <div class="col-md-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <label>{{ Form::label ('categoria', '* Categoria')}}</label>
                            <select class="form-control" name="categoria" id="categoria" required>
                                <option value="">Seleccione una categoria</option>
                                @foreach($listaCategorias as $lista)
                                <option value="{{$lista->IdCategoria}}">{{$lista->Descripcion}}</option>
                                @endforeach
                            </select>
                            <br>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-3 col-md-offset-8 text-left">
                            <input type="submit" name="Guardar" value="Guardar Dominio" class="btn btn-success btn-block">
                        </div>
                    </div>
                </div>
