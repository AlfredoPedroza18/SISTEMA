...
<ol class="breadcrumb">
    <li><a href="{{route('configuracion_dominios')}}">Dominios</a></li>
        <li class="active">
            Dominio
        </li>
    </li>
...
<h1 class="page-header text-center">Dominio <small>Edición</small></h1>

<div class="panel panel-inverse" data-sortable-id="ui-widget-14">
    <div class="panel-heading">
        <h4 class="panel-title">Dominio <small>Edición</small></h4>
    </div>
        
    <div class="panel-body">
            <form id="form-alta-tiposservicio" action="{{ route('dominio_configuracion_update',['id'=>$IdDominio])}}" method="POST">
                {{ csrf_field() }}
                <div class="jumbotron">
                    <div class="row">
                        <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <input type="hidden" id="cntC" name="cntC" value="{{$IdDominio}}">
                            <label>Categoría: {{$descripcionCategoria}}</label>
                            <br><br><br>
