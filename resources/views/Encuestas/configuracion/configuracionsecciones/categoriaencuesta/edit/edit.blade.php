...
<ol class="breadcrumb">
    <li><a href="{{route('configuracion_categoria_encuesta')}}">Categoría_Encuesta</a></li>
        <li class="active">
            Edición-Categoría_Encuesta
        </li>
    </li>
</ol>

<h1 class="page-header text-center">Categoría Encuesta<small>Edición</small></h1>

<div class="panel panel-inverse" data-sortable-id="ui-widget-14">
    <div class="panel-heading">
        <h4 class="panel-title">Categoría Encuesta<small>Edición</small></h4>
    </div>
        
    <div class="panel-body">
            <form id="form-alta-tiposservicio" action="{{route('categoria_encuesta_update',['id'=>$IdCategoria])}}" method="POST">
                {{ csrf_field() }}
                <div class="jumbotron">
                    <div class="row">
                        <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <input type="hidden" id="agrupador" name="agrupador" value="{{$IdAgrupador}}">
                            <label>Grupo de Encuesta: {{$Agrupador}}</label>
                            <br>
                            <br>
                        </div>
                        <div class="col-md-6">
