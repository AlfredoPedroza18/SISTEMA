...
{!! Html::script('assets/plugins/bootstrap/js/bootstrap.min.js') !!}
  ...
  {!! Html::script('assets/plugins/DataTables/media/js/jquery.dataTables.js')!!}
    ...
    {!! Html::script('assets/plugins/DataTables/extensions/Buttons/js/vfs_fonts.js') !!}
    ...
    {!! Html::script('assets/js/chosen/chosen.jquery.min.js') !!}
    {!! Html::script('assets/js/chosen/init.js') !!}
    {!! Html::script('assets/js/chosen/prism.js') !!}
