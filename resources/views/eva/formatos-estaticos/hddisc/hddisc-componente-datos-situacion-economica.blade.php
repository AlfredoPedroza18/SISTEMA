    ...
    <div class="panel-body">
        <div class="form-horizontal">
                ...
                <div class="col-md-2">
                    <table class="table table-striped">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <input  type="hidden" class="form-control" name="situacion_economica[id]" value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->id : '0' }}">
                                    <input type="text" class="form-control" name="situacion_economica[aportacion1]" 
                                    value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->aportacion1 : '' }}">
                                
                            </td>                                
                            </tr>
                            <tr>
                                <td><input type="text" class="form-control" name="situacion_economica[aportacion2]" 
                                    value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->aportacion2 : '' }}">
                                </td>                                
                            </tr>
                            <tr>
                                <td><input type="text" class="form-control" name="situacion_economica[aportacion3]" 
                                    value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->aportacion3 : '' }}">
                                </td>                                
                            </tr>
                            <tr>
                                <td><input type="text" class="form-control" name="situacion_economica[aportacion4]" 
                                    value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->aportacion4 : '' }}">
                                </td>                                
                            </tr>
                            <tr>
                                <td><input type="text" class="form-control" name="situacion_economica[aportacion5]" 
                                    value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->aportacion5 : '' }}">
                                </td>                                
                            </tr>
                            <tr>
                                <td><input type="text" class="form-control" name="situacion_economica[aportacion6]" 
                                    value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->aportacion6 : '' }}">
                                </td>                                
                            </tr>
                            <tr>
                                <td><input type="text" class="form-control" name="situacion_economica[aportacion7]" 
                                    value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->aportacion7 : '' }}">
                                </td>                                
                            </tr>
                            <tr>
                                <td><input type="text" class="form-control" name="situacion_economica[aportacion8]" 
                                    value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->aportacion8 : '' }}">
                                </td>                                
                            </tr>
                            <tr>
                                <td><input type="text" class="form-control" name="situacion_economica[aportacion9]" 
                                    value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->aportacion9 : '' }}">
                                </td>                                
                            </tr>
                            <tr>
                                <td><input type="text" class="form-control" name="situacion_economica[aportacion10]" 
                                    value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->aportacion10 : '' }}">
                                </td>                                
                            </tr>
                            <tr>
                                <td><input type="text" class="form-control" name="situacion_economica[aportacion11]" 
                                    value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->aportacion11 : '' }}">
                                </td>                                
                            </tr>
                        </tbody>
                    </table>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input  type="number" class="form-control" name="situacion_economica[i_total]" id="monto_total_ingresos" readonly="readonly" 
                                            value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->i_total : '' }}">
                                </td>
                            </tr>
                        </tfoot>
                        <tbody>
                            <tr>
                                <td><input type="text" class="form-control" name="situacion_economica[i_concepto1]" 
                                    value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->i_concepto1 : '' }}"></td>
                                <td>
                                    <input  type="number" class="form-control monto_ingresos" name="situacion_economica[i_monto1]"
                                            value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->i_monto1 : '0.00' }}">
                                </td>
                            </tr>
                            <tr>
                                <td><input type="text" class="form-control" name="situacion_economica[i_concepto2]" 
                                    value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->i_concepto2 : '' }}"></td>
                                <td>
                                    <input  type="number" class="form-control monto_ingresos" name="situacion_economica[i_monto2]"
                                            value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->i_monto2 : '0.00' }}">
                                </td>
                            </tr>
                            <tr>
                                <td><input type="text" class="form-control" name="situacion_economica[i_concepto3]" 
                                    value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->i_concepto3 : '' }}"></td>
                                <td>
                                    <input  type="number" class="form-control monto_ingresos" name="situacion_economica[i_monto3]"
                                            value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->i_monto3 : '0.00' }}">
                                </td>
                            </tr>
                            <tr>
                                <td><input type="text" class="form-control" name="situacion_economica[i_concepto4]" 
                                    value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->i_concepto4 : '' }}"></td>
                                <td>
                                    <input  type="number" class="form-control monto_ingresos" name="situacion_economica[i_monto4]"
                                            value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->i_monto4 : '0.00' }}">
                                </td>
                            </tr>
                            <tr>
                                <td><input type="text" class="form-control" name="situacion_economica[i_concepto5]" 
                                    value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->i_concepto5 : '' }}"></td>
                                <td>
                                    <input  type="number" class="form-control monto_ingresos" name="situacion_economica[i_monto5]"
                                            value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->i_monto5 : '0.00' }}">
                                </td>
                            </tr>
                            <tr>
                                <td><input type="text" class="form-control" name="situacion_economica[i_concepto6]" 
                                    value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->i_concepto6 : '' }}"></td>
                                <td>
                                    <input  type="number" class="form-control monto_ingresos" name="situacion_economica[i_monto6]"
                                            value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->i_monto6 : '0.00' }}">
                                </td>
                            </tr>
                            <tr>
                                <td><input type="text" class="form-control" name="situacion_economica[i_concepto7]" 
                                    value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->i_concepto7 : '' }}"></td>
                                <td>
                                    <input  type="number" class="form-control monto_ingresos" name="situacion_economica[i_monto7]"
                                            value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->i_monto7 : '0.00' }}">
                                </td>
                            </tr>
                            <tr>
                                <td><input type="text" class="form-control" name="situacion_economica[i_concepto8]" 
                                    value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->i_concepto8 : '' }}"></td>
                                <td>
                                    <input  type="number" class="form-control monto_ingresos" name="situacion_economica[i_monto8]"
                                            value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->i_monto8 : '0.00' }}">
                                </td>
                            </tr>
                            <tr>
                                <td><input type="text" class="form-control" name="situacion_economica[i_concepto9]" 
                                    value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->i_concepto9 : '' }}"></td>
                                <td>
                                    <input  type="number" class="form-control monto_ingresos" name="situacion_economica[i_monto9]"
                                            value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->i_monto9 : '0.00' }}">
                                </td>
                            </tr>
                            <tr>
                                <td><input type="text" class="form-control" name="situacion_economica[i_concepto10]" 
                                    value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->i_concepto10 : '' }}"></td>
                                <td>
                                    <input  type="number" class="form-control monto_ingresos" name="situacion_economica[i_monto10]"
                                            value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->i_monto10 : '0.00' }}">
                                </td>
                            </tr>
                            <tr>
                                <td><input type="text" class="form-control" name="situacion_economica[i_concepto11]" 
                                    value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->i_concepto11 : '' }}"></td>
                                <td>
                                    <input  type="number" class="form-control monto_ingresos" name="situacion_economica[i_monto11]"
                                            value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->i_monto11 : '0.00' }}">
                                </td>
                            </tr>
                        </tbody>
                    </table>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input  type="number" 
                                            ...
                                            readonly="readonly" 
                                            value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->e_total : '' }}">
                                </td>
                            </tr>
                        </tfoot>
                    	<tbody>
                    		<tr>
                    			...
                    			<td>
                    				...
                    				<input  type="number" class="form-control monto_egresos" name="situacion_economica[e_monto1]"                                             
                                            value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->e_monto1 : '0.00' }}">
                    			</td>
                    		</tr>
                    		<tr>
                    			...
                    			<td>
                    				...
                    				<input  type="number" class="form-control monto_egresos" name="situacion_economica[e_monto2]"                                             
                                            value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->e_monto2 : '0.00' }}">
                    			</td>
                    		</tr>
                    		<tr>
                    			...
                    			<td>
                    				...
                    				<input  type="number" class="form-control monto_egresos" name="situacion_economica[e_monto3]"                                             
                                            value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->e_monto3 : '0.00' }}">
                    			</td>
                    		</tr>
                    		<tr>
                    			<td>Teléfono:</td>
                    			<td>
                    				...
                    				<input  type="number" class="form-control monto_egresos" name="situacion_economica[e_monto4]"                                             
                                            value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->e_monto4 : '0.00' }}">
                    			</td>
                    		</tr>
                    		<tr>
                    			...
                    			<td>
                    				...
                    				<input  type="number" class="form-control monto_egresos" name="situacion_economica[e_monto5]"                                             
                                            value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->e_monto5 : '0.00' }}">
                    			</td>
                    		</tr>
                    		<tr>
                    			<td>Predial:</td>
                    			<td>
                    				...
                    				<input  type="number" class="form-control monto_egresos" name="situacion_economica[e_monto6]"                                             
                                            value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->e_monto6 : '0.00' }}">
                    			</td>
                    		</tr>
                    		<tr>
                    			...
                    			<td>
                    				...
                    				<input  type="number" class="form-control monto_egresos tico]" name="situacion_economica[e_monto7]"
                                            value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->e_monto7 : '0.00' }}">
                    			</td>
                    		</tr>
                    		<tr>
                    			...
                    			<td>
                    				...
                    				<input  type="number" class="form-control monto_egresos" name="situacion_economica[e_monto8]"                                             
                                            value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->e_monto8 : '0.00' }}">
                    			</td>
                    		</tr>
                    		<tr>
                    			<td>Ropa calzado:</td>
                    			<td>
                    				...
                    				<input  type="number" class="form-control monto_egresos" name="situacion_economica[e_monto9]"                                             
                                            value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->e_monto9 : '0.00' }}">
                    			</td>
                    		</tr>
                    		<tr>
                    			<td>Diversiones:</td>
                    			<td>
                    				...
                    				<input  type="number" class="form-control monto_egresos" name="situacion_economica[e_monto10]"                                             
                                            value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->e_monto10 : '0.00' }}">
                    			</td>
                    		</tr>
                            <tr>
                                <td>Otros:</td>
                                <td>
                                    ...
                                    <input  type="number" class="form-control monto_egresos" name="situacion_economica[e_monto11]"                                             
                                            value="{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->e_monto11 : '0.00' }}">
                                </td>
                            </tr>
                    	</tbody>
                    </table>
            ...
            <div class="form-group">
                ...
                <div class="col-md-9">   
                    <textarea class="form-control" rows="3" name="situacion_economica[deficit]">{{ isset( $estudio->formatoHddisc ) ? $estudio->formatoHddisc->situacion_economica->deficit : '' }}</textarea>
                </div>                
            </div>                
