<div class="panel panel-primary" data-sortable-id="ui-widget-15">
    ...
    <div class="form-horizontal">
           ...
           <input type="hidden" name="ifamiliar[id]" value="{{ isset( $estudio->formatoGnp ) ? $estudio->formatoGnp->id : 0 }}">
                <div class="row">
                        <div class="col-md-4 text-right">¿Con quién habita actualmente?</div>
                        <div class="col-md-7">
                      <input  type="text" 
                                    class="form-control text-center" 
            value="{{ isset( $estudio->formatoGnp ) ?  $estudio->formatoGnp->infoFamiliar->con_quien_vive : '' }}" 
            ...
            <div class="form-group">
                <div class="row">
                      ...
                      <input  type="text" 
                                    class="form-control text-center" 
                                    value="{{ isset( $estudio->formatoGnp ) ?  $estudio->formatoGnp->infoFamiliar->relacion_familia : '' }}" 
            ...
            <div class="form-group">
                <div class="row">
                      ...
                      <input  type="text" 
                                    class="form-control text-center" 
                                    value="{{ isset( $estudio->formatoGnp ) ?  $estudio->formatoGnp->infoFamiliar->familiares_extrangero : '' }}" 
             ...
             <div class="form-group">
                <div class="row">
                      ...
                      <input  type="text" 
                                    class="form-control text-center" 
                                    value="{{ isset( $estudio->formatoGnp ) ?  $estudio->formatoGnp->infoFamiliar->familiares_interior_republica : '' }}" 
            ...
            <div class="form-group">
                <div class="row">
                      ...
                      <input  type="text" 
                                    class="form-control text-center" 
                                    value="{{ isset( $estudio->formatoGnp ) ?  $estudio->formatoGnp->infoFamiliar->frecuencia_visita : '' }}" 
             ...
             <div class="form-group">
                ...
                <div class="row">
                      ...
                      <input  type="text" 
                                    class="form-control text-center" 
                                    value="{{ isset( $estudio->formatoGnp ) ?  $estudio->formatoGnp->infoFamiliar->observaciones : '' }}" 
