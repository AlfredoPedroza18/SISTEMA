...
<div class="panel panel-primary" data-sortable-id="ui-widget-15">
    ...
    <div class="panel-body">
        ...
        @if( $estudio->formatoJll )
            ...
            @forelse ( $estudio->formatoJll->referenciasLaboralesCinco as $index => $referencia )
        ...
        <div class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <input type="hidden" name="otras_fuentes_ingresos[id]" value="{{ isset( $estudio->formatoJll->otroIngreso ) ? $estudio->formatoJll->otroIngreso->id : 0 }}">
                    <textarea class="form-control" rows="3" name="otras_fuentes_ingresos[descripcion]">{{ isset( $estudio->formatoJll->otroIngreso ) ? $estudio->formatoJll->otroIngreso->descripcion : '' }}</textarea>
                </div>
            </div>
        </div>
    </div>
