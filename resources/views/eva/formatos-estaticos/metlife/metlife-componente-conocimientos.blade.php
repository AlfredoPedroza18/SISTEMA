    ...
    <div class="panel-body">
        <div class="form-horizontal">
            ...
            @if($estudio->formatoMetlife)
                ...
                @foreach ($estudio->formatoMetlife->conocimientos_ as $indexconoci =>$conoci)
            ...
            @else                
                ...
                <div class="form-group">
    <input type="hidden" name="conocimientomet[0][id]" value="{{ isset( $estudio->formatoMetlife) ? $estudio->formatoMetlife->conocimientos_->id : 0 }}">
                    <div class="col-md-5 col-md-offset-2">
