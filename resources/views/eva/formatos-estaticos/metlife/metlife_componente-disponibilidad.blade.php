<div class="panel panel-primary" data-sortable-id="ui-widget-15">
    ...
    <div class="form-horizontal">
            ...
            <div class="form-group">
                <div class="col-md-9">
                    <input type="hidden" name="dispo[id]" value="{{ isset( $estudio->formatoMetlife ) ? $estudio->formatoMetlife->id : 0 }}">
              ...
              <div class="form-group">
                <div class="row">
                      ...
                      <div class="col-md-4 text-left">
                            <input  type="text" 
                            class="form-control" 
                            value="{{ isset( $estudio->formatoMetlife) ? $estudio->formatoMetlife->disponible->empleado_actualmente: '' }}" 
                 ...
                 <div class="row">
                      ...
                      <div class="col-md-4 text-left">
                            <input  type="text" 
                            class="form-control" 
                            value="{{ isset( $estudio->formatoMetlife) ? $estudio->formatoMetlife->disponible->disponible_viajar: '' }}" 
                ...
                <div class="row">
                      ...
                      <div class="col-md-4 text-left">
                            <input  type="text" 
                            class="form-control" 
                            value="{{ isset( $estudio->formatoMetlife) ? $estudio->formatoMetlife->disponible->cambiar_residencia: '' }}" 
                ...
                <div class="row">
                      ...
                      <div class="col-md-4 text-left">
                            <input  type="text" 
                            class="form-control" 
                            value="{{ isset( $estudio->formatoMetlife) ? $estudio->formatoMetlife->disponible->fecha_laboral: '' }}" 
