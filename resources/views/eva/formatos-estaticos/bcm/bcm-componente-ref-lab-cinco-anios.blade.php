...
<div class="panel panel-primary" data-sortable-id="ui-widget-15">
    ...
    <div class="panel-body">
        ...
        @if( $estudio->formatoBcm )
            ...
            @forelse ( $estudio->formatoBcm->referenciasLaboralesCinco as $index => $referencia )
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-3">
                        <input      type="number" 
                                    oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                                    maxlength="13" min="1" max="99999999999999999999"  
                                    class="form-control" name="referencias_lab_cinco[0][telefono]">
                    </div>
                </div>
                <div class="form-group alert alert-info" >
                    <label class="col-md-3 control-label"></label>
        ...
        <div class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <input type="hidden" name="otras_fuentes_ingresos[id]" value="{{ isset( $estudio->formatoBcm->otroIngreso ) ? $estudio->formatoBcm->otroIngreso->id : 0 }}">
                    <textarea class="form-control" rows="3" name="otras_fuentes_ingresos[descripcion]">{{ isset( $estudio->formatoBcm->otroIngreso ) ? $estudio->formatoBcm->otroIngreso->descripcion : '' }}</textarea>
                </div>
            </div>
        </div>
    </div>
