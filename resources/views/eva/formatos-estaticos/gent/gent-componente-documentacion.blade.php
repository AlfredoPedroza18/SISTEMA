    ...
    <div class="panel-body">
        <div class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-md-1">
                    <input type="hidden" name="documentacion[id]" value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->documentacion->id : 0 }}">
                    <input  type="text" class="form-control" name="documentacion[acta_no]" 
                            value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->documentacion->acta_no : '' }}">
                </div>
                <label class="col-md-1 control-label">Año</label>
                <div class="col-md-1">
                    <input  type="text" class="form-control" name="documentacion[acta_anio]" 
                            value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->documentacion->acta_anio : '' }}">
                </div>
                <label class="col-md-1 control-label">Libro</label>
                <div class="col-md-1">
                    <input  type="text" class="form-control" name="documentacion[acta_libro]" 
                            value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->documentacion->acta_libro : '' }}">
                </div>
                <label class="col-md-1 control-label">Oficialia</label>
                <div class="col-md-1">
                    <input  type="text" class="form-control" name="documentacion[acta_oficialia]" 
                            value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->documentacion->acta_oficialia : '' }}">
                </div>
                <div class="col-md-2">
                    <input  type="text" class="form-control" name="documentacion[acta_corroboro]" 
                            value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->documentacion->acta_corroboro : '' }}">
                </div>
            </div>
            <div class="form-group">                
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <input  type="text" class="form-control" name="documentacion[ine_clave_]" 
                                    value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->documentacion->ine_clave_ : '' }}">
                        </div>
                        <label class="col-md-1 control-label">Número</label>
                        <div class="col-md-5">
                            
                            <input  type="text" class="form-control" name="documentacion[ine_no]" 
                                    value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->documentacion->ine_no : '' }}">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-11">
                            ...
                            <input  type="text" class="form-control" name="documentacion[ine_direccion]" 
                                    value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->documentacion->ine_direccion : '' }}">
                        </div>
                    </div>                                        
                </div>
                <div class="col-md-2">
                    ...
                    <input  type="text" class="form-control" name="documentacion[ine__corroboro]" 
                            value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->documentacion->ine__corroboro : '' }}">
                </div>
            </div>
            ...
            <div class="form-group">                
                ...
                <div class="col-md-8">
                    <input  type="text" class="form-control" name="documentacion[curp]" 
                            value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->documentacion->curp : '' }}">
                </div>
                <div class="col-md-2">
                    <input  type="text" class="form-control" name="documentacion[curp_corroboro]" 
                            value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->documentacion->curp_corroboro : '' }}">
                </div>
            </div>
            <div class="form-group">                
                ...
                <div class="col-md-8">
                    <input  type="text" class="form-control" name="documentacion[rfc_no]" 
                            value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->documentacion->rfc_no : '' }}">
                </div>
                <div class="col-md-2">
                    <input  type="text" class="form-control" name="documentacion[rfc_corroboro]" 
                            value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->documentacion->rfc_corroboro : '' }}">
                </div>
            </div>
            <div class="form-group">                
                ...
                <div class="col-md-2">
                    <input  type="text" class="form-control" name="documentacion[afore_no]" 
                            value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->documentacion->afore_no : '' }}">
                </div>
                ...
                <div class="col-md-2">
                    <input  type="text" class="form-control" name="documentacion[afore_institucion]" 
                            value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->documentacion->afore_institucion : '' }}">
                </div>
                <div class="col-md-2">
                    <input  type="text" class="form-control" name="documentacion[afore_corroboro]" 
                            value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->documentacion->afore_corroboro : '' }}">
                </div>
            </div>
            <div class="form-group">                
                ...
                <div class="col-md-8">
                    <input  type="text" class="form-control" name="documentacion[nss_no]" 
                            value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->documentacion->nss_no : '' }}">
                </div>                
                <div class="col-md-2">
                    <input  type="text" class="form-control" name="documentacion[nss_corroboro]" 
                            value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->documentacion->nss_corroboro : '' }}">
                </div>
            </div>
            <div class="form-group">                
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-11">
                            ...
                            <input  type="text" class="form-control" name="documentacion[ce_institucion]" 
                                    value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->documentacion->ce_institucion : '' }}">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            ...
                            <input  type="text" class="form-control" name="documentacion[ce_documento]" 
                                    value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->documentacion->ce_documento : '' }}">
                        </div>
                        <label class="col-md-1 control-label">Folio</label>
                        <div class="col-md-5">
                            
                            <input  type="text" class="form-control" name="documentacion[ce_folio]" 
                                    value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->documentacion->ce_folio : '' }}">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-11">
                            ...
                            <input  type="text" class="form-control" name="documentacion[ce_grado]" 
                                    value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->documentacion->ce_grado : '' }}">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-11">
                            ...
                            <input  type="text" class="form-control" name="documentacion[ce_licenciatura]" 
                                    value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->documentacion->ce_licenciatura : '' }}">
                        </div>
                    </div>
                </div>
                <div class="col-md-2">
                    ...
                    <input  type="text" class="form-control" name="documentacion[ce_corroboro]" 
                            value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->documentacion->ce_corroboro : '' }}">
                </div>
            </div>
            <div class="form-group">                
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-11">
                            ...
                            <input  type="text" class="form-control" name="documentacion[cd_titular]" 
                                    value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->documentacion->cd_titular : '' }}">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-11">
                            ...
                            <input  type="text" class="form-control" name="documentacion[cd_servicio_fecha]" 
                                    value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->documentacion->cd_servicio_fecha : '' }}">
                        </div>
                    </div>
                </div>
                <div class="col-md-2">
                    ...
                    <input  type="text" class="form-control" name="documentacion[cd_corroboro]" 
                            value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->documentacion->cd_corroboro : '' }}">
                </div>
            </div>
            <div class="form-group">                
                ...
                <div class="col-md-3">
                    <input  type="text" class="form-control" name="documentacion[licencia_manejo_tipo]" 
                            value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->documentacion->licencia_manejo_tipo : '' }}">
                </div>
                ...
                <div class="col-md-3">
                    <input  type="text" class="form-control" name="documentacion[licencia_manejo_no_vig]" 
                            value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->documentacion->licencia_manejo_no_vig : '' }}">
                </div>
                <div class="col-md-2">
                    <input  type="text" class="form-control" name="documentacion[licencia_manejo_corroboro]" 
                            value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->documentacion->licencia_manejo_corroboro : '' }}">
                </div>
            </div>
            <div class="form-group">                
                ...
                <div class="col-md-7">
                    <input  type="text" class="form-control" name="documentacion[cedula_no]" 
                            value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->documentacion->cedula_no : '' }}">
                </div>
                <div class="col-md-2">
                    <input  type="text" class="form-control" name="documentacion[cedula_corroboro]" 
                            value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->documentacion->cedula_corroboro : '' }}">
                </div>
            </div>
            <div class="form-group">                
                ...
                <div class="col-md-7">
                    <input  type="text" class="form-control" name="documentacion[pasaporte_no]" 
                            value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->documentacion->pasaporte_no : '' }}">
                </div>
                <div class="col-md-2">
                    <input  type="text" class="form-control" name="documentacion[pasaporte_corroboro]" 
                            value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->documentacion->pasaporte_corroboro : '' }}">
                </div>
            </div>
            <div class="form-group">                
                ...
                <div class="col-md-7">
                    <input  type="text" class="form-control" name="documentacion[infonavit_no]" 
                            value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->documentacion->infonavit_no : '' }}">
                </div>
                <div class="col-md-2">
                    <input  type="text" class="form-control" name="documentacion[infonavit_corroboro]" 
                            value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->documentacion->infonavit_corroboro : '' }}">
                </div>
            </div>
            <div class="form-group">                
                ...
                <div class="col-md-7">
                    <input  type="text" class="form-control" name="documentacion[fonacot_no]" 
                            value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->documentacion->fonacot_no : '' }}">
                </div>
                <div class="col-md-2">
                    <input  type="text" class="form-control" name="documentacion[fonacot_corroboro]" 
                            value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->documentacion->fonacot_corroboro : '' }}">
                </div>
            </div>
            <div class="form-group">                
                ...
                <div class="col-md-3">
                    <input  type="text" class="form-control" name="documentacion[cartilla_matricula]" 
                            value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->documentacion->cartilla_matricula : '' }}">
                </div>
                ...
                <div class="col-md-3">
                    <input  type="text" class="form-control" name="documentacion[cartilla_liberacion]" 
                            value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->documentacion->cartilla_liberacion : '' }}">
                </div>
                <div class="col-md-2">
                    <input  type="text" class="form-control" name="documentacion[cartilla_corroboro]" 
                            value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->documentacion->cartilla_corroboro : '' }}">
                </div>
            </div>
            <div class="form-group">                
                ...
                <div class="col-md-3">
                    <input  type="text" class="form-control" name="documentacion[actam_juzgado]" 
                            value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->documentacion->actam_juzgado : '' }}">
                </div>
                <label class="col-md-1 control-label">Número</label>
                <div class="col-md-3">
                    <input  type="text" class="form-control" name="documentacion[actam_no]" 
                            value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->documentacion->actam_no : '' }}">
                </div>
                <div class="col-md-2">
                    <input  type="text" class="form-control" name="documentacion[actam_corroboro]" 
                            value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->documentacion->actam_corroboro : '' }}">
                </div>
            </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-11">
                            ...
                            <input  type="text" class="form-control" name="documentacion[recibo_percepciones_empresa]" 
                                    value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->documentacion->recibo_percepciones_empresa : '' }}">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <input  type="text" class="form-control" name="documentacion[recibo_percepciones_puesto]" 
                                    value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->documentacion->recibo_percepciones_puesto : '' }}">
                        </div>
                        ...
                        <div class="col-md-5">
                            <input  type="text" class="form-control" name="documentacion[recibo_percepciones_ingreso]" 
                                    value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->documentacion->recibo_percepciones_ingreso : '' }}">
                        </div>
                    </div>
                </div>
                <div class="col-md-2">
                    <input  type="text" class="form-control" name="documentacion[recibo_percepciones_corroboro]" 
                            value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->documentacion->recibo_percepciones_corroboro : '' }}">
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-2 control-label">Observaciones: </label>
                <div class="col-md-8">   
                    <textarea class="form-control" rows="3" name="documentacion[observaciones]">{{ isset( $estudio->formatoGent->documentacion ) ? $estudio->formatoGent->documentacion->observaciones : '' }}</textarea>
                </div>                
            </div>
