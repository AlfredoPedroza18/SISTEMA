    ...
    <div class="panel-body">
        <div class="form-horizontal">
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <input type="hidden" name="enfermedades_candidato[id]" value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->enfermedad->id : '' }}">
            ...
            <div class="form-group">
                ...
                <div class="col-md-2">
                    <select class="form-control" name="enfermedades_candidato[anemia]">
                            ...
                            <option value="2" 
                                    @if( $estudio->formatoGent ) 
                                            @if( $estudio->formatoGent->enfermedad->anemia == '2' ) 
                                                selected="selected"
                                            @endif
                                    @endif
                                     >No</option>
                ...
                <div class="col-md-2">
                    <select class="form-control" name="enfermedades_candidato[gastritis]">
                            ...
                            <option value="2" 
                                    @if( $estudio->formatoGent ) 
                                            @if( $estudio->formatoGent->enfermedad->gastritis == '2' ) 
                                                selected="selected"
                                            @endif
                                    @endif
                                     >No</option>
                ...
                <div class="col-md-2">
                    <select class="form-control" name="enfermedades_candidato[ulcera]">
                            ...
                            <option value="2" 
                                    @if( $estudio->formatoGent ) 
                                            @if( $estudio->formatoGent->enfermedad->ulcera == '2' ) 
                                                selected="selected"
                                            @endif
                                    @endif
                                     >No</option>
            ...
            <div class="form-group">
                ...
                <div class="col-md-2">
                    <select class="form-control" name="enfermedades_candidato[asma]">
                            ...
                            <option value="2" 
                                    @if( $estudio->formatoGent ) 
                                            @if( $estudio->formatoGent->enfermedad->asma == '2' ) 
                                                selected="selected"
                                            @endif
                                    @endif
                                     >No</option>
                ...
                <div class="col-md-2">
                    <select class="form-control" name="enfermedades_candidato[espalda]">
                            ...
                            <option value="2" 
                                    @if( $estudio->formatoGent ) 
                                            @if( $estudio->formatoGent->enfermedad->espalda == '2' ) 
                                                selected="selected"
                                            @endif
                                    @endif
                                     >No</option>
                ...
                <div class="col-md-2">
                    <select class="form-control" name="enfermedades_candidato[artritis]">
                            ...
                            <option value="2" 
                                    @if( $estudio->formatoGent ) 
                                            @if( $estudio->formatoGent->enfermedad->artritis == '2' ) 
                                                selected="selected"
                                            @endif
                                    @endif
                                     >No</option>
            ...
            <div class="form-group">
                ...
                <div class="col-md-2">
                    <select class="form-control" name="enfermedades_candidato[gripe]">
                            ...
                            <option value="2" 
                                    @if( $estudio->formatoGent ) 
                                            @if( $estudio->formatoGent->enfermedad->gripe == '2' ) 
                                                selected="selected"
                                            @endif
                                    @endif
                                     >No</option>
                ...
                <div class="col-md-2">
                    <select class="form-control" name="enfermedades_candidato[migrania]">
                            ...
                            <option value="2" 
                                    @if( $estudio->formatoGent ) 
                                            @if( $estudio->formatoGent->enfermedad->migrania == '2' ) 
                                                selected="selected"
                                            @endif
                                    @endif
                                     >No</option>
                ...
                <div class="col-md-2">
                    <select class="form-control" name="enfermedades_candidato[bronquitis]">
                            ...
                            <option value="2" 
                                    @if( $estudio->formatoGent ) 
                                            @if( $estudio->formatoGent->enfermedad->bronquitis == '2' ) 
                                                selected="selected"
                                            @endif
                                    @endif
                                     >No</option>
            ...
            <div class="form-group">
                ...
                <div class="col-md-2">
                    <select class="form-control" name="enfermedades_candidato[presion_alta]">
                            ...
                            <option value="2" 
                                    @if( $estudio->formatoGent ) 
                                            @if( $estudio->formatoGent->enfermedad->presion_alta == '2' ) 
                                                selected="selected"
                                            @endif
                                    @endif
                                     >No</option>
                ...
                <div class="col-md-2">
                    <select class="form-control" name="enfermedades_candidato[presion_baja]">
                            ...
                            <option value="2" 
                                    @if( $estudio->formatoGent ) 
                                            @if( $estudio->formatoGent->enfermedad->presion_baja == '2' ) 
                                                selected="selected"
                                            @endif
                                    @endif
                                     >No</option>
                ...
                <div class="col-md-2">
                    <select class="form-control" name="enfermedades_candidato[rinon]">
                            ...
                            <option value="2" 
                                    @if( $estudio->formatoGent ) 
                                            @if( $estudio->formatoGent->enfermedad->rinon == '2' ) 
                                                selected="selected"
                                            @endif
                                    @endif
                                     >No</option>
            ...
            <div class="form-group">
                ...
                <div class="col-md-2">
                    <select class="form-control" name="enfermedades_candidato[epilepsia]">
                            ...
                            <option value="2" 
                                    @if( $estudio->formatoGent ) 
                                            @if( $estudio->formatoGent->enfermedad->epilepsia == '2' ) 
                                                selected="selected"
                                            @endif
                                    @endif
                                     >No</option>
                ...
                <div class="col-md-2">
                    <select class="form-control" name="enfermedades_candidato[problemas_cardiacos]">
                            ...
                            <option value="2" 
                                    @if( $estudio->formatoGent ) 
                                            @if( $estudio->formatoGent->enfermedad->problemas_cardiacos == '2' ) 
                                                selected="selected"
                                            @endif
                                    @endif
                                     >No</option>
            ...
            <div class="form-group">
                ...
                <input  type="hidden" 
                        ...
                        value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->padecimiento->id : 0 }}">
                <div class="col-md-2">
                    <select class="form-control" name="padecimientos[acidez]">
                            ...
                            <option value="2" 
                                    @if( $estudio->formatoGent ) 
                                            @if( $estudio->formatoGent->padecimiento->acidez == '2' ) 
                                                selected="selected"
                                            @endif
                                    @endif
                                     >No</option>
                ...
                <div class="col-md-2">
                    <select class="form-control" name="padecimientos[insomnio]">
                            ...
                            <option value="2" 
                                    @if( $estudio->formatoGent ) 
                                            @if( $estudio->formatoGent->padecimiento->insomnio == '2' ) 
                                                selected="selected"
                                            @endif
                                    @endif
                                     >No</option>
                ...
                <div class="col-md-2">
                    <select class="form-control" name="padecimientos[debilidad]">
                            ...
                            <option value="2" 
                                    @if( $estudio->formatoGent ) 
                                            @if( $estudio->formatoGent->padecimiento->debilidad == '2' ) 
                                                selected="selected"
                                            @endif
                                    @endif
                                     >No</option>
            ...
            <div class="form-group">
                ...
                <div class="col-md-2">
                    <select class="form-control" name="padecimientos[ansiedad]">
                            ...
                            <option value="2" 
                                    @if( $estudio->formatoGent ) 
                                            @if( $estudio->formatoGent->padecimiento->ansiedad == '2' ) 
                                                selected="selected"
                                            @endif
                                    @endif
                                     >No</option>
                ...
                <div class="col-md-2">
                    <select class="form-control" name="padecimientos[escalofrios]">
                            ...
                            <option value="2" 
                                    @if( $estudio->formatoGent ) 
                                            @if( $estudio->formatoGent->padecimiento->escalofrios == '2' ) 
                                                selected="selected"
                                            @endif
                                    @endif
                                     >No</option>
                ...
                <div class="col-md-2">
                    <select class="form-control" name="padecimientos[mareos]">
                            ...
                            <option value="2" 
                                    @if( $estudio->formatoGent ) 
                                            @if( $estudio->formatoGent->padecimiento->mareos == '2' ) 
                                                selected="selected"
                                            @endif
                                    @endif
                                     >No</option>
            ...
            <div class="form-group">
                ...
                <div class="col-md-2">
                    <select class="form-control" name="padecimientos[dolor_cabeza]">
                            ...
                            <option value="2" 
                                    @if( $estudio->formatoGent ) 
                                            @if( $estudio->formatoGent->padecimiento->dolor_cabeza == '2' ) 
                                                selected="selected"
                                            @endif
                                    @endif
                                     >No</option>
                ...
                <div class="col-md-2">
                    <select class="form-control" name="padecimientos[manos_temblorosas]">
                            ...
                            <option value="2" 
                                    @if( $estudio->formatoGent ) 
                                            @if( $estudio->formatoGent->padecimiento->manos_temblorosas == '2' ) 
                                                selected="selected"
                                            @endif
                                    @endif
                                     >No</option>
                ...
                <div class="col-md-2">
                    <select class="form-control" name="padecimientos[taquicardia]">
                            ...
                            <option value="2" 
                                    @if( $estudio->formatoGent ) 
                                            @if( $estudio->formatoGent->padecimiento->taquicardia == '2' ) 
                                                selected="selected"
                                            @endif
                                    @endif
                                     >No</option>
            ...
            <div class="form-group">
                ...
                <div class="col-md-2">
                    <select class="form-control" name="padecimientos[estrenimiento]">
                            ...
                            <option value="2" 
                                    @if( $estudio->formatoGent ) 
                                            @if( $estudio->formatoGent->padecimiento->estrenimiento == '2' ) 
                                                selected="selected"
                                            @endif
                                    @endif
                                     >No</option>
                ...
                <div class="col-md-2">
                    <select class="form-control" name="padecimientos[alergia]">
                            ...
                            <option value="2" 
                                    @if( $estudio->formatoGent ) 
                                            @if( $estudio->formatoGent->padecimiento->alergia == '2' ) 
                                                selected="selected"
                                            @endif
                                    @endif
                                     >No</option>
                ...
                <div class="col-md-2">
                    <input  type="text" 
                            ...
                            value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->padecimiento->tipo : '' }}">
            ...
            <div class="form-group">
                ...
                <div class="col-md-2">
                    <select class="form-control" name="padecimientos[tratamiento_medico]">
                            ...
                            <option value="2" 
                                    @if( $estudio->formatoGent ) 
                                            @if( $estudio->formatoGent->padecimiento->tratamiento_medico == '2' ) 
                                                selected="selected"
                                            @endif
                                    @endif
                                     >No</option>
                ...
                <div class="col-md-4">
                    <input  type="text" 
                            ...
                            value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->padecimiento->tratamiento_medico_desc : '' }}">   
                </div>
            </div> 
            <div class="form-group">
                ...
                <div class="col-md-2">
                    <select class="form-control" name="padecimientos[medicamento_controlado]">
                            ...
                            <option value="2" 
                                    @if( $estudio->formatoGent ) 
                                            @if( $estudio->formatoGent->padecimiento->medicamento_controlado == '2' ) 
                                                selected="selected"
                                            @endif
                                    @endif
                                     >No</option>
                ...
                <div class="col-md-4">
                    <input  type="text" 
                            ...
                            value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->padecimiento->medicamento_controlado_desc : '' }}">   
                </div>
            </div> 
            ...
            @if( $estudio->formatoGent )
                @forelse( $estudio->formatoGent->padecimiento_familiar as $index => $familiar )
                     <div class="form-group">
                        <label class="col-md-2 text-center control-label">
                            <a  href="javascript:;" 
            ...
            <div class="form-group">
                ...
                <div class="col-md-2">                    
                    <input  type="hidden" 
                            ...
                            value="{{ isset( $estudio->formatoGent ) ?  $estudio->formatoGent->atencion_medica->id : '0' }}">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <input  type="text" 
                            ...
                            value="{{ isset( $estudio->formatoGent ) ?  $estudio->formatoGent->atencion_medica->padecimiento : '' }}">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">   
                	<input     type="text" 
                            ...
                            value="{{ isset( $estudio->formatoGent ) ?  $estudio->formatoGent->atencion_medica->accidente_llamar : '' }}">
                </div>                
                ...
                <div class="col-md-2">   
                    <input  type="text" 
                            ...
                            value="{{ isset( $estudio->formatoGent ) ?  $estudio->formatoGent->atencion_medica->telefono : '' }}">
                </div>                
            </div>            
        </div>
    </div>
