        ...
        <div class="form-horizontal">
                        ...
                        <tbody>
                            <tr>
                                <td style="width:20%;">
                                    ...
                                    <input type="hidden" name="habitos_costumbres[0][id]" value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->habitos_detalle[0]->id : 0 }}">
                                ...
                                <td style="width:20%;">
                                    <div class="col-md-12 text-center">
                                        ...
                                        <select class="form-control" name="habitos_costumbres[0][respuesta]">
                                            ...
                                            @if( $estudio->formatoGent->habitos_detalle[0]->respuesta == '1' ) 
                                            selected="selected"
                                            @endif
                                            @endif
                                            >Si</option>
                                            <option value="2" 
                                            @if( $estudio->formatoGent ) 
                                            @if( $estudio->formatoGent->habitos_detalle[0]->respuesta == '2' ) 
                                            selected="selected"
                                            @endif
                                            @endif
                                            >No</option>
                                ...
                                <td style="width:10%;">
                                    <div class="col-md-12 text-center">                   
                                        <input  type="text" 
                                                class="form-control"                              
                                                value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->habitos_detalle[0]->cantidad : '' }}" 
                                ...
                                <td style="width:10%;">
                                    <div class="col-md-12 text-center">                   
                                        <input  type="text" 
                                                class="form-control"                              
                                                value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->habitos_detalle[0]->diario : '' }}" 
                                ...
                                <td style="width:10%;">
                                    <div class="col-md-12 text-center">                   
                                        <input  type="text" 
                                                class="form-control"                              
                                                value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->habitos_detalle[0]->semanal : '' }}" 
                                ...
                                <td style="width:10%;">
                                    <div class="col-md-12 text-center">                   
                                        <input  type="text" 
                                                class="form-control"                              
                                                value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->habitos_detalle[0]->quincenal : '' }}" 
                                ...
                                <td style="width:10%;">
                                    <div class="col-md-12 text-center">                   
                                        <input  type="text" 
                                                class="form-control"                              
                                                value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->habitos_detalle[0]->ocasional : '' }}" 
                            ...
                            <tr>
                                <td style="width:20%;">
                                    ...
                                    <input type="hidden" name="habitos_costumbres[1][id]" value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->habitos_detalle[1]->id : '0' }}">
                                ...
                                <td style="width:20%;">
                                    <div class="col-md-12 text-center">                   
                                        <select class="form-control" name="habitos_costumbres[1][respuesta]">
                                            <option value="1" 
                                            @if( $estudio->formatoGent ) 
                                            @if( $estudio->formatoGent->habitos_detalle[1]->respuesta == '1' ) 
                                            selected="selected"
                                            @endif
                                            @endif
                                            >Si</option>
                                            <option value="2" 
                                            @if( $estudio->formatoGent ) 
                                            @if( $estudio->formatoGent->habitos_detalle[1]->respuesta == '2' ) 
                                            selected="selected"
                                            @endif
                                            @endif
                                            >No</option>
                                ...
                                <td style="width:10%;">
                                    <div class="col-md-12 text-center">                   
                                        <input  type="text" 
                                                class="form-control"                              
                                                value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->habitos_detalle[1]->cantidad : '' }}" 
                                ...
                                <td style="width:10%;">
                                    <div class="col-md-12 text-center">                   
                                        <input  type="text" 
                                                class="form-control"                              
                                                value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->habitos_detalle[1]->diario : '' }}" 
                                ...
                                <td style="width:10%;">
                                    <div class="col-md-12 text-center">                   
                                        <input  type="text" 
                                                class="form-control"                              
                                                value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->habitos_detalle[1]->semanal : '' }}" 
                                ...
                                <td style="width:10%;">
                                    <div class="col-md-12 text-center">                   
                                        <input  type="text" 
                                                class="form-control"                              
                                                value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->habitos_detalle[1]->quincenal : '' }}" 
                                ...
                                <td style="width:10%;">
                                    <div class="col-md-12 text-center">                   
                                        <input  type="text" 
                                                class="form-control"                              
                                                value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->habitos_detalle[1]->ocasional : '' }}" 
                            ...
                            <tr>
                                <td style="width:20%;">
                                    ...
                                    <input type="hidden" name="habitos_costumbres[2][id]" value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->habitos_detalle[2]->id : '0' }}">
                                ...
                                <td style="width:20%;">
                                    <div class="col-md-12 text-center">                   
                                        <select class="form-control" name="habitos_costumbres[2][respuesta]">
                                            <option value="1" 
                                            @if( $estudio->formatoGent ) 
                                            @if( $estudio->formatoGent->habitos_detalle[2]->respuesta == '1' ) 
                                            selected="selected"
                                            @endif
                                            @endif
                                            >Si</option>
                                            <option value="2" 
                                            @if( $estudio->formatoGent ) 
                                            @if( $estudio->formatoGent->habitos_detalle[2]->respuesta == '2' ) 
                                            selected="selected"
                                            @endif
                                            @endif
                                            >No</option>
                                ...
                                <td style="width:10%;">
                                    <div class="col-md-12 text-center">                   
                                        <input  type="text" 
                                                class="form-control"                              
                                                value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->habitos_detalle[2]->cantidad : '' }}" 
                                ...
                                <td style="width:10%;">
                                    <div class="col-md-12 text-center">                   
                                        <input  type="text" 
                                                class="form-control"                              
                                                value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->habitos_detalle[2]->diario : '' }}" 
                                ...
                                <td style="width:10%;">
                                    <div class="col-md-12 text-center">                   
                                        <input  type="text" 
                                                class="form-control"                              
                                                value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->habitos_detalle[2]->semanal : '' }}" 
                                ...
                                <td style="width:10%;">
                                    <div class="col-md-12 text-center">                   
                                        <input  type="text" 
                                                class="form-control"                              
                                                value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->habitos_detalle[2]->quincenal : '' }}" 
                                ...
                                <td style="width:10%;">
                                    <div class="col-md-12 text-center">                   
                                        <input  type="text" 
                                                class="form-control"                              
                                                value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->habitos_detalle[2]->ocasional : '' }}" 
            ...
            <div class="form-group">
                ...
                <div class="col-md-2 text-center">           
                    <input type="hidden" name="habitos_costumbres_normal[id]" value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->habitos->id : '0' }}">        
            ...
            <div class="form-group">
                ...
                <div class="col-md-2 text-center">                   
                    <select class="form-control" name="habitos_costumbres_normal[tipo_actividad_social]">
                        ...
                        <option value="2" 
                                @if( $estudio->formatoGent ) 
                                        @if( $estudio->formatoGent->habitos->tipo_actividad_social == '2' ) 
                                            selected="selected"
                                        @endif
                                @endif
                                 >No</option>
                ...
                <div class="col-md-2 text-center">                   
                    <select class="form-control" name="habitos_costumbres_normal[tipo_actividad_deportiva]">
                        ...
                        <option value="2" 
                                @if( $estudio->formatoGent ) 
                                        @if( $estudio->formatoGent->habitos->tipo_actividad_deportiva == '2' ) 
                                            selected="selected"
                                        @endif
                                @endif
                                 >No</option>
                ...
                <div class="col-md-2 text-center">                   
                    <select class="form-control" name="habitos_costumbres_normal[tipo_actividad_religiosa]">
                        ...
                        <option value="2" 
                                @if( $estudio->formatoGent ) 
                                        @if( $estudio->formatoGent->habitos->tipo_actividad_religiosa == '2' ) 
                                            selected="selected"
                                        @endif
                                @endif
                                 >No</option>
                ...
                <div class="col-md-2 text-center">                   
                    <select class="form-control" name="habitos_costumbres_normal[tipo_actividad_cultural]">
                        ...
                        <option value="2" 
                                @if( $estudio->formatoGent ) 
                                        @if( $estudio->formatoGent->habitos->tipo_actividad_cultural == '2' ) 
                                            selected="selected"
                                        @endif
                                @endif
                                 >No</option>
            ...
            <div class="form-group">
                ...
                <div class="col-md-5">
                    ...
                    value="{{ isset( $estudio->formatoGent ) ? $estudio->formatoGent->habitos->cuales : '' }}" >
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-md-2 text-center">                   
                    <select class="form-control" name="habitos_costumbres_normal[tiempo_dedicado_diario]">
                        ...
                        <option value="2" 
                                @if( $estudio->formatoGent ) 
                                        @if( $estudio->formatoGent->habitos->tiempo_dedicado_diario == '2' ) 
                                            selected="selected"
                                        @endif
                                @endif
                                 >No</option>
                ...
                <div class="col-md-2 text-center">                   
                    <select class="form-control" name="habitos_costumbres_normal[tiempo_dedicado_semanal]">
                        ...
                        <option value="2" 
                                @if( $estudio->formatoGent ) 
                                        @if( $estudio->formatoGent->habitos->tiempo_dedicado_semanal == '2' ) 
                                            selected="selected"
                                        @endif
                                @endif
                                 >No</option>
                ...
                <div class="col-md-2 text-center">                   
                    <select class="form-control" name="habitos_costumbres_normal[tiempo_dedicado_quincenal]">
                        ...
                        <option value="2" 
                                @if( $estudio->formatoGent ) 
                                        @if( $estudio->formatoGent->habitos->tiempo_dedicado_quincenal == '2' ) 
                                            selected="selected"
                                        @endif
                                @endif
                                 >No</option>
                ...
                <div class="col-md-2 text-center">                   
                    <select class="form-control" name="habitos_costumbres_normal[tiempo_dedicado_mensual]">
                        ...
                        <option value="2" 
                                @if( $estudio->formatoGent ) 
                                        @if( $estudio->formatoGent->habitos->tiempo_dedicado_mensual == '2' ) 
                                            selected="selected"
                                        @endif
                                @endif
                                 >No</option>
