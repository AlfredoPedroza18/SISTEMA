                                        ...
                                        <tbody>
                         				 ...
                         				 @if( $estudio->imagenes->where('tipo','Candidato')->sortByDesc('fecha_alta')->first() )
                                    			{{ Html::image(
                                                        ...
                                                        $estudio->imagenes->where('tipo','Candidato')->sortByDesc('fecha_alta')->first()->archivo,'',["style"=>"max-width:60%"]) }}
                                                                                                                  
                                                     
                                                            
                                                        @else
                                                             
                                                        {!! Html::image('recursos_cotizaciones/maquila/logo-gent.jpg','',["style"=>"max-width:60%"]) !!}        
                            ...
                            <td  colspan="3" class="table-border">
                                <div class="box">
                                    <table class="auto-width">
                                        <tbody>
                                            <tr>
                                                <td colspan="10"  class="table-border letra-componente justificar">
                                                ...
                                                <table class="auto-width ">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            {{ isset( $estudio->formatoRoa  ) ? date("d-m-Y", strtotime($estudio->formatoRoa->datosGenerales->fecha_matrimonio)) : ''}}
                                                            </p></td>
                                            ...
                                            <td colspan="3" class="table-border">
                                                <table class="auto-width table-border">
                                                    <tbody>
                                                        ...
                                                        <tr>
		                                                         <td colspan="2" class="alinear-izquierda letra-componente" style="width: 35%">
		                                                         	Si es trunco, ¿Por qué abandonó sus estudios?
		                                                         </td>
                                                            <td>
                                                                <p class="letra-componente alinear-izquierda" style="width: 65%">
                                             ...
                                             {{ isset( $estudio->formatoRoa) ? $estudio->formatoRoa->situacionEconomica->tipoinUno : ''}}       
                                                       ...
                                                       <tr>
                                                        ...
                                                        <tr>
                                                                ...
                                                                <td class="letra-componente " style="width:15%;"><p class="alinear-izquierda">
                                                                 <?php 
                                                                  $e11=null;
                                                                  if($estudio->formatoRoa ){
                                                            ...
                                                            <td class="table-border">
                                                                <table class="tabla-componente table-border">
                                                                    <thead>
                                                                        ...
                                                                        <th class="letra-componente negrita alinear-centro"  style="width:25%;">TIPO</th>
                                                                        <th class="letra-componente negrita alinear-centro"  style="width:15%;">VALOR</th>    
                                                                        <th class="letra-componente negrita alinear-centro"  style="width:15%;">PAGADO</th>    
                                                ...
                                                <td colspan="3" class="table-border">
                                                     <span style=" display: inline-block;height: 15px;"></span>
                                                                                                ...
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td style="width: 15%;" class="table-border letra-componente alinear-izquierda">
                                                                                                        <p>&nbsp;&nbsp;SI</p>
                                                                                                    </td>
                                                                                                    <td
                                                                                                      @if( $estudio->formatoRoa)
                                                                                                ...
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td  colspan="4" class="letra-componente table-border" style="width: 75%">
                                                                                                        <p class="border-footer">
                                                                              {{ isset( $estudio->formatoRoa ) ? $estudio->formatoRoa->apreciacionVivienda->familiares_parentesco: '' }}
                                                                                  ...
                                                                                  Medio: {{ isset( $estudio->formatoRoa ) ? $estudio->formatoRoa->apreciacionVivienda->entero_vacante: '' }}
                                                                                        ...
                                                                                        <p class="border-footer">
                                                                                            Nombre del reclutador: {{ isset( $estudio->formatoRoa) ? $estudio->formatoRoa->apreciacionVivienda->nombre_reclutador: '' }}
                                                                                        </p>
                                                                ...
                                                                <table class="tabla-componente">
                                                                    <tbody>
                                                                        <tr>
                                                                            ...
                                                                            <td  class="alinear-derecha letra-componente table-border" style="width: 20%">
                                                                                 <p>
                                                                                     MOTIVO:
                                                                                 </p>
                                                                            </td>
                                                            ...
                                                            <table class="tabla-componente">
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td colspan="4" class="alinear-izquierda letra-componente" style="width: 10%">
                                                                            @if( $estudio->formatoRoa ) 
                                                                            @if( trim($estudio->formatoRoa->padecimientos->tratamiento_medico) != '' )
                                                                ...
                                                                <table class="auto-width">
                                                                    <tbody> 
                                                                       <tr>
                                                                            ...
                                                                            <td colspan="3" class="alinear-izquierda letra-componente " style="width: 70%">
                                                                                ...
                                                                                <table class="auto-width">
                                                                                    <tbody>
                                                                                        <tr>
                                                                                           ...
                                                                                           <td class="alinear-izquierda table-border letra-componente"  style="width: 7.5%">                                                           &nbsp;SI
                                                                                           </td>
                                                                                            <td class="alinear-centro"   @if( $estudio->formatoRoa) 
                                                                                           ...
                                                                                           <td class="alinear-izquierda letra-componente" 
                                                                                            @if( $estudio->formatoRoa)
                                                                                                                @if( trim( $estudio->formatoRoa->habitoCostumbre->tipo_actividad_pareja) != ''  )
                                                                                                                                style="background-color:#FF8000; width:13%;"
                                                                                                                                @else
                                                                                                                                style="width:13%;"
                                                                                                                                @endif 
                                                                                                                                @endif>                                                           
                                                ...
                                                <table class="tabla-componente auto-width">
                                                    <tbody>
                                                        <tr>
                                                                            ...
                                                                            <td style="width: 40%" class="alinear-izquierda letra-componente"> 
                                                                                ...
                                                                                <tr>
                                                                                    <td colspan="4" style="width: 100%">
                                                                                         <p class="justificar letra-componente">
                                                                                           COMENTARIOS:&nbsp;{{$referencias->comentarios_referencias}} 
                                                                                         </p>
                                                                                    </td>                                                            
                                                                                </tr>
                                                                            </tbody>
                                                                    ...
                                                                    <td class="alinear-centro table-border">
                                                                        <table class="tabla-componente">
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td colspan="2" style="width: 43.33%">
                                                                                     <p class="alinear-centro letra-componente">
